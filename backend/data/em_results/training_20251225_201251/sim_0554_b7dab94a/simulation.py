...
# Antenna parameters
L = 0.02516838217542208  # Patch length (m)
W = 0.031248007310914226   # Patch width (m)
h = 0.0012010701850444718  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010067352870168833  # Feed x position
feed_y = 0.01154998079136938  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0554_b7dab94a')
