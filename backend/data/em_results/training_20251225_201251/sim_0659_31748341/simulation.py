...
# Antenna parameters
L = 0.033110337031127396  # Patch length (m)
W = 0.03508865558667445   # Patch width (m)
h = 0.0018380072490548956  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010603929407363485  # Feed x position
feed_y = 0.006683924331228515  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0659_31748341')
