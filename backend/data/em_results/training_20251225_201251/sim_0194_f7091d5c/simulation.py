...
# Antenna parameters
L = 0.028417468153938738  # Patch length (m)
W = 0.03841454918131858   # Patch width (m)
h = 0.0013157145120542236  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005073699544342138  # Feed x position
feed_y = 0.015365819672527432  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0194_f7091d5c')
