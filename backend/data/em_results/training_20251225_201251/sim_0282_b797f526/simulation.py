...
# Antenna parameters
L = 0.03056169980820841  # Patch length (m)
W = 0.03571536153689448   # Patch width (m)
h = 0.0031211788288267595  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001009401259462924  # Feed x position
feed_y = 0.011444506603280648  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0282_b797f526')
