...
# Antenna parameters
L = 0.026357821627081165  # Patch length (m)
W = 0.03046699736906379   # Patch width (m)
h = 0.001670369597918629  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007499815774702114  # Feed x position
feed_y = 0.007765925612385374  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0784_18b4c78e')
