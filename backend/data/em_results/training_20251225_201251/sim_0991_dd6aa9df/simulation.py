...
# Antenna parameters
L = 0.025357633159964026  # Patch length (m)
W = 0.03279211990319274   # Patch width (m)
h = 0.0009170168339312892  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0035626237865214985  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0991_dd6aa9df')
