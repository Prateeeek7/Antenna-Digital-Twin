...
# Antenna parameters
L = 0.02881213058864188  # Patch length (m)
W = 0.036938505026772456   # Patch width (m)
h = 0.00178294822794299  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0042894728393346356  # Feed x position
feed_y = 0.012222777198517217  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0568_3e90fab8')
