...
# Antenna parameters
L = 0.02571583737574297  # Patch length (m)
W = 0.030524261188201084   # Patch width (m)
h = 0.0019223033260676974  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01028633495029719  # Feed x position
feed_y = 0.003096660780742543  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0057_074600e4')
