...
# Antenna parameters
L = 0.0325704302841537  # Patch length (m)
W = 0.03699618717329206   # Patch width (m)
h = 0.001223205572315758  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003298779949629742  # Feed x position
feed_y = 0.014747491888642095  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0487_f40ba338')
