...
# Antenna parameters
L = 0.02531881869149721  # Patch length (m)
W = 0.03816786999822925   # Patch width (m)
h = 0.002360986950120825  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0022515187011581715  # Feed x position
feed_y = 0.007797085802484631  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0873_3e7a1a7d')
