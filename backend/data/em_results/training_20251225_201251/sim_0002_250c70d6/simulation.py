...
# Antenna parameters
L = 0.027566292019757677  # Patch length (m)
W = 0.04404109852516727   # Patch width (m)
h = 0.0009184547237118065  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015185889636495158  # Feed x position
feed_y = 0.01577896959706346  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0002_250c70d6')
