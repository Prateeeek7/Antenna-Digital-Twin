...
# Antenna parameters
L = 0.03138607274586088  # Patch length (m)
W = 0.03866530011883358   # Patch width (m)
h = 0.0022163675989399735  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013903625202963  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0807_0b4237b2')
