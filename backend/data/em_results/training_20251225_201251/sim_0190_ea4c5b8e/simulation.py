...
# Antenna parameters
L = 0.026464691496057124  # Patch length (m)
W = 0.03940127390394202   # Patch width (m)
h = 0.0008210124883962797  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01058587659842285  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0190_ea4c5b8e')
