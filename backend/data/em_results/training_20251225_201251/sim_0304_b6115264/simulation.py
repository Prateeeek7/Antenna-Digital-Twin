...
# Antenna parameters
L = 0.03480708670546442  # Patch length (m)
W = 0.031012059129689604   # Patch width (m)
h = 0.0021034812186415184  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011734155567415914  # Feed x position
feed_y = 0.005586695960942522  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0304_b6115264')
