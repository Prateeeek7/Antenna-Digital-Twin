...
# Antenna parameters
L = 0.028297500132459717  # Patch length (m)
W = 0.03774693254401503   # Patch width (m)
h = 0.0025821487357249504  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008411800001562603  # Feed x position
feed_y = 0.015098773017606013  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0830_d23532b5')
