...
# Antenna parameters
L = 0.025046482976091498  # Patch length (m)
W = 0.044029480937893356   # Patch width (m)
h = 0.001633302442864159  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009322423525230016  # Feed x position
feed_y = 0.017611792375157344  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0642_0247929a')
