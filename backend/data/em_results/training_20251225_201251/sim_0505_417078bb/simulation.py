...
# Antenna parameters
L = 0.02965849006868565  # Patch length (m)
W = 0.036616298495102804   # Patch width (m)
h = 0.0009370340240781851  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01186339602747426  # Feed x position
feed_y = 0.008867894708270513  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0505_417078bb')
