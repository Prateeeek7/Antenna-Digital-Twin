...
# Antenna parameters
L = 0.025796436825163433  # Patch length (m)
W = 0.040206591007874   # Patch width (m)
h = 0.002454846538043617  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010318574730065373  # Feed x position
feed_y = 0.015606852469094988  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0671_a472dd45')
