...
# Antenna parameters
L = 0.028927362139578243  # Patch length (m)
W = 0.03158741449160154   # Patch width (m)
h = 0.002660168556199676  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008822223467267696  # Feed x position
feed_y = 0.011820560943262342  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0802_e3029029')
