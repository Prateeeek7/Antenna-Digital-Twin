...
# Antenna parameters
L = 0.02588772188848914  # Patch length (m)
W = 0.031323872686296404   # Patch width (m)
h = 0.0021866290162720057  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0011004787698472617  # Feed x position
feed_y = 0.012529549074518562  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0990_bf5f53d3')
