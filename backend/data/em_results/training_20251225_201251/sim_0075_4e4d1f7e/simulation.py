...
# Antenna parameters
L = 0.03054852216627458  # Patch length (m)
W = 0.04470095808804936   # Patch width (m)
h = 0.000854149030310723  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012219408866509832  # Feed x position
feed_y = 0.009594397163790094  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0075_4e4d1f7e')
