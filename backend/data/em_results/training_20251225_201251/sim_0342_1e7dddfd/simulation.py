...
# Antenna parameters
L = 0.03150212207149361  # Patch length (m)
W = 0.030774258252558296   # Patch width (m)
h = 0.002074448051504264  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012600848828597445  # Feed x position
feed_y = 0.010304740059355298  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0342_1e7dddfd')
