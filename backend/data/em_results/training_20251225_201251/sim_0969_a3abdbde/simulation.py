...
# Antenna parameters
L = 0.03423698538332012  # Patch length (m)
W = 0.03130293150626382   # Patch width (m)
h = 0.001892825802891263  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01369479415332805  # Feed x position
feed_y = 0.012521172602505529  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0969_a3abdbde')
