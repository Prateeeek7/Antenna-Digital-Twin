...
# Antenna parameters
L = 0.028914078671750967  # Patch length (m)
W = 0.04042865887076358   # Patch width (m)
h = 0.0019247379094465577  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007951213551038292  # Feed x position
feed_y = 0.014158213580562339  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0478_47cbe89b')
