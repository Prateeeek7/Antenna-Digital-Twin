...
# Antenna parameters
L = 0.025629936753527604  # Patch length (m)
W = 0.03825138456144692   # Patch width (m)
h = 0.0015246293902473318  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0023137306898170936  # Feed x position
feed_y = 0.014053417676532547  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0831_34f4ec2e')
