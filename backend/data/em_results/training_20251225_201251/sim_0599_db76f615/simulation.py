...
# Antenna parameters
L = 0.02595527112817846  # Patch length (m)
W = 0.03938017329162863   # Patch width (m)
h = 0.0025538957909028237  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010382108451271384  # Feed x position
feed_y = 0.0028531313633494487  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0599_db76f615')
