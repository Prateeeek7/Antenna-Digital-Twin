...
# Antenna parameters
L = 0.031109598184273717  # Patch length (m)
W = 0.04357699491598715   # Patch width (m)
h = 0.001723124772103091  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010017222740080161  # Feed x position
feed_y = 0.01743079796639486  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0635_cf67a1e8')
