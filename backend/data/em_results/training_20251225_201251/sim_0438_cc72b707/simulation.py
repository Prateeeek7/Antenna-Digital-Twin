...
# Antenna parameters
L = 0.02623884813946686  # Patch length (m)
W = 0.03651654206394793   # Patch width (m)
h = 0.0016598695026687998  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006611417672228502  # Feed x position
feed_y = 0.002362659416664236  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0438_cc72b707')
