...
# Antenna parameters
L = 0.029152171794343516  # Patch length (m)
W = 0.03580586393623787   # Patch width (m)
h = 0.002021546554830489  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011098211792597922  # Feed x position
feed_y = 0.008024741405314487  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0407_f5c994d0')
