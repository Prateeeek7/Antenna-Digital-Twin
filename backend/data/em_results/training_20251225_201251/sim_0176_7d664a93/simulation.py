...
# Antenna parameters
L = 0.027945908600223755  # Patch length (m)
W = 0.030125973378661984   # Patch width (m)
h = 0.0029601550847130407  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011178363440089503  # Feed x position
feed_y = 0.009260773289088682  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0176_7d664a93')
