...
# Antenna parameters
L = 0.032889293492842295  # Patch length (m)
W = 0.037154542786363126   # Patch width (m)
h = 0.0016652835964739918  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013155717397136918  # Feed x position
feed_y = 0.010936829609744557  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0851_720fa26d')
