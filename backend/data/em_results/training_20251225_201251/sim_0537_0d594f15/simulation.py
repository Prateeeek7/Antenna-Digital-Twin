...
# Antenna parameters
L = 0.03345260827678073  # Patch length (m)
W = 0.03536641822005962   # Patch width (m)
h = 0.0014247886315419847  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0069538752289799695  # Feed x position
feed_y = 0.004765427797654029  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0537_0d594f15')
