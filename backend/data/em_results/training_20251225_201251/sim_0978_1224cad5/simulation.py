...
# Antenna parameters
L = 0.026327749763703154  # Patch length (m)
W = 0.04076579213691878   # Patch width (m)
h = 0.003141338944893066  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0033664146371579135  # Feed x position
feed_y = 0.011013041944169409  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0978_1224cad5')
