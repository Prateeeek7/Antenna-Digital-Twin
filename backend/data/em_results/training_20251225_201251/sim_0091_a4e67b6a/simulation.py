...
# Antenna parameters
L = 0.025388164667711197  # Patch length (m)
W = 0.03637529959230668   # Patch width (m)
h = 0.0030068994544580996  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0027065804313304445  # Feed x position
feed_y = 0.011010141004415318  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0091_a4e67b6a')
