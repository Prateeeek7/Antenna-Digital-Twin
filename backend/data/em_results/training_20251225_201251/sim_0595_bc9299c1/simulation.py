...
# Antenna parameters
L = 0.02885180472028116  # Patch length (m)
W = 0.03324519141854068   # Patch width (m)
h = 0.0019838959977410663  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009106839456577009  # Feed x position
feed_y = 0.012568758520123572  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0595_bc9299c1')
