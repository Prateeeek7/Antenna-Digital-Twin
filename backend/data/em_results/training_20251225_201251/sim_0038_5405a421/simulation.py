...
# Antenna parameters
L = 0.026570631868494662  # Patch length (m)
W = 0.03337138544137491   # Patch width (m)
h = 0.0030797053809622126  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0011979221555903712  # Feed x position
feed_y = 0.013348554176549966  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0038_5405a421')
