...
# Antenna parameters
L = 0.03375195639084387  # Patch length (m)
W = 0.03645798927597667   # Patch width (m)
h = 0.0008101165677217948  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012555426764216447  # Feed x position
feed_y = 0.01257601671488014  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0047_a07fac5e')
