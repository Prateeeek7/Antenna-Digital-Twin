...
# Antenna parameters
L = 0.030346913846573908  # Patch length (m)
W = 0.035460035271088174   # Patch width (m)
h = 0.002425000875118604  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012138765538629564  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0956_1b1a4ecb')
