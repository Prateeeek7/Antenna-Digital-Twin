...
# Antenna parameters
L = 0.02923157929848228  # Patch length (m)
W = 0.042205046980566034   # Patch width (m)
h = 0.0015999534803131858  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006579204028792506  # Feed x position
feed_y = 0.004873042317595347  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0357_d98f5c43')
