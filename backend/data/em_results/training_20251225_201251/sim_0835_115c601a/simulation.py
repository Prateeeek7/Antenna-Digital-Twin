...
# Antenna parameters
L = 0.03451444441532454  # Patch length (m)
W = 0.039440823594683275   # Patch width (m)
h = 0.0009008339523189384  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006701773436353551  # Feed x position
feed_y = 0.01577632943787331  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0835_115c601a')
