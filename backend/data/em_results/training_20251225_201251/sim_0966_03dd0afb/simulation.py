...
# Antenna parameters
L = 0.02933406386808682  # Patch length (m)
W = 0.043495509444849687   # Patch width (m)
h = 0.0011703625046752169  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011733625547234729  # Feed x position
feed_y = 0.017398203777939877  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0966_03dd0afb')
