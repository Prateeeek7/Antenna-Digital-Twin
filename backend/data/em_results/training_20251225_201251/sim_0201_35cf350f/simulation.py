...
# Antenna parameters
L = 0.0286460707260843  # Patch length (m)
W = 0.04422117221324767   # Patch width (m)
h = 0.0027120340244129407  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010517029888177199  # Feed x position
feed_y = 0.01768846888529907  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0201_35cf350f')
