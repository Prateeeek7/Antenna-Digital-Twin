...
# Antenna parameters
L = 0.026163123349508342  # Patch length (m)
W = 0.03307941890451774   # Patch width (m)
h = 0.0013894691799316073  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.009543234921822364  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0106_f2dc8d1a')
