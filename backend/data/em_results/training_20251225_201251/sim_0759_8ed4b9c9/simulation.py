...
# Antenna parameters
L = 0.033393469099336964  # Patch length (m)
W = 0.03705526632253356   # Patch width (m)
h = 0.0017989319348701324  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01279946155606712  # Feed x position
feed_y = 0.005367946481103838  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0759_8ed4b9c9')
