...
# Antenna parameters
L = 0.03190499016788968  # Patch length (m)
W = 0.04214291783323469   # Patch width (m)
h = 0.0017916371952561008  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003880513854567966  # Feed x position
feed_y = 0.01685716713329388  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0535_29c6c47d')
