...
# Antenna parameters
L = 0.031556819358528915  # Patch length (m)
W = 0.03246980678316958   # Patch width (m)
h = 0.001794595645228061  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001663100670177636  # Feed x position
feed_y = 0.012987922713267833  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0672_871b5256')
