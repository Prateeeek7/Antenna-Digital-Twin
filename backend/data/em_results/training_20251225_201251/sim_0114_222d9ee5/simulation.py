...
# Antenna parameters
L = 0.03234661543516703  # Patch length (m)
W = 0.04368233281690069   # Patch width (m)
h = 0.0016076418259793907  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.017192230117172087  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0114_222d9ee5')
