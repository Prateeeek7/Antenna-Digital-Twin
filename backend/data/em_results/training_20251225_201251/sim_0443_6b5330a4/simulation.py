...
# Antenna parameters
L = 0.028689122406172288  # Patch length (m)
W = 0.04280828971212998   # Patch width (m)
h = 0.002705768882749462  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011475648962468915  # Feed x position
feed_y = 0.004124263699386264  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0443_6b5330a4')
