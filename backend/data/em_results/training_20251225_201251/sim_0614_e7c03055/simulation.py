...
# Antenna parameters
L = 0.026909837428901073  # Patch length (m)
W = 0.0438305397944646   # Patch width (m)
h = 0.002962842167332171  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009462527342678793  # Feed x position
feed_y = 0.0024573791154793457  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0614_e7c03055')
