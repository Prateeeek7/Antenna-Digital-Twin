...
# Antenna parameters
L = 0.03320143139608084  # Patch length (m)
W = 0.030643531750796777   # Patch width (m)
h = 0.0023905377827791023  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011630226061041854  # Feed x position
feed_y = 0.012011613915499557  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0431_dc3dfaf1')
