...
# Antenna parameters
L = 0.0318898587342509  # Patch length (m)
W = 0.043738571495845674   # Patch width (m)
h = 0.0028269123393558824  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0105341824176759  # Feed x position
feed_y = 0.009880972950986996  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0799_ade870dc')
