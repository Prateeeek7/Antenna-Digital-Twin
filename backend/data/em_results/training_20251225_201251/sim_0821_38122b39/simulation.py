...
# Antenna parameters
L = 0.03075904516588041  # Patch length (m)
W = 0.03882431998459752   # Patch width (m)
h = 0.0018998531030887458  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008721491542106663  # Feed x position
feed_y = 0.012918431785443349  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0821_38122b39')
