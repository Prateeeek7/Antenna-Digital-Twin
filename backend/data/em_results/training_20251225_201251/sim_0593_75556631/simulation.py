...
# Antenna parameters
L = 0.025534570582942277  # Patch length (m)
W = 0.03989519317671655   # Patch width (m)
h = 0.002796119682679416  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010142665360035436  # Feed x position
feed_y = 0.01595807727068662  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0593_75556631')
