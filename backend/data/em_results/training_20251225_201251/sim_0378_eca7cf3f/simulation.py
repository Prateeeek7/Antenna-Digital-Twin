...
# Antenna parameters
L = 0.03289772132213448  # Patch length (m)
W = 0.031023609883499663   # Patch width (m)
h = 0.0028554704452980395  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0028782026234027208  # Feed x position
feed_y = 0.005455248002278645  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0378_eca7cf3f')
