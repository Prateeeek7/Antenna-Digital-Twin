...
# Antenna parameters
L = 0.030149989325349777  # Patch length (m)
W = 0.036206815842917385   # Patch width (m)
h = 0.000992253172405475  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01205999573013991  # Feed x position
feed_y = 0.012741686108309485  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0244_1ac5a560')
