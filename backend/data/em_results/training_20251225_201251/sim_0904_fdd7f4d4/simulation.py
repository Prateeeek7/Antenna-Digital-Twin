...
# Antenna parameters
L = 0.02669915225257228  # Patch length (m)
W = 0.04362879300285173   # Patch width (m)
h = 0.0008005438897084677  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018842851685165985  # Feed x position
feed_y = 0.01667201584829631  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0904_fdd7f4d4')
