...
# Antenna parameters
L = 0.030947543002570053  # Patch length (m)
W = 0.04067653880542099   # Patch width (m)
h = 0.002947934762879606  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012379017201028021  # Feed x position
feed_y = 0.009422516488270647  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0348_d5af70ba')
