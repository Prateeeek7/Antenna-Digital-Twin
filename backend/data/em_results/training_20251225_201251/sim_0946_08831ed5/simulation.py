...
# Antenna parameters
L = 0.03495683539857585  # Patch length (m)
W = 0.03696125802468135   # Patch width (m)
h = 0.002332776171876607  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010098388709922876  # Feed x position
feed_y = 0.010313867157623656  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0946_08831ed5')
