...
# Antenna parameters
L = 0.03348735966297725  # Patch length (m)
W = 0.03778218212177711   # Patch width (m)
h = 0.002415102963364657  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005971392946262035  # Feed x position
feed_y = 0.015112872848710844  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0688_c6474220')
