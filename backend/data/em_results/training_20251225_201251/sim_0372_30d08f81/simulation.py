...
# Antenna parameters
L = 0.03018417555258461  # Patch length (m)
W = 0.03567009716215281   # Patch width (m)
h = 0.0023096233325909776  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004383847435055139  # Feed x position
feed_y = 0.012205611196697637  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0372_30d08f81')
