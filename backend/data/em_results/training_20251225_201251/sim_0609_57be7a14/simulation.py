...
# Antenna parameters
L = 0.02527024595676174  # Patch length (m)
W = 0.030488085287629477   # Patch width (m)
h = 0.0028000579378690675  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015551478089320416  # Feed x position
feed_y = 0.012195234115051792  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0609_57be7a14')
