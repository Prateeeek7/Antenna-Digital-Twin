...
# Antenna parameters
L = 0.03420339416324496  # Patch length (m)
W = 0.04453867460433749   # Patch width (m)
h = 0.0015031108144116336  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013681357665297983  # Feed x position
feed_y = 0.004196080345194909  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0913_72430dec')
