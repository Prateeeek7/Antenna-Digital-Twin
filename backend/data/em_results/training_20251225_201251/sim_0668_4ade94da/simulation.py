...
# Antenna parameters
L = 0.030926598610463117  # Patch length (m)
W = 0.044792673404109404   # Patch width (m)
h = 0.0020092217563681077  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012075236147125804  # Feed x position
feed_y = 0.001982008715431824  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0668_4ade94da')
