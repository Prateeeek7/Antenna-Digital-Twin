...
# Antenna parameters
L = 0.030612910554809785  # Patch length (m)
W = 0.03900077778473227   # Patch width (m)
h = 0.0013877802563975108  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003714476238516401  # Feed x position
feed_y = 0.0030179840778779975  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0603_f9f875e1')
