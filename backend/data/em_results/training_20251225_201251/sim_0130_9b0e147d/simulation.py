...
# Antenna parameters
L = 0.03360598644442447  # Patch length (m)
W = 0.03358656547677924   # Patch width (m)
h = 0.001729588129258746  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.010699793392468706  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0130_9b0e147d')
