...
# Antenna parameters
L = 0.031397776320721035  # Patch length (m)
W = 0.03639838556052303   # Patch width (m)
h = 0.0025934170248563407  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.009066296418776728  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0362_77a37354')
