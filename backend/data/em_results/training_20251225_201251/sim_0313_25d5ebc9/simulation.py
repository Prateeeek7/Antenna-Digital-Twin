...
# Antenna parameters
L = 0.03343539068608927  # Patch length (m)
W = 0.03655378268999364   # Patch width (m)
h = 0.001702362066666944  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013374156274435708  # Feed x position
feed_y = 0.014621513075997456  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0313_25d5ebc9')
