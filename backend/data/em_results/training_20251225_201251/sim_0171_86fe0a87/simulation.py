...
# Antenna parameters
L = 0.03452530199111825  # Patch length (m)
W = 0.037338997576431554   # Patch width (m)
h = 0.0012994919222388541  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008245003721493907  # Feed x position
feed_y = 0.013731098613443592  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0171_86fe0a87')
