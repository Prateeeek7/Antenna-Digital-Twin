...
# Antenna parameters
L = 0.025529811484209623  # Patch length (m)
W = 0.04005817467359125   # Patch width (m)
h = 0.0028337166227882142  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034789423613212902  # Feed x position
feed_y = 0.015840391378162264  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0900_4cf1ced5')
