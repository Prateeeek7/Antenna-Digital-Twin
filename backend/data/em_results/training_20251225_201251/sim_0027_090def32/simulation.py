...
# Antenna parameters
L = 0.026649771961289703  # Patch length (m)
W = 0.041235621611801374   # Patch width (m)
h = 0.0031364424717513373  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0010155863628535094  # Feed x position
feed_y = 0.01649424864472055  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0027_090def32')
