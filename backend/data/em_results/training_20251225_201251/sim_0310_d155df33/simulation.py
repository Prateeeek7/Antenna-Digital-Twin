...
# Antenna parameters
L = 0.027418691096691497  # Patch length (m)
W = 0.03413341767447297   # Patch width (m)
h = 0.0021504728848907905  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007850392510218551  # Feed x position
feed_y = 0.013653367069789188  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0310_d155df33')
