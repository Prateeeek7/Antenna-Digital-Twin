...
# Antenna parameters
L = 0.032764681761442226  # Patch length (m)
W = 0.03067028127646446   # Patch width (m)
h = 0.00251894254534727  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013105872704576891  # Feed x position
feed_y = 0.008390710034410763  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0427_295171ac')
