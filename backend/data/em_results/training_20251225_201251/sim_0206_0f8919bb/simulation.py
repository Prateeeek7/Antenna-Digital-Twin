...
# Antenna parameters
L = 0.03074438181069937  # Patch length (m)
W = 0.037549203261974674   # Patch width (m)
h = 0.002303578558035797  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0066729591396422275  # Feed x position
feed_y = 0.0054743114672364795  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0206_0f8919bb')
