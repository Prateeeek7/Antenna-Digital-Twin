...
# Antenna parameters
L = 0.03004678914373588  # Patch length (m)
W = 0.04279210187516332   # Patch width (m)
h = 0.0008453521196501432  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004494005939383176  # Feed x position
feed_y = 0.011263109484455965  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0255_db2bdba6')
