...
# Antenna parameters
L = 0.029180113961014807  # Patch length (m)
W = 0.044087725381969436   # Patch width (m)
h = 0.0030110201248814443  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004297227584396108  # Feed x position
feed_y = 0.017635090152787775  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0196_12ed8389')
