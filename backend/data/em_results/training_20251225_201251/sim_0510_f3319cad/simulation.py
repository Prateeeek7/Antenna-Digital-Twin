...
# Antenna parameters
L = 0.03462456690823765  # Patch length (m)
W = 0.030007510796145387   # Patch width (m)
h = 0.0014344550228829818  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0019571536138354505  # Feed x position
feed_y = 0.012003004318458155  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0510_f3319cad')
