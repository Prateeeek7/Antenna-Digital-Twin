...
# Antenna parameters
L = 0.03323412365025347  # Patch length (m)
W = 0.03961922906495048   # Patch width (m)
h = 0.0021909376255636157  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012925476997388843  # Feed x position
feed_y = 0.010477222886734186  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0441_65802756')
