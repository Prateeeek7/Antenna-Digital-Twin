...
# Antenna parameters
L = 0.03382069315511456  # Patch length (m)
W = 0.03264581668487109   # Patch width (m)
h = 0.0010567155776427574  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009619323428334358  # Feed x position
feed_y = 0.0048935129251142535  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0286_456ec974')
