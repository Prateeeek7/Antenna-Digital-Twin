...
# Antenna parameters
L = 0.03069797691381158  # Patch length (m)
W = 0.04165417838838914   # Patch width (m)
h = 0.0019204654462805096  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009708335210580192  # Feed x position
feed_y = 0.011857865420695678  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0795_b3524dfa')
