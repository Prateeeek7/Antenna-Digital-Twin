...
# Antenna parameters
L = 0.026069001689428235  # Patch length (m)
W = 0.04484838895565567   # Patch width (m)
h = 0.003134923216548534  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010427600675771295  # Feed x position
feed_y = 0.0027330166705213  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0250_93480904')
