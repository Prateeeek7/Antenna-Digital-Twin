...
# Antenna parameters
L = 0.03493630528953819  # Patch length (m)
W = 0.04211588696396559   # Patch width (m)
h = 0.0027086497490147353  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013148109892583852  # Feed x position
feed_y = 0.013570999267174429  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0816_544120d0')
