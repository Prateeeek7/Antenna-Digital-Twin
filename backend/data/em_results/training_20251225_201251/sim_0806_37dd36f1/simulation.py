...
# Antenna parameters
L = 0.0339048912285073  # Patch length (m)
W = 0.04397467409893807   # Patch width (m)
h = 0.002437663099976198  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004449234796489034  # Feed x position
feed_y = 0.01758986963957523  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0806_37dd36f1')
