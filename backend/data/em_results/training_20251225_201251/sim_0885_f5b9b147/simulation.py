...
# Antenna parameters
L = 0.02947620734049414  # Patch length (m)
W = 0.03583219880673495   # Patch width (m)
h = 0.002244468548629115  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008736204600332226  # Feed x position
feed_y = 0.004962225059720217  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0885_f5b9b147')
