...
# Antenna parameters
L = 0.028979150252468746  # Patch length (m)
W = 0.040982458263231124   # Patch width (m)
h = 0.001611360847936042  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0115916601009875  # Feed x position
feed_y = 0.008902930645956634  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0756_7dad6038')
