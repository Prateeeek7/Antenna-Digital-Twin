...
# Antenna parameters
L = 0.0261470396713709  # Patch length (m)
W = 0.04203943121044367   # Patch width (m)
h = 0.0025270283480853762  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012451218334172895  # Feed x position
feed_y = 0.010766879465331038  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0186_08697e52')
