...
# Antenna parameters
L = 0.02879668250687541  # Patch length (m)
W = 0.032353946499436695   # Patch width (m)
h = 0.0015558634083148919  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009835276158737204  # Feed x position
feed_y = 0.004006840488102692  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0631_ec8dd900')
