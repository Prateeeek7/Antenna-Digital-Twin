...
# Antenna parameters
L = 0.03026607939977585  # Patch length (m)
W = 0.041081386093253784   # Patch width (m)
h = 0.002002995726297846  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007682834711881018  # Feed x position
feed_y = 0.0032603666044063594  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0309_6ebab5a9')
