...
# Antenna parameters
L = 0.029143016815921317  # Patch length (m)
W = 0.033810199321313274   # Patch width (m)
h = 0.0018524998969012127  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011145851908064958  # Feed x position
feed_y = 0.004504160788286598  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0452_4cdd18f1')
