...
# Antenna parameters
L = 0.03001744791100401  # Patch length (m)
W = 0.042404531385315136   # Patch width (m)
h = 0.0012639430205389306  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004826279001722736  # Feed x position
feed_y = 0.004634482867198998  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0829_7db5095f')
