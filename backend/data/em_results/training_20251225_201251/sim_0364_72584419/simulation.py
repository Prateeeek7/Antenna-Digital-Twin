...
# Antenna parameters
L = 0.027980720293918345  # Patch length (m)
W = 0.0407176228112788   # Patch width (m)
h = 0.0027475312219085403  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009966704630454765  # Feed x position
feed_y = 0.01628704912451152  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0364_72584419')
