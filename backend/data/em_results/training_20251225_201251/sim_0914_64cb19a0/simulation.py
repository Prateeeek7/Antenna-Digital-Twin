...
# Antenna parameters
L = 0.03416696557102608  # Patch length (m)
W = 0.04303685482995903   # Patch width (m)
h = 0.0017884094006736804  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003359224394695651  # Feed x position
feed_y = 0.008997959071332672  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0914_64cb19a0')
