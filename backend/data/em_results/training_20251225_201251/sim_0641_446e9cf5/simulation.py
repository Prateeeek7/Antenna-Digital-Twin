...
# Antenna parameters
L = 0.03463583295896918  # Patch length (m)
W = 0.031229945756328224   # Patch width (m)
h = 0.0031206498293219697  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012449938941608417  # Feed x position
feed_y = 0.008102681982181885  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0641_446e9cf5')
