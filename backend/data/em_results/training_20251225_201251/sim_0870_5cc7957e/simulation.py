...
# Antenna parameters
L = 0.028548170968160137  # Patch length (m)
W = 0.03401897478164406   # Patch width (m)
h = 0.001403225712535701  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011419268387264056  # Feed x position
feed_y = 0.013607589912657626  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0870_5cc7957e')
