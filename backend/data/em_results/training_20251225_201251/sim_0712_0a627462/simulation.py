...
# Antenna parameters
L = 0.03290288930646022  # Patch length (m)
W = 0.035317441005533544   # Patch width (m)
h = 0.0019138291847589934  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012286194753445851  # Feed x position
feed_y = 0.0015897554733937712  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0712_0a627462')
