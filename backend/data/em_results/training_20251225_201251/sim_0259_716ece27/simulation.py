...
# Antenna parameters
L = 0.03236621407212441  # Patch length (m)
W = 0.03992858040347626   # Patch width (m)
h = 0.0026260014496822066  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009309767424712458  # Feed x position
feed_y = 0.014705913839015634  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0259_716ece27')
