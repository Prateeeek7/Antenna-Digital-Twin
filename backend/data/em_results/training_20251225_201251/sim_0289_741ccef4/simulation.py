...
# Antenna parameters
L = 0.031204314302852965  # Patch length (m)
W = 0.037591313268055565   # Patch width (m)
h = 0.002308310674679134  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007947333359788734  # Feed x position
feed_y = 0.015036525307222227  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0289_741ccef4')
