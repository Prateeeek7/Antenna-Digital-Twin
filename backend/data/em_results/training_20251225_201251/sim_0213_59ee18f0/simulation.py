...
# Antenna parameters
L = 0.027030238716093086  # Patch length (m)
W = 0.03467400485797254   # Patch width (m)
h = 0.0014007549734701735  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010812095486437235  # Feed x position
feed_y = 0.013869601943189017  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0213_59ee18f0')
