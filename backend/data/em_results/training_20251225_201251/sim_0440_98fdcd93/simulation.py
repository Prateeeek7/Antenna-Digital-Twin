...
# Antenna parameters
L = 0.034838813226329216  # Patch length (m)
W = 0.03375094422853994   # Patch width (m)
h = 0.0009706526514038846  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01313099302228665  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0440_98fdcd93')
