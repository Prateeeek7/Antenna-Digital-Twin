...
# Antenna parameters
L = 0.025361692960612543  # Patch length (m)
W = 0.04060422375381594   # Patch width (m)
h = 0.002805253642953025  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0025502915131894225  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0472_d08c8fe0')
