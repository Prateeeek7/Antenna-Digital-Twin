...
# Antenna parameters
L = 0.025091593038294665  # Patch length (m)
W = 0.040794051709157564   # Patch width (m)
h = 0.0020638541981854034  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0011118090333027896  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0532_e02ff132')
