...
# Antenna parameters
L = 0.032799126601849284  # Patch length (m)
W = 0.042893384720641435   # Patch width (m)
h = 0.0022146050071451522  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011328257042135203  # Feed x position
feed_y = 0.017157353888256576  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0796_dcedf30f')
