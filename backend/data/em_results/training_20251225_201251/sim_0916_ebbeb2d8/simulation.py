...
# Antenna parameters
L = 0.03167322096414939  # Patch length (m)
W = 0.03936314097766416   # Patch width (m)
h = 0.0022835603394842077  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010848374922657444  # Feed x position
feed_y = 0.003194869664871586  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0916_ebbeb2d8')
