...
# Antenna parameters
L = 0.03474263294311518  # Patch length (m)
W = 0.041731703956699145   # Patch width (m)
h = 0.0016809894627264916  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002423235539089211  # Feed x position
feed_y = 0.01669268158267966  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0100_ad8953a2')
