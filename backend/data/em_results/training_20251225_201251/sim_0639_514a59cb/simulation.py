...
# Antenna parameters
L = 0.029396119464526978  # Patch length (m)
W = 0.0436566748463109   # Patch width (m)
h = 0.002606974161664073  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001305859350896754  # Feed x position
feed_y = 0.0038432761965338314  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0639_514a59cb')
