...
# Antenna parameters
L = 0.031373072284307454  # Patch length (m)
W = 0.04156462439695492   # Patch width (m)
h = 0.0008689702676654393  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004432015571956456  # Feed x position
feed_y = 0.01662584975878197  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0511_1f1289e9')
