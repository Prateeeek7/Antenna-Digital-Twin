...
# Antenna parameters
L = 0.026288294070314633  # Patch length (m)
W = 0.03201112319822435   # Patch width (m)
h = 0.002665805453264719  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010515317628125853  # Feed x position
feed_y = 0.004648160491042867  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0026_3fa19741')
