...
# Antenna parameters
L = 0.026748907177088856  # Patch length (m)
W = 0.03321487041556999   # Patch width (m)
h = 0.0018638881803288523  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007465971464634376  # Feed x position
feed_y = 0.011428149844616872  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0127_ee5cd53f')
