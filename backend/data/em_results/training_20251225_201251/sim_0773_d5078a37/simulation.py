...
# Antenna parameters
L = 0.02975675875785399  # Patch length (m)
W = 0.03704154291152973   # Patch width (m)
h = 0.0022129822698183335  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015381251844572652  # Feed x position
feed_y = 0.004843792136783414  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0773_d5078a37')
