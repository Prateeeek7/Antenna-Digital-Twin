...
# Antenna parameters
L = 0.027799281651302667  # Patch length (m)
W = 0.0350066980337965   # Patch width (m)
h = 0.0012308797929777946  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002182376459907273  # Feed x position
feed_y = 0.004778479655520155  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0797_29ae28b9')
