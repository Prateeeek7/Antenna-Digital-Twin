...
# Antenna parameters
L = 0.02929606369543168  # Patch length (m)
W = 0.04175523013354572   # Patch width (m)
h = 0.0031123891370311465  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0044694806451402854  # Feed x position
feed_y = 0.01092210069651303  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0055_a57908f8')
