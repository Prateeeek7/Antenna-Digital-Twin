...
# Antenna parameters
L = 0.029817636395646167  # Patch length (m)
W = 0.04186426323534375   # Patch width (m)
h = 0.0026188313556019097  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011927054558258467  # Feed x position
feed_y = 0.014062308080779157  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0288_20026b41')
