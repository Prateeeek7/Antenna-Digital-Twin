...
# Antenna parameters
L = 0.032300633303081354  # Patch length (m)
W = 0.03109218144631445   # Patch width (m)
h = 0.000977342450329202  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012920253321232542  # Feed x position
feed_y = 0.01241324952261523  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0294_75b3e7c6')
