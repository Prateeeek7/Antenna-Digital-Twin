...
# Antenna parameters
L = 0.032521097360381765  # Patch length (m)
W = 0.04451295066089569   # Patch width (m)
h = 0.0011348573797839712  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01148099549157474  # Feed x position
feed_y = 0.017805180264358275  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0245_aebda838')
