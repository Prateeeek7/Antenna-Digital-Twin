...
# Antenna parameters
L = 0.03317607630907078  # Patch length (m)
W = 0.040801270518595716   # Patch width (m)
h = 0.001233207400169287  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0068320428361838366  # Feed x position
feed_y = 0.016320508207438286  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0135_2fb37ea1')
