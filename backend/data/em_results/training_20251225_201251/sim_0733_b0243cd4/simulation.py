...
# Antenna parameters
L = 0.026515801894389443  # Patch length (m)
W = 0.031346831685083426   # Patch width (m)
h = 0.0025420913875781  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001890841854374287  # Feed x position
feed_y = 0.004661652829610043  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0733_b0243cd4')
