...
# Antenna parameters
L = 0.03336774702661218  # Patch length (m)
W = 0.043759139816217235   # Patch width (m)
h = 0.002633990279652067  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013347098810644872  # Feed x position
feed_y = 0.013567913432027415  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0550_c800731b')
