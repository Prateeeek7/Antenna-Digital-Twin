...
# Antenna parameters
L = 0.03274780420407798  # Patch length (m)
W = 0.035513041165708345   # Patch width (m)
h = 0.0018105378358392456  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011089484784788377  # Feed x position
feed_y = 0.0035297256159431065  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0395_941acf22')
