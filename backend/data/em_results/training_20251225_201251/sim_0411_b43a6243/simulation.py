...
# Antenna parameters
L = 0.02668520201497245  # Patch length (m)
W = 0.03366032931381318   # Patch width (m)
h = 0.0023204602955924584  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006162534834627289  # Feed x position
feed_y = 0.006983647851395189  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0411_b43a6243')
