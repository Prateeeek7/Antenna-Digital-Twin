...
# Antenna parameters
L = 0.03251616048186523  # Patch length (m)
W = 0.036826031350072806   # Patch width (m)
h = 0.0015868418534517436  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013006464192746092  # Feed x position
feed_y = 0.005664227992218534  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0580_4f062fbe')
