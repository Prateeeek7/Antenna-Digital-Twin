...
# Antenna parameters
L = 0.025107070640934964  # Patch length (m)
W = 0.04476166047223849   # Patch width (m)
h = 0.0021157710247495277  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002414067560952754  # Feed x position
feed_y = 0.015839392372405683  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0602_f386e7ec')
