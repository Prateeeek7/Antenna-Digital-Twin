...
# Antenna parameters
L = 0.029600767764647304  # Patch length (m)
W = 0.03819691086026619   # Patch width (m)
h = 0.0028313191450156146  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011840307105858922  # Feed x position
feed_y = 0.015278764344106478  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0817_ade405e3')
