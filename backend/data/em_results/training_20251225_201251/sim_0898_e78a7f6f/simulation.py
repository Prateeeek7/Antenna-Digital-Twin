...
# Antenna parameters
L = 0.02940475077904296  # Patch length (m)
W = 0.035342243532232705   # Patch width (m)
h = 0.0027008092945816674  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008834551355000745  # Feed x position
feed_y = 0.005614620988883969  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0898_e78a7f6f')
