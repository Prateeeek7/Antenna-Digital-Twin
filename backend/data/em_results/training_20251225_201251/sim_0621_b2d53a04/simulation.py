...
# Antenna parameters
L = 0.03292323981039911  # Patch length (m)
W = 0.04364502788514511   # Patch width (m)
h = 0.0019984485751086602  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013169295924159644  # Feed x position
feed_y = 0.007617416790024852  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0621_b2d53a04')
