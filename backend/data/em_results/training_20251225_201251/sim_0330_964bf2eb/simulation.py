...
# Antenna parameters
L = 0.025017339691273784  # Patch length (m)
W = 0.039640887984094667   # Patch width (m)
h = 0.0013849886519597182  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004113663232254387  # Feed x position
feed_y = 0.01585635519363787  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0330_964bf2eb')
