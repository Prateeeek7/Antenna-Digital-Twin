...
# Antenna parameters
L = 0.02593646662304932  # Patch length (m)
W = 0.03556818804188053   # Patch width (m)
h = 0.0008484029118193232  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0036204554147836973  # Feed x position
feed_y = 0.0018954880329561383  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0228_f73cab60')
