...
# Antenna parameters
L = 0.03417857541927716  # Patch length (m)
W = 0.04229005027080941   # Patch width (m)
h = 0.0031675619373488333  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01135543575910803  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0778_aa669bb2')
