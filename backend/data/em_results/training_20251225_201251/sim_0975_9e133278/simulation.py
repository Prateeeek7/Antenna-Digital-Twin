...
# Antenna parameters
L = 0.03370445580402554  # Patch length (m)
W = 0.03685167149030559   # Patch width (m)
h = 0.0010791669654533782  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013340434251057064  # Feed x position
feed_y = 0.006534474491184248  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0975_9e133278')
