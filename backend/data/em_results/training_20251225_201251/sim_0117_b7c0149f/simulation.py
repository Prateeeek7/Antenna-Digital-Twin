...
# Antenna parameters
L = 0.03428369167759636  # Patch length (m)
W = 0.036672337401263445   # Patch width (m)
h = 0.0010343867464745371  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005876368693453888  # Feed x position
feed_y = 0.013751671364341455  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0117_b7c0149f')
