...
# Antenna parameters
L = 0.0304900875537186  # Patch length (m)
W = 0.04151613573865742   # Patch width (m)
h = 0.0012723452209347508  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0013396745967035049  # Feed x position
feed_y = 0.0014622967848796269  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0479_4fb68b13')
