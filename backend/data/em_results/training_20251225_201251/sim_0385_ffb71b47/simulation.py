...
# Antenna parameters
L = 0.0262295403675066  # Patch length (m)
W = 0.03974471681259652   # Patch width (m)
h = 0.002101492617565497  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01589788672503861  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0385_ffb71b47')
