...
# Antenna parameters
L = 0.03337581599955843  # Patch length (m)
W = 0.039727888009873646   # Patch width (m)
h = 0.00252265857711631  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009035293010558651  # Feed x position
feed_y = 0.00626576784421029  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0097_46c8c6be')
