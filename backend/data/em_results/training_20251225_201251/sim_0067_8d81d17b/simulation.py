...
# Antenna parameters
L = 0.02500385620259458  # Patch length (m)
W = 0.03328357356377655   # Patch width (m)
h = 0.001967058282492149  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003011908344265868  # Feed x position
feed_y = 0.013313429425510621  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0067_8d81d17b')
