...
# Antenna parameters
L = 0.0331058139169921  # Patch length (m)
W = 0.03975338517875787   # Patch width (m)
h = 0.0010431890446080594  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007956425572265152  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0073_bea2737c')
