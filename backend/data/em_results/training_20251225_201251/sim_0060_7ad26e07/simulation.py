...
# Antenna parameters
L = 0.03335221003645422  # Patch length (m)
W = 0.034647981716873805   # Patch width (m)
h = 0.0012523134367137256  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007912574649071809  # Feed x position
feed_y = 0.013859192686749523  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0060_7ad26e07')
