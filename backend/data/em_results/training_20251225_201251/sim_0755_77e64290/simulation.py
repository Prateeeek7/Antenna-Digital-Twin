...
# Antenna parameters
L = 0.031715086964673005  # Patch length (m)
W = 0.0438044331256795   # Patch width (m)
h = 0.0013278121783815596  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012658156890100282  # Feed x position
feed_y = 0.012441294949435003  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0755_77e64290')
