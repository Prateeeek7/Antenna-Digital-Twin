...
# Antenna parameters
L = 0.030872742990292776  # Patch length (m)
W = 0.04028897068714336   # Patch width (m)
h = 0.0016311395670529144  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00800172675315708  # Feed x position
feed_y = 0.015354985902597401  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0485_96b3056b')
