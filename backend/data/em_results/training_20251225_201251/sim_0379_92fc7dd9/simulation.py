...
# Antenna parameters
L = 0.03333822998588879  # Patch length (m)
W = 0.043520161907085256   # Patch width (m)
h = 0.0012841399255024875  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013334209389024444  # Feed x position
feed_y = 0.008028274482045107  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0379_92fc7dd9')
