...
# Antenna parameters
L = 0.03363939669181426  # Patch length (m)
W = 0.037307666796808595   # Patch width (m)
h = 0.002632044359048799  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011457885354188683  # Feed x position
feed_y = 0.005233740175651496  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0298_262da2bb')
