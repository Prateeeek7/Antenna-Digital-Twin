...
# Antenna parameters
L = 0.028988148206550466  # Patch length (m)
W = 0.033306567438993934   # Patch width (m)
h = 0.0026885554540224455  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.011424896210215545  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0143_28c46f1c')
