...
# Antenna parameters
L = 0.028021044954228032  # Patch length (m)
W = 0.033938484761276616   # Patch width (m)
h = 0.0009253594986365428  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013575393904510647  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0428_e40e1319')
