...
# Antenna parameters
L = 0.031926424017897775  # Patch length (m)
W = 0.03011281622388285   # Patch width (m)
h = 0.0010772146166164295  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01277056960715911  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0899_af7e460b')
