...
# Antenna parameters
L = 0.029048460364174227  # Patch length (m)
W = 0.0329186579950118   # Patch width (m)
h = 0.0008393127955376723  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00713237158388604  # Feed x position
feed_y = 0.013167463198004721  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0222_74326cdc')
