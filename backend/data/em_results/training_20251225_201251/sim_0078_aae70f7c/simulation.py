...
# Antenna parameters
L = 0.02748362926116009  # Patch length (m)
W = 0.03674817117482497   # Patch width (m)
h = 0.002984988180800074  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005418588570011124  # Feed x position
feed_y = 0.0015799453099140017  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0078_aae70f7c')
