...
# Antenna parameters
L = 0.03161432243883159  # Patch length (m)
W = 0.0357879366547876   # Patch width (m)
h = 0.0012210462276345797  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012645728975532636  # Feed x position
feed_y = 0.008402454873168064  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0762_8fcf980c')
