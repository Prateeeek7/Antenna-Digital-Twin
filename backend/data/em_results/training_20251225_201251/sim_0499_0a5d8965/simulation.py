...
# Antenna parameters
L = 0.03212477858552791  # Patch length (m)
W = 0.03176171620319484   # Patch width (m)
h = 0.0026474918213533374  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006620604440869706  # Feed x position
feed_y = 0.006137973888859045  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0499_0a5d8965')
