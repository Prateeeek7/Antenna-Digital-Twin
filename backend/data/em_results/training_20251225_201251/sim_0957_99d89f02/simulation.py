...
# Antenna parameters
L = 0.025661319827055676  # Patch length (m)
W = 0.032335216522217394   # Patch width (m)
h = 0.0021086009690096355  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.005437416424729691  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0957_99d89f02')
