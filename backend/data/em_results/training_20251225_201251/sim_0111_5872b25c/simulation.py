...
# Antenna parameters
L = 0.03396767147715057  # Patch length (m)
W = 0.03886061911004528   # Patch width (m)
h = 0.0014396235258982363  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005832479405581734  # Feed x position
feed_y = 0.01499061419954631  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0111_5872b25c')
