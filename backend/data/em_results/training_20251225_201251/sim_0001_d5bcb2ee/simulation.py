...
# Antenna parameters
L = 0.03254024377648364  # Patch length (m)
W = 0.04201858290447014   # Patch width (m)
h = 0.002434913445667336  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007319470425289642  # Feed x position
feed_y = 0.01568447842538436  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0001_d5bcb2ee')
