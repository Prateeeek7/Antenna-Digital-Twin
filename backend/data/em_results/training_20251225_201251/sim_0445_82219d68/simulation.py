...
# Antenna parameters
L = 0.028827466923992948  # Patch length (m)
W = 0.03516442091385783   # Patch width (m)
h = 0.0013998388263734363  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010334088340887525  # Feed x position
feed_y = 0.014065768365543133  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0445_82219d68')
