...
# Antenna parameters
L = 0.029611794429173603  # Patch length (m)
W = 0.037391388703931785   # Patch width (m)
h = 0.0017399340546525983  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002159049890792012  # Feed x position
feed_y = 0.014087813593318857  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0308_979469be')
