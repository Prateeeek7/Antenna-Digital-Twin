...
# Antenna parameters
L = 0.026507989838513227  # Patch length (m)
W = 0.03477359556317869   # Patch width (m)
h = 0.0008899545669554189  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006883417261358902  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0878_23b4eb30')
