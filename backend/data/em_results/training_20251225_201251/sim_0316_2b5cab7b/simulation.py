...
# Antenna parameters
L = 0.03269110100992928  # Patch length (m)
W = 0.03224528478086055   # Patch width (m)
h = 0.002140636012078378  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007171314673059003  # Feed x position
feed_y = 0.002344130640624226  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0316_2b5cab7b')
