...
# Antenna parameters
L = 0.030300467962254916  # Patch length (m)
W = 0.03136206870617384   # Patch width (m)
h = 0.0030080974897464434  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012120187184901966  # Feed x position
feed_y = 0.0105903285315837  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0620_ac031db3')
