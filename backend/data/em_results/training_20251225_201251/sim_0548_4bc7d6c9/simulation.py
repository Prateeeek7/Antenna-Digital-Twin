...
# Antenna parameters
L = 0.03173906890669142  # Patch length (m)
W = 0.041192333870787516   # Patch width (m)
h = 0.00120758005319003  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.006356789323824054  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0548_4bc7d6c9')
