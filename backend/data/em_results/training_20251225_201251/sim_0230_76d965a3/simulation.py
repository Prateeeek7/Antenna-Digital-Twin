...
# Antenna parameters
L = 0.029578560913039217  # Patch length (m)
W = 0.034591813968305116   # Patch width (m)
h = 0.002587769371440868  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009758654569300043  # Feed x position
feed_y = 0.013836725587322046  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0230_76d965a3')
