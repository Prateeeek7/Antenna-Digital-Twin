...
# Antenna parameters
L = 0.025736916667960474  # Patch length (m)
W = 0.035998090857025065   # Patch width (m)
h = 0.0010842794247394203  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004366203207582028  # Feed x position
feed_y = 0.0069103747419369714  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0306_c8e55c8a')
