...
# Antenna parameters
L = 0.028403007291909862  # Patch length (m)
W = 0.040929649608005166   # Patch width (m)
h = 0.0018837215505415205  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009300373231409274  # Feed x position
feed_y = 0.010957531277763713  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0842_ef2cd15a')
