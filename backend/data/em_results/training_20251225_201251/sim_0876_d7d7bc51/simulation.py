...
# Antenna parameters
L = 0.028074780026129544  # Patch length (m)
W = 0.0404201984285117   # Patch width (m)
h = 0.002337859816338141  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003502727431123806  # Feed x position
feed_y = 0.016168079371404683  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0876_d7d7bc51')
