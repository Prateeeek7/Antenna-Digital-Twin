...
# Antenna parameters
L = 0.02637122523018776  # Patch length (m)
W = 0.042870606056069106   # Patch width (m)
h = 0.0019058519930440832  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0036137567950270556  # Feed x position
feed_y = 0.017148242422427643  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0524_bd72f53c')
