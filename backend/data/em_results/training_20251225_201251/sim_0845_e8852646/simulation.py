...
# Antenna parameters
L = 0.03497127249741562  # Patch length (m)
W = 0.034880951930099234   # Patch width (m)
h = 0.0030939765016327306  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009345081849263836  # Feed x position
feed_y = 0.013952380772039695  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0845_e8852646')
