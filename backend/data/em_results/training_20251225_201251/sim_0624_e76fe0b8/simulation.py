...
# Antenna parameters
L = 0.032448378200650566  # Patch length (m)
W = 0.031930014342974454   # Patch width (m)
h = 0.001980004997455253  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012979351280260227  # Feed x position
feed_y = 0.012772005737189783  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0624_e76fe0b8')
