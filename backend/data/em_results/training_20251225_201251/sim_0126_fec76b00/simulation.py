...
# Antenna parameters
L = 0.026830752983327804  # Patch length (m)
W = 0.03655766125364074   # Patch width (m)
h = 0.0023815112702547173  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006058750232004129  # Feed x position
feed_y = 0.01193518624818649  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0126_fec76b00')
