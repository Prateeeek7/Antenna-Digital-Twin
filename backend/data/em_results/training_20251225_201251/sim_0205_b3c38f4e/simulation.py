...
# Antenna parameters
L = 0.029026975197188623  # Patch length (m)
W = 0.030435786966005008   # Patch width (m)
h = 0.0028463207948274645  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01161079007887545  # Feed x position
feed_y = 0.012174314786402005  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0205_b3c38f4e')
