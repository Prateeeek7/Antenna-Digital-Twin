...
# Antenna parameters
L = 0.02788798217889281  # Patch length (m)
W = 0.038368126144810416   # Patch width (m)
h = 0.002512389125623537  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009359971115486605  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0087_56759748')
