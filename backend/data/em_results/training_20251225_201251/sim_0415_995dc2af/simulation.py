...
# Antenna parameters
L = 0.0255546927670894  # Patch length (m)
W = 0.03490535209400377   # Patch width (m)
h = 0.003036352440092586  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009221392988583679  # Feed x position
feed_y = 0.00849891098722499  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0415_995dc2af')
