...
# Antenna parameters
L = 0.030730011713890455  # Patch length (m)
W = 0.04103664081501609   # Patch width (m)
h = 0.002239311458207448  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011765746580575637  # Feed x position
feed_y = 0.005698699395068034  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0371_42541789')
