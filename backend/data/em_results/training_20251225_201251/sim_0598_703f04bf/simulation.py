...
# Antenna parameters
L = 0.03048209134869137  # Patch length (m)
W = 0.04051767178918842   # Patch width (m)
h = 0.0027672570955804697  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012192836539476549  # Feed x position
feed_y = 0.014230555691304249  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0598_703f04bf')
