...
# Antenna parameters
L = 0.02733979631526316  # Patch length (m)
W = 0.042622454312927584   # Patch width (m)
h = 0.0009059456700795821  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001999779325673673  # Feed x position
feed_y = 0.010979635685538855  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0827_7651aac1')
