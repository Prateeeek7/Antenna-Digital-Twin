...
# Antenna parameters
L = 0.030122563996348925  # Patch length (m)
W = 0.03727465289858127   # Patch width (m)
h = 0.0008288498608791026  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037747014991568414  # Feed x position
feed_y = 0.0060623623599592846  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0174_30c47d23')
