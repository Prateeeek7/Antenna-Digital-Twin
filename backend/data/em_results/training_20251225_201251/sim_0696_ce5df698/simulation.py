...
# Antenna parameters
L = 0.02633557851442536  # Patch length (m)
W = 0.03856942139911812   # Patch width (m)
h = 0.0026843880233808903  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014805469545459496  # Feed x position
feed_y = 0.007816093612519955  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0696_ce5df698')
