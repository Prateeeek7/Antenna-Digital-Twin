...
# Antenna parameters
L = 0.027491994228824847  # Patch length (m)
W = 0.03543219523996493   # Patch width (m)
h = 0.001032431618707102  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009325522489248466  # Feed x position
feed_y = 0.007542002970981774  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0536_d29ce5ad')
