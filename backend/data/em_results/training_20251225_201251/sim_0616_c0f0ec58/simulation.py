...
# Antenna parameters
L = 0.03388778047748553  # Patch length (m)
W = 0.03212829139117771   # Patch width (m)
h = 0.003162417645929801  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004629394119746143  # Feed x position
feed_y = 0.00989935383464787  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0616_c0f0ec58')
