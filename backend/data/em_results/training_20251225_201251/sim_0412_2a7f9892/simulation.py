...
# Antenna parameters
L = 0.028930545834275602  # Patch length (m)
W = 0.04375101285880087   # Patch width (m)
h = 0.002872390246624245  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00566907495771746  # Feed x position
feed_y = 0.0030095522169438075  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0412_2a7f9892')
