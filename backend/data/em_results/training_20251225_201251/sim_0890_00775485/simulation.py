...
# Antenna parameters
L = 0.03102157757752079  # Patch length (m)
W = 0.0365253950389024   # Patch width (m)
h = 0.0014128318284511914  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009110099672614778  # Feed x position
feed_y = 0.01461015801556096  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0890_00775485')
