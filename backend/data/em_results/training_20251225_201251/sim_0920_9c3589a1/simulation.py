...
# Antenna parameters
L = 0.033803769147425305  # Patch length (m)
W = 0.03178615478011428   # Patch width (m)
h = 0.002933632183817787  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002929912978626054  # Feed x position
feed_y = 0.002643020003892353  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0920_9c3589a1')
