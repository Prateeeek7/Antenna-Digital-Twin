...
# Antenna parameters
L = 0.02738981839456086  # Patch length (m)
W = 0.030381064293379712   # Patch width (m)
h = 0.0010298449267047516  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005534470401271234  # Feed x position
feed_y = 0.001181008208600407  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0165_6df371dd')
