...
# Antenna parameters
L = 0.033625059363963386  # Patch length (m)
W = 0.03856049592131786   # Patch width (m)
h = 0.0010172546410160581  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013450023745585356  # Feed x position
feed_y = 0.005085658667556878  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0384_633916a5')
