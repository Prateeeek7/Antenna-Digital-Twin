...
# Antenna parameters
L = 0.03010000578090776  # Patch length (m)
W = 0.033382253108960466   # Patch width (m)
h = 0.001128571522191294  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012040002312363105  # Feed x position
feed_y = 0.003288541434056358  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0226_03c74e09')
