...
# Antenna parameters
L = 0.02845225092096619  # Patch length (m)
W = 0.042472551142817304   # Patch width (m)
h = 0.0011035124289829946  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0044179187458733855  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0266_10187e3f')
