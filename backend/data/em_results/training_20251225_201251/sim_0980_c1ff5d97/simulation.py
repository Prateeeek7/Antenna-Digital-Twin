...
# Antenna parameters
L = 0.025415011710755733  # Patch length (m)
W = 0.043990672610952866   # Patch width (m)
h = 0.001310768272484714  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00936697726571375  # Feed x position
feed_y = 0.012983623395847273  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0980_c1ff5d97')
