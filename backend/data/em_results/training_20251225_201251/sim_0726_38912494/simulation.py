...
# Antenna parameters
L = 0.027598936113169877  # Patch length (m)
W = 0.03603052286824414   # Patch width (m)
h = 0.0010241627399117592  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011039574445267951  # Feed x position
feed_y = 0.012888315822752561  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0726_38912494')
