...
# Antenna parameters
L = 0.030002540556440645  # Patch length (m)
W = 0.042649773004294525   # Patch width (m)
h = 0.0029910811161390394  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003343315030965591  # Feed x position
feed_y = 0.01705990920171781  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0947_57615787')
