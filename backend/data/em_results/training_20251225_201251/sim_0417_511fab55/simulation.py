...
# Antenna parameters
L = 0.03125736524571811  # Patch length (m)
W = 0.03783967173248818   # Patch width (m)
h = 0.001667962734435089  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010256842597595713  # Feed x position
feed_y = 0.015135868692995273  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0417_511fab55')
