...
# Antenna parameters
L = 0.028674916558373047  # Patch length (m)
W = 0.043954015213267264   # Patch width (m)
h = 0.002545506921605037  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0031795282614474553  # Feed x position
feed_y = 0.009465864063876282  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0769_e308e4a1')
