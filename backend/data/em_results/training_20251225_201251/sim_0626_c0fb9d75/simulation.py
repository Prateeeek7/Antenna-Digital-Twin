...
# Antenna parameters
L = 0.02728573204378336  # Patch length (m)
W = 0.044656483420302734   # Patch width (m)
h = 0.001366164040181298  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009876848934694671  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0626_c0fb9d75')
