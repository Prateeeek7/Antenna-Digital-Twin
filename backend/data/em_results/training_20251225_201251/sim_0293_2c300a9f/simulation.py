...
# Antenna parameters
L = 0.025223271466053153  # Patch length (m)
W = 0.03173347860379786   # Patch width (m)
h = 0.002681051250553611  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010004534346686685  # Feed x position
feed_y = 0.0017585285979843936  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0293_2c300a9f')
