...
# Antenna parameters
L = 0.033244326394409864  # Patch length (m)
W = 0.033512568936912096   # Patch width (m)
h = 0.0013514329037563593  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013297730557763947  # Feed x position
feed_y = 0.0011678831102156456  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0887_ce90faa6')
