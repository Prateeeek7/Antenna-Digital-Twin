...
# Antenna parameters
L = 0.026317396514565848  # Patch length (m)
W = 0.04061516264338548   # Patch width (m)
h = 0.0016394180411527322  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01052695860582634  # Feed x position
feed_y = 0.01624606505735419  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0150_e1990ef9')
