...
# Antenna parameters
L = 0.028146103288140174  # Patch length (m)
W = 0.043182585788646276   # Patch width (m)
h = 0.0010105381710188118  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007446336231855765  # Feed x position
feed_y = 0.00819444877626727  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0984_4d83036f')
