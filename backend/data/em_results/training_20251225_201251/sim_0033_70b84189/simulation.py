...
# Antenna parameters
L = 0.030556290777161377  # Patch length (m)
W = 0.03451755315385301   # Patch width (m)
h = 0.0014604601964670458  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012222516310864552  # Feed x position
feed_y = 0.00652463044489535  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0033_70b84189')
