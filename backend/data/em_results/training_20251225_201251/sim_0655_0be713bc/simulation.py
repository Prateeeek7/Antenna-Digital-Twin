...
# Antenna parameters
L = 0.029731801888918146  # Patch length (m)
W = 0.03150774797022978   # Patch width (m)
h = 0.0021235199393899646  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011892720755567259  # Feed x position
feed_y = 0.004629980736755342  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0655_0be713bc')
