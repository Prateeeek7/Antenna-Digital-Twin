...
# Antenna parameters
L = 0.03277198518189141  # Patch length (m)
W = 0.04241642170769059   # Patch width (m)
h = 0.0027803614187769847  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013108794072756565  # Feed x position
feed_y = 0.008445089120389932  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0085_aba89134')
