...
# Antenna parameters
L = 0.03444373344817997  # Patch length (m)
W = 0.0395989379929234   # Patch width (m)
h = 0.0029208391002490176  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011454731897695856  # Feed x position
feed_y = 0.011452365950132853  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0994_694405d9')
