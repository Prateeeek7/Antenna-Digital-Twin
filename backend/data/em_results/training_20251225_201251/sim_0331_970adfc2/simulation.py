...
# Antenna parameters
L = 0.034645979522018436  # Patch length (m)
W = 0.04475662965788181   # Patch width (m)
h = 0.0008795679894787803  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008931747460540174  # Feed x position
feed_y = 0.0018789925905762356  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0331_970adfc2')
