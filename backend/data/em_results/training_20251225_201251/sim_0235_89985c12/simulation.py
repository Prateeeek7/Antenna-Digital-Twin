...
# Antenna parameters
L = 0.02754249734012052  # Patch length (m)
W = 0.03803302980543214   # Patch width (m)
h = 0.0010127170295834676  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005312683477437337  # Feed x position
feed_y = 0.004065571540329422  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0235_89985c12')
