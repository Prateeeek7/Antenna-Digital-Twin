...
# Antenna parameters
L = 0.03145936027457592  # Patch length (m)
W = 0.032163938093322124   # Patch width (m)
h = 0.0031901557136270026  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.009965815728521031  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0663_fd8546cb')
