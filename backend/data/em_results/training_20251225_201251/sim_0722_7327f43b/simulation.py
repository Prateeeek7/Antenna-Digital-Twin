...
# Antenna parameters
L = 0.02671343952394939  # Patch length (m)
W = 0.0343300873188253   # Patch width (m)
h = 0.002999323941483432  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004475966914287909  # Feed x position
feed_y = 0.0037659666918832603  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0722_7327f43b')
