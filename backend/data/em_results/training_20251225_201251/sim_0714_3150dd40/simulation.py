...
# Antenna parameters
L = 0.03442238051821436  # Patch length (m)
W = 0.03167789324762416   # Patch width (m)
h = 0.00169926307540169  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006050667381531946  # Feed x position
feed_y = 0.01076537849938074  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0714_3150dd40')
