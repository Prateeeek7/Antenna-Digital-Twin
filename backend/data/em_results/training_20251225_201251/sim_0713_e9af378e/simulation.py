...
# Antenna parameters
L = 0.02521187809448149  # Patch length (m)
W = 0.034262088999572025   # Patch width (m)
h = 0.0026036410212023093  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021324559263297214  # Feed x position
feed_y = 0.01370483559982881  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0713_e9af378e')
