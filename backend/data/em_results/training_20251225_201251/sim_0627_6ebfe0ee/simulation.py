...
# Antenna parameters
L = 0.027862389784270185  # Patch length (m)
W = 0.04260235412638551   # Patch width (m)
h = 0.0017358636375718402  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006230352068080843  # Feed x position
feed_y = 0.009471003074902326  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0627_6ebfe0ee')
