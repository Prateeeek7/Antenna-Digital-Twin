...
# Antenna parameters
L = 0.028903138706899974  # Patch length (m)
W = 0.038926253501281066   # Patch width (m)
h = 0.0018981085536980587  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011561255482759991  # Feed x position
feed_y = 0.013262578346101306  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0932_2fb0e7a4')
