...
# Antenna parameters
L = 0.03393629371738495  # Patch length (m)
W = 0.0373319446597638   # Patch width (m)
h = 0.0017381323487744686  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0013554176219451285  # Feed x position
feed_y = 0.014316818696026096  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0774_b8765ade')
