...
# Antenna parameters
L = 0.03275774822333895  # Patch length (m)
W = 0.0406981049253156   # Patch width (m)
h = 0.002847565191518663  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01310309928933558  # Feed x position
feed_y = 0.01627924197012624  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0315_2f77e04d')
