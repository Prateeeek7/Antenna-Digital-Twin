...
# Antenna parameters
L = 0.025143892298667647  # Patch length (m)
W = 0.034746696887398655   # Patch width (m)
h = 0.001367849200399858  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0063025979552159325  # Feed x position
feed_y = 0.013069522329351825  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0166_1135656a')
