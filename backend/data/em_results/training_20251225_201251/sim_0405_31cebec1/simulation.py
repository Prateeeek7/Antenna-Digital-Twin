...
# Antenna parameters
L = 0.033416059280258315  # Patch length (m)
W = 0.04477784546167089   # Patch width (m)
h = 0.0028678931896539374  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007643414948228001  # Feed x position
feed_y = 0.011360284572525671  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0405_31cebec1')
