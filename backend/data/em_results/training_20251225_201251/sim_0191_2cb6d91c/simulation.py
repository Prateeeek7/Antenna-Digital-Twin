...
# Antenna parameters
L = 0.026261120111713946  # Patch length (m)
W = 0.043293339619300084   # Patch width (m)
h = 0.0024523576123489095  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0020025337318476093  # Feed x position
feed_y = 0.016591528514482635  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0191_2cb6d91c')
