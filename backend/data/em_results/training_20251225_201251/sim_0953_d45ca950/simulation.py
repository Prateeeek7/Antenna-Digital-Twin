...
# Antenna parameters
L = 0.02747727511407883  # Patch length (m)
W = 0.04193011774849774   # Patch width (m)
h = 0.0012738328517816486  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021952371948560753  # Feed x position
feed_y = 0.005960168895630515  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0953_d45ca950')
