...
# Antenna parameters
L = 0.028202979978188897  # Patch length (m)
W = 0.041315280772766985   # Patch width (m)
h = 0.0024616341606643498  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005777151804832367  # Feed x position
feed_y = 0.014960522788457596  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0098_02fdfea9')
