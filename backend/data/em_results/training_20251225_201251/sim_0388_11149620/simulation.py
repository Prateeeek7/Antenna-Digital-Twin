...
# Antenna parameters
L = 0.02737776409679124  # Patch length (m)
W = 0.03980317658397401   # Patch width (m)
h = 0.001547806567234269  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0026258469798227254  # Feed x position
feed_y = 0.0020135548270706727  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0388_11149620')
