...
# Antenna parameters
L = 0.03435199328180041  # Patch length (m)
W = 0.042921072285402165   # Patch width (m)
h = 0.0016141205880441849  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013740797312720163  # Feed x position
feed_y = 0.017168428914160868  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0989_77915aff')
