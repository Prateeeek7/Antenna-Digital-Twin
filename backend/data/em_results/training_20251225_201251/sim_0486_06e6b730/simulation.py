...
# Antenna parameters
L = 0.03386171802147511  # Patch length (m)
W = 0.0337392247415524   # Patch width (m)
h = 0.0012281931768913497  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008866310540643437  # Feed x position
feed_y = 0.008372434611884349  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0486_06e6b730')
