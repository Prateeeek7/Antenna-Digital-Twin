...
# Antenna parameters
L = 0.03177932481519813  # Patch length (m)
W = 0.040049207893478996   # Patch width (m)
h = 0.002208798755014003  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005061869383598748  # Feed x position
feed_y = 0.014422227909168616  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0231_f037d5bd')
