...
# Antenna parameters
L = 0.025672605685315236  # Patch length (m)
W = 0.0427679869261184   # Patch width (m)
h = 0.0025014824870964246  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010269042274126096  # Feed x position
feed_y = 0.01710719477044736  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0128_1e447e0a')
