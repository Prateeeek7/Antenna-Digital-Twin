...
# Antenna parameters
L = 0.026966753563328897  # Patch length (m)
W = 0.03297717428678721   # Patch width (m)
h = 0.0011541652377028613  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010104467263343056  # Feed x position
feed_y = 0.012879266414921224  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0461_d1f04d7e')
