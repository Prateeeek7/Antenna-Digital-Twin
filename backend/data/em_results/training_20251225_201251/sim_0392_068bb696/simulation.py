...
# Antenna parameters
L = 0.03115385263255812  # Patch length (m)
W = 0.03971374119585212   # Patch width (m)
h = 0.0015642275792563495  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012461541053023249  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0392_068bb696')
