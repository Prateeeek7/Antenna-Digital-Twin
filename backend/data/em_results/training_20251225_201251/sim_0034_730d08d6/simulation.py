...
# Antenna parameters
L = 0.0302170908216186  # Patch length (m)
W = 0.03920227414306152   # Patch width (m)
h = 0.003103385683782638  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012086836328647441  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0034_730d08d6')
