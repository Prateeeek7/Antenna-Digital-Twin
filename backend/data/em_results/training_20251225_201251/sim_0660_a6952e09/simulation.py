...
# Antenna parameters
L = 0.030280574907366804  # Patch length (m)
W = 0.032500212390423486   # Patch width (m)
h = 0.002544185746203486  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009053900846342212  # Feed x position
feed_y = 0.0027183390573122224  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0660_a6952e09')
