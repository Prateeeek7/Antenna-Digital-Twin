...
# Antenna parameters
L = 0.02995548854255989  # Patch length (m)
W = 0.042378156626939986   # Patch width (m)
h = 0.0025735838821180084  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005432604595042077  # Feed x position
feed_y = 0.007082421376688433  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0692_f2e5edb7')
