...
# Antenna parameters
L = 0.028588093572433942  # Patch length (m)
W = 0.043922679387955084   # Patch width (m)
h = 0.002340610233974317  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005281804247724689  # Feed x position
feed_y = 0.017128190599035142  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0915_1dbb2bf8')
