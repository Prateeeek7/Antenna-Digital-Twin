...
# Antenna parameters
L = 0.02773957933557947  # Patch length (m)
W = 0.03768892877396717   # Patch width (m)
h = 0.0021563438319573518  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011095831734231789  # Feed x position
feed_y = 0.014007090187496938  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0855_246adfac')
