...
# Antenna parameters
L = 0.03229929510494643  # Patch length (m)
W = 0.03208975085078223   # Patch width (m)
h = 0.0014167960859656882  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008160808561255636  # Feed x position
feed_y = 0.01130761991356051  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0910_cefc4237')
