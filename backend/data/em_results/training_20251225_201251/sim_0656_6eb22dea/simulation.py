...
# Antenna parameters
L = 0.03294335359809074  # Patch length (m)
W = 0.031619495850462205   # Patch width (m)
h = 0.0029137384758774003  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021232941832048787  # Feed x position
feed_y = 0.00442371407078494  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0656_6eb22dea')
