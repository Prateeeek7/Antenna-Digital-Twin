...
# Antenna parameters
L = 0.028424824947556066  # Patch length (m)
W = 0.04299478550099812   # Patch width (m)
h = 0.0019627814987755207  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007192324772722134  # Feed x position
feed_y = 0.003172412637146118  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0962_a944eaca')
