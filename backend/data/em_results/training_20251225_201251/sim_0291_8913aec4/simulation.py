...
# Antenna parameters
L = 0.02609909420941465  # Patch length (m)
W = 0.03182661106563125   # Patch width (m)
h = 0.001442149180242378  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00448975287726792  # Feed x position
feed_y = 0.0065184351086649125  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0291_8913aec4')
