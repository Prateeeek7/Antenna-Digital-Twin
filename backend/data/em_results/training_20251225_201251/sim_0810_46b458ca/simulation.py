...
# Antenna parameters
L = 0.027340503969570995  # Patch length (m)
W = 0.030394964438548146   # Patch width (m)
h = 0.0022458868009497344  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010936201587828398  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0810_46b458ca')
