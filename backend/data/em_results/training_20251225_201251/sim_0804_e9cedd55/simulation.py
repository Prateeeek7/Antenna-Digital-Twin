...
# Antenna parameters
L = 0.031217783028516233  # Patch length (m)
W = 0.0318120992196026   # Patch width (m)
h = 0.003170444291652134  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010069258924019626  # Feed x position
feed_y = 0.012724839687841043  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0804_e9cedd55')
