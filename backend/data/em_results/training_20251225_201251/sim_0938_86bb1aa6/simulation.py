...
# Antenna parameters
L = 0.030705283761860328  # Patch length (m)
W = 0.04481633155735071   # Patch width (m)
h = 0.001112655162220956  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012282113504744133  # Feed x position
feed_y = 0.017926532622940285  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0938_86bb1aa6')
