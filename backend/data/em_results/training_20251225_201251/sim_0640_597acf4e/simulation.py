...
# Antenna parameters
L = 0.027912384922521804  # Patch length (m)
W = 0.04117615891356262   # Patch width (m)
h = 0.0013161999673172017  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006815515065209303  # Feed x position
feed_y = 0.008566118482435617  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0640_597acf4e')
