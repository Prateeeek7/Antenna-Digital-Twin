...
# Antenna parameters
L = 0.02834663329192403  # Patch length (m)
W = 0.0328398138868482   # Patch width (m)
h = 0.0008317842872878355  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008981232476879469  # Feed x position
feed_y = 0.011841681548742376  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0689_b8fbde34')
