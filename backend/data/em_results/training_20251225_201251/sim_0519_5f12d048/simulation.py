...
# Antenna parameters
L = 0.03306086681703168  # Patch length (m)
W = 0.03742366898260488   # Patch width (m)
h = 0.0009646235459854621  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.001610140917573035  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0519_5f12d048')
