...
# Antenna parameters
L = 0.025983297967446486  # Patch length (m)
W = 0.03763855645471441   # Patch width (m)
h = 0.0027654605396438686  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010393319186978596  # Feed x position
feed_y = 0.004638208205241748  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0113_b9134b70')
