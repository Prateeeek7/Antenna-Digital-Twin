...
# Antenna parameters
L = 0.02970244628458775  # Patch length (m)
W = 0.030530858559472546   # Patch width (m)
h = 0.001089986790407161  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011160050369860152  # Feed x position
feed_y = 0.012212343423789018  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0703_db2aa7ab')
