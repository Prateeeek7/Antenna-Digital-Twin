...
# Antenna parameters
L = 0.03237498338157935  # Patch length (m)
W = 0.044692443654933495   # Patch width (m)
h = 0.0025953872855979127  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010189907462493293  # Feed x position
feed_y = 0.010895159509708052  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0952_b4f4c128')
