...
# Antenna parameters
L = 0.034411676336415356  # Patch length (m)
W = 0.0352690460135658   # Patch width (m)
h = 0.001292475675640026  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010238597539894551  # Feed x position
feed_y = 0.004135732851144366  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0743_46fd5044')
