...
# Antenna parameters
L = 0.031478558428510786  # Patch length (m)
W = 0.038645787017946846   # Patch width (m)
h = 0.0008282418745701366  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009558998579157783  # Feed x position
feed_y = 0.011316428953033182  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0521_4950d656')
