...
# Antenna parameters
L = 0.029224781235653113  # Patch length (m)
W = 0.03794580545506346   # Patch width (m)
h = 0.0018703230953854926  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00704880701863137  # Feed x position
feed_y = 0.012420160771217069  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0403_7d376024')
