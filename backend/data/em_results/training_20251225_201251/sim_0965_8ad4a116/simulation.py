...
# Antenna parameters
L = 0.03143597830900854  # Patch length (m)
W = 0.033117316128215155   # Patch width (m)
h = 0.0020278064302969873  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005426057077518839  # Feed x position
feed_y = 0.00583015492344157  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0965_8ad4a116')
