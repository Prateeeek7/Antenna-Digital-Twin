...
# Antenna parameters
L = 0.03225804814470182  # Patch length (m)
W = 0.037139130819831924   # Patch width (m)
h = 0.0008337216955447779  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003025758470698092  # Feed x position
feed_y = 0.0023057064137756845  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0318_8d1e1c77')
