...
# Antenna parameters
L = 0.03169139232305046  # Patch length (m)
W = 0.031044865963885677   # Patch width (m)
h = 0.0029416183902416715  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012676556929220185  # Feed x position
feed_y = 0.012417946385554272  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0684_893b57ec')
