...
# Antenna parameters
L = 0.02517336546742771  # Patch length (m)
W = 0.034228322327964286   # Patch width (m)
h = 0.0008412019297161824  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004516399359600046  # Feed x position
feed_y = 0.013691328931185714  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0224_edc9a4bb')
