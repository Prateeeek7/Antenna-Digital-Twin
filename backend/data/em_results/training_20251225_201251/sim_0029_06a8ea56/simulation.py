...
# Antenna parameters
L = 0.03445733024336908  # Patch length (m)
W = 0.04034502646503986   # Patch width (m)
h = 0.0025651503862340686  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0019220486350610033  # Feed x position
feed_y = 0.009258747603759278  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0029_06a8ea56')
