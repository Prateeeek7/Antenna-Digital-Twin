...
# Antenna parameters
L = 0.03211086714816298  # Patch length (m)
W = 0.032667899168929655   # Patch width (m)
h = 0.0022479734993253097  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012844346859265193  # Feed x position
feed_y = 0.0022012405279149476  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0320_2b3d0310')
