...
# Antenna parameters
L = 0.025502298068864622  # Patch length (m)
W = 0.0406449471518425   # Patch width (m)
h = 0.0016769447291834828  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01020091922754585  # Feed x position
feed_y = 0.0018934530853567477  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0343_5410a0c0')
