...
# Antenna parameters
L = 0.03381903022111295  # Patch length (m)
W = 0.03904731304563297   # Patch width (m)
h = 0.0021473197851702144  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010237995037941067  # Feed x position
feed_y = 0.005287683436186512  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0184_98c908cc')
