...
# Antenna parameters
L = 0.034780134089241514  # Patch length (m)
W = 0.03025992023193513   # Patch width (m)
h = 0.002180694172315948  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00613896173391218  # Feed x position
feed_y = 0.00691926344534036  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0634_2e4346a6')
