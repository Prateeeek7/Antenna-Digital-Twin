...
# Antenna parameters
L = 0.03454755234956444  # Patch length (m)
W = 0.030160068301330414   # Patch width (m)
h = 0.0022190455283044442  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009687413373661843  # Feed x position
feed_y = 0.004687391060757923  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0561_02154f69')
