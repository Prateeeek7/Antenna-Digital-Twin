...
# Antenna parameters
L = 0.030892703180064058  # Patch length (m)
W = 0.04400387098848559   # Patch width (m)
h = 0.0011465727135873977  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030979782524539743  # Feed x position
feed_y = 0.01637870246811315  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0961_df444e4e')
