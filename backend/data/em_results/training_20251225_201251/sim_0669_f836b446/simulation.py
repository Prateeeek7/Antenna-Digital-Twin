...
# Antenna parameters
L = 0.030463281124142347  # Patch length (m)
W = 0.043083067121983634   # Patch width (m)
h = 0.002550584900353027  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001252439165238452  # Feed x position
feed_y = 0.014510534043202255  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0669_f836b446')
