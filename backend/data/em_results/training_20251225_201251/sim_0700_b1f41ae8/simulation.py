...
# Antenna parameters
L = 0.02792585972417868  # Patch length (m)
W = 0.03335144236270581   # Patch width (m)
h = 0.0012199984584711204  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030069885321411033  # Feed x position
feed_y = 0.005207524630494737  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0700_b1f41ae8')
