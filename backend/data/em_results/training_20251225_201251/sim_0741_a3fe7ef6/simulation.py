...
# Antenna parameters
L = 0.03219846899624197  # Patch length (m)
W = 0.0367750308480987   # Patch width (m)
h = 0.0029823917763820438  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01287938759849679  # Feed x position
feed_y = 0.011901609971642855  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0741_a3fe7ef6')
