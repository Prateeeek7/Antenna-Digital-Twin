...
# Antenna parameters
L = 0.03007222656872471  # Patch length (m)
W = 0.03765765450387275   # Patch width (m)
h = 0.0027344347035932123  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012028890627489885  # Feed x position
feed_y = 0.0150630618015491  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0124_7fb74e91')
