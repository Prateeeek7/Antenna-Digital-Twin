...
# Antenna parameters
L = 0.029009576538860014  # Patch length (m)
W = 0.0434783259335846   # Patch width (m)
h = 0.002171487229309812  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009556526990026726  # Feed x position
feed_y = 0.011884011570364303  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0409_ce72dbe7')
