...
# Antenna parameters
L = 0.03488120799975693  # Patch length (m)
W = 0.03019074137343204   # Patch width (m)
h = 0.0010619914482088138  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007427841283035004  # Feed x position
feed_y = 0.007275982185422477  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0081_8faa7cb8')
