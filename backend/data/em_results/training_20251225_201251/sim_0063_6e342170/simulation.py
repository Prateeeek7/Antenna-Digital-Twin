...
# Antenna parameters
L = 0.028786725044355876  # Patch length (m)
W = 0.0448293080388041   # Patch width (m)
h = 0.0026631542159709057  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008358270574662572  # Feed x position
feed_y = 0.004013369401351477  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0063_6e342170')
