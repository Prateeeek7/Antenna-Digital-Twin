...
# Antenna parameters
L = 0.03130116654729297  # Patch length (m)
W = 0.0418013390583181   # Patch width (m)
h = 0.0028650222667861236  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004559260530689235  # Feed x position
feed_y = 0.016720535623327242  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0740_f267f81f')
