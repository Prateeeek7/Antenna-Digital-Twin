...
# Antenna parameters
L = 0.02742143385715908  # Patch length (m)
W = 0.04125362220705247   # Patch width (m)
h = 0.0016838732889057177  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00487509092121915  # Feed x position
feed_y = 0.0024210243292553547  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0023_01f862b5')
