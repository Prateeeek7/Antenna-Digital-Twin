...
# Antenna parameters
L = 0.026671952356425034  # Patch length (m)
W = 0.033894187824314546   # Patch width (m)
h = 0.0021289080125505675  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010432967603757653  # Feed x position
feed_y = 0.0026074840640080365  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0009_731fded8')
