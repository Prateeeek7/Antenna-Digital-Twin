...
# Antenna parameters
L = 0.02638132402134427  # Patch length (m)
W = 0.03096362441585102   # Patch width (m)
h = 0.0014480186067024484  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01055252960853771  # Feed x position
feed_y = 0.003640514402805814  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0742_038a91b7')
