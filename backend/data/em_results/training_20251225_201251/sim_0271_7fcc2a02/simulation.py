...
# Antenna parameters
L = 0.033019760296444725  # Patch length (m)
W = 0.03710219313834349   # Patch width (m)
h = 0.0027524871782847646  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01151250243320639  # Feed x position
feed_y = 0.014840877255337396  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0271_7fcc2a02')
