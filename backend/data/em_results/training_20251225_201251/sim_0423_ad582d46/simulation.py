...
# Antenna parameters
L = 0.03003072331597546  # Patch length (m)
W = 0.03023603138583268   # Patch width (m)
h = 0.0014695050554998637  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006019534620340059  # Feed x position
feed_y = 0.0066936488645916396  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0423_ad582d46')
