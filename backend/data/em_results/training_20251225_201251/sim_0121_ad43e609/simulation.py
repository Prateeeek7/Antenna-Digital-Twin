...
# Antenna parameters
L = 0.030082179948292622  # Patch length (m)
W = 0.03672199797842607   # Patch width (m)
h = 0.0020117261502291595  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0029219962475617216  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0121_ad43e609')
