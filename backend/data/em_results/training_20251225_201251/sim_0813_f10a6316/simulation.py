...
# Antenna parameters
L = 0.026732108579601312  # Patch length (m)
W = 0.04468078027239189   # Patch width (m)
h = 0.001381531484424656  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0063099793710827  # Feed x position
feed_y = 0.001135316066263527  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0813_f10a6316')
