...
# Antenna parameters
L = 0.030025631479924625  # Patch length (m)
W = 0.03877186909674844   # Patch width (m)
h = 0.0013038894442397547  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01201025259196985  # Feed x position
feed_y = 0.015508747638699378  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0960_2754e111')
