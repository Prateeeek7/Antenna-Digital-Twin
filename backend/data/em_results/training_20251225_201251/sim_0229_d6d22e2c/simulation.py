...
# Antenna parameters
L = 0.032656784543177594  # Patch length (m)
W = 0.04138876768830499   # Patch width (m)
h = 0.002857276665358778  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021473263355587043  # Feed x position
feed_y = 0.016555507075321996  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0229_d6d22e2c')
