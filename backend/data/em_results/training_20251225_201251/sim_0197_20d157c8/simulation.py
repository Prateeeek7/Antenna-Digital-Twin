...
# Antenna parameters
L = 0.026430793341417267  # Patch length (m)
W = 0.03555987919398927   # Patch width (m)
h = 0.0026310797439447276  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007792559035307532  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0197_20d157c8')
