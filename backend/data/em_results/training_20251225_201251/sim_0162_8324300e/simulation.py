...
# Antenna parameters
L = 0.03472995992395267  # Patch length (m)
W = 0.04411475130297154   # Patch width (m)
h = 0.003012816597003367  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0023514850331890487  # Feed x position
feed_y = 0.004121929945823906  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0162_8324300e')
