...
# Antenna parameters
L = 0.032648344682772654  # Patch length (m)
W = 0.03863572919876493   # Patch width (m)
h = 0.0013948313278515393  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003703701841791705  # Feed x position
feed_y = 0.013985725435436771  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0053_88b58bbb')
