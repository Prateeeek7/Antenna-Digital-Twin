...
# Antenna parameters
L = 0.028617717471245366  # Patch length (m)
W = 0.040195038963869174   # Patch width (m)
h = 0.002064967076917786  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009342989783254303  # Feed x position
feed_y = 0.01607801558554767  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0151_6ebd8c05')
