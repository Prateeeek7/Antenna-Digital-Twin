...
# Antenna parameters
L = 0.028830291152714543  # Patch length (m)
W = 0.03915928901458174   # Patch width (m)
h = 0.0016222459399410681  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014186701167222685  # Feed x position
feed_y = 0.006008443639145541  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0254_e1746dac')
