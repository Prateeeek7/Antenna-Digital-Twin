...
# Antenna parameters
L = 0.03071101749554822  # Patch length (m)
W = 0.03126655551132997   # Patch width (m)
h = 0.0027393940162425603  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.002077430699142067  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0648_73e7a229')
