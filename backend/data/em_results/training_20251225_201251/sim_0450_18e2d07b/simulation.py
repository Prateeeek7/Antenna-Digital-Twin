...
# Antenna parameters
L = 0.02681466094367278  # Patch length (m)
W = 0.03387342209188734   # Patch width (m)
h = 0.002733490716904765  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003437806863266611  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0450_18e2d07b')
