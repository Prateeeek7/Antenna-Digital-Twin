...
# Antenna parameters
L = 0.031179565249379874  # Patch length (m)
W = 0.031602277523856054   # Patch width (m)
h = 0.0012866318123093494  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012156142549161628  # Feed x position
feed_y = 0.009408452575713572  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0056_c875dc46')
