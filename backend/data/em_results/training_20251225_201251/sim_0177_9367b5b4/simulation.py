...
# Antenna parameters
L = 0.033026227940171175  # Patch length (m)
W = 0.031194088395261103   # Patch width (m)
h = 0.002261285339136737  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00932721987744722  # Feed x position
feed_y = 0.010720089263055076  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0177_9367b5b4')
