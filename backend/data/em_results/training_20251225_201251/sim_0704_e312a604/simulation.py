...
# Antenna parameters
L = 0.03415479142841295  # Patch length (m)
W = 0.03549197641307392   # Patch width (m)
h = 0.00182933682584194  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013501714540870187  # Feed x position
feed_y = 0.014196790565229567  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0704_e312a604')
