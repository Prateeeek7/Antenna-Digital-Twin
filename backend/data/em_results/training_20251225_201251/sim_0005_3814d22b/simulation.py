...
# Antenna parameters
L = 0.03241805361292148  # Patch length (m)
W = 0.030622999184944093   # Patch width (m)
h = 0.0018966948709621106  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003644530148940789  # Feed x position
feed_y = 0.009651097739080652  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0005_3814d22b')
