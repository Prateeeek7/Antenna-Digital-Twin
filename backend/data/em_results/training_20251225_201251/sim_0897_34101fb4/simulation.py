...
# Antenna parameters
L = 0.0346571979909469  # Patch length (m)
W = 0.03615336253794727   # Patch width (m)
h = 0.0012485309618421765  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013862879196378762  # Feed x position
feed_y = 0.013114024523810257  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0897_34101fb4')
