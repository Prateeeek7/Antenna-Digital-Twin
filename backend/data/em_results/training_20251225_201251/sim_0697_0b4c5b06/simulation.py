...
# Antenna parameters
L = 0.02876250270649279  # Patch length (m)
W = 0.03109985409334924   # Patch width (m)
h = 0.0009878092794662497  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005375587425142983  # Feed x position
feed_y = 0.0015472430168193536  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0697_0b4c5b06')
