...
# Antenna parameters
L = 0.029362591847683646  # Patch length (m)
W = 0.042423229366362177   # Patch width (m)
h = 0.002786872008030131  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006821026144849896  # Feed x position
feed_y = 0.0010204291627655523  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0545_bfe736f1')
