...
# Antenna parameters
L = 0.032951850977409484  # Patch length (m)
W = 0.034848767594992974   # Patch width (m)
h = 0.0011199969827118596  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013180740390963794  # Feed x position
feed_y = 0.001195174647334319  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0983_5fd86aad')
