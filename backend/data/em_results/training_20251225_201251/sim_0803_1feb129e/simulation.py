...
# Antenna parameters
L = 0.02778451736158167  # Patch length (m)
W = 0.036596240866883956   # Patch width (m)
h = 0.0009117133478117293  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011113806944632668  # Feed x position
feed_y = 0.014638496346753583  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0803_1feb129e')
