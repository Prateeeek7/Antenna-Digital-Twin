...
# Antenna parameters
L = 0.03174000234663086  # Patch length (m)
W = 0.039293169718178346   # Patch width (m)
h = 0.0029507059238020436  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009561955399749762  # Feed x position
feed_y = 0.009353299800169412  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0442_6b64b106')
