...
# Antenna parameters
L = 0.02948155586453341  # Patch length (m)
W = 0.0379529603108791   # Patch width (m)
h = 0.001498097020552241  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030495065591417785  # Feed x position
feed_y = 0.012004203827047083  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0930_e0bbaee7')
