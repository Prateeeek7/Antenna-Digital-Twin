...
# Antenna parameters
L = 0.034864143962385345  # Patch length (m)
W = 0.03070827801240896   # Patch width (m)
h = 0.002383094523586253  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01094712509506365  # Feed x position
feed_y = 0.008836157530749756  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0507_69da29a6')
