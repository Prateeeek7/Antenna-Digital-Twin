...
# Antenna parameters
L = 0.034870177693025264  # Patch length (m)
W = 0.03370553449487504   # Patch width (m)
h = 0.002539657828922415  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00738001290218183  # Feed x position
feed_y = 0.013482213797950017  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0632_2342ff63')
