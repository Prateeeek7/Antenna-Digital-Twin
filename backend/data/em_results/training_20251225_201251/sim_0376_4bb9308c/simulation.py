...
# Antenna parameters
L = 0.03485494497180643  # Patch length (m)
W = 0.03609544994580125   # Patch width (m)
h = 0.001871820024745681  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002269942683639555  # Feed x position
feed_y = 0.0021416594544373616  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0376_4bb9308c')
