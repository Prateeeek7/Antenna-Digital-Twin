...
# Antenna parameters
L = 0.02925476909500721  # Patch length (m)
W = 0.038547172046491884   # Patch width (m)
h = 0.0016740914425794017  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004856867604232367  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0339_76cd7a2b')
