...
# Antenna parameters
L = 0.0337660252591631  # Patch length (m)
W = 0.044213825164573055   # Patch width (m)
h = 0.0030843494817861207  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012534572046531607  # Feed x position
feed_y = 0.008990408244250821  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0901_38a542a3')
