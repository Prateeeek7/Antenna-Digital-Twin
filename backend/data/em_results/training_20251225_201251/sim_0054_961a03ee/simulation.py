...
# Antenna parameters
L = 0.028339446045908358  # Patch length (m)
W = 0.03014738037793596   # Patch width (m)
h = 0.0012678718833616948  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011335778418363343  # Feed x position
feed_y = 0.012058952151174385  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0054_961a03ee')
