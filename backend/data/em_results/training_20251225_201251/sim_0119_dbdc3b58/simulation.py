...
# Antenna parameters
L = 0.032167219778934  # Patch length (m)
W = 0.032479454498014516   # Patch width (m)
h = 0.0014536789525446338  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015121519556519321  # Feed x position
feed_y = 0.012991781799205807  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0119_dbdc3b58')
