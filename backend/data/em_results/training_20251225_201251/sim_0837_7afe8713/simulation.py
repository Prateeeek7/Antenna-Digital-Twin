...
# Antenna parameters
L = 0.025701931655528098  # Patch length (m)
W = 0.03295343797968589   # Patch width (m)
h = 0.0008044786024552315  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008172319697852584  # Feed x position
feed_y = 0.009218835577117702  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0837_7afe8713')
