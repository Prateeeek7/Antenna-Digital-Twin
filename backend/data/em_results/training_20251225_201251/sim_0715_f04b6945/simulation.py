...
# Antenna parameters
L = 0.031226129828843763  # Patch length (m)
W = 0.04152269842882824   # Patch width (m)
h = 0.002328183977858859  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0033139467034515153  # Feed x position
feed_y = 0.003341046861512529  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0715_f04b6945')
