...
# Antenna parameters
L = 0.027830672203803433  # Patch length (m)
W = 0.03788412762030704   # Patch width (m)
h = 0.0025848097700969658  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011132268881521374  # Feed x position
feed_y = 0.014366268585473775  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0257_adcbdbbf')
