...
# Antenna parameters
L = 0.03384928695465816  # Patch length (m)
W = 0.03507015265396193   # Patch width (m)
h = 0.0013254222615599143  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006446045937396533  # Feed x position
feed_y = 0.011698925013947755  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0353_0e16587d')
