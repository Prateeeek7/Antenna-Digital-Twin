...
# Antenna parameters
L = 0.028606166572065897  # Patch length (m)
W = 0.03162341241290966   # Patch width (m)
h = 0.002514073508057296  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01144246662882636  # Feed x position
feed_y = 0.010441913853278416  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0497_b6b17e6f')
