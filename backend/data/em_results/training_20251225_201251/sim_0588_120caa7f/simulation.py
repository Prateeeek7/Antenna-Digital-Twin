...
# Antenna parameters
L = 0.03140013374082475  # Patch length (m)
W = 0.03037166276621807   # Patch width (m)
h = 0.0016884442977375552  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002556463163955527  # Feed x position
feed_y = 0.012148665106487228  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0588_120caa7f')
