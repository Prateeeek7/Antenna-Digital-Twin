...
# Antenna parameters
L = 0.02731072204569828  # Patch length (m)
W = 0.044433418374013434   # Patch width (m)
h = 0.0017319245101184513  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002064171953057324  # Feed x position
feed_y = 0.002442945980825221  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0086_cc6cfc40')
