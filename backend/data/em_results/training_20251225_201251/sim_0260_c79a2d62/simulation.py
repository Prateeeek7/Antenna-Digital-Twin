...
# Antenna parameters
L = 0.0309378546102744  # Patch length (m)
W = 0.032181559913841376   # Patch width (m)
h = 0.0031645867050980638  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006523905274958061  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0260_c79a2d62')
