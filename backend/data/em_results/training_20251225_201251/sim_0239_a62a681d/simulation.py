...
# Antenna parameters
L = 0.02764807699320965  # Patch length (m)
W = 0.04324168803118186   # Patch width (m)
h = 0.0031576254226901718  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.008416243788633522  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0239_a62a681d')
