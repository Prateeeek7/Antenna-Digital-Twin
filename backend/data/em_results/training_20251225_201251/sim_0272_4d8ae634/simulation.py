...
# Antenna parameters
L = 0.03196331669259205  # Patch length (m)
W = 0.03873934898988188   # Patch width (m)
h = 0.001376915084532393  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012785326677036822  # Feed x position
feed_y = 0.0026834412492818655  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0272_4d8ae634')
