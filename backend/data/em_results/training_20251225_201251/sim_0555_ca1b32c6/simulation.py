...
# Antenna parameters
L = 0.034056452746788035  # Patch length (m)
W = 0.03320027104812794   # Patch width (m)
h = 0.0016579662843295069  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0035033916830519013  # Feed x position
feed_y = 0.01171745098705415  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0555_ca1b32c6')
