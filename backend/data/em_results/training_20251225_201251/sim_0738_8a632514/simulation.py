...
# Antenna parameters
L = 0.03457961089179226  # Patch length (m)
W = 0.036440995900779136   # Patch width (m)
h = 0.0009365785816617552  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013113581852000927  # Feed x position
feed_y = 0.014576398360311655  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0738_8a632514')
