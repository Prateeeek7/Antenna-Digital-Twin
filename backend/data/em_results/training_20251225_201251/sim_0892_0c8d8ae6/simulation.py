...
# Antenna parameters
L = 0.025975790883005296  # Patch length (m)
W = 0.03087877868663757   # Patch width (m)
h = 0.002474414789939658  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006013793617904997  # Feed x position
feed_y = 0.0035174801593401083  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0892_0c8d8ae6')
