...
# Antenna parameters
L = 0.033792255821655515  # Patch length (m)
W = 0.040386150221666355   # Patch width (m)
h = 0.0031253341992358488  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004273377025275791  # Feed x position
feed_y = 0.004326349454352107  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0601_c9119adb')
