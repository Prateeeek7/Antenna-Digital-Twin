...
# Antenna parameters
L = 0.025593054672087136  # Patch length (m)
W = 0.038754517450526674   # Patch width (m)
h = 0.0013204166276777054  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007980930694972545  # Feed x position
feed_y = 0.01125887942373504  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0723_bfd32bd4')
