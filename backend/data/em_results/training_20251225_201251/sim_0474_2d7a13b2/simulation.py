...
# Antenna parameters
L = 0.03213537772069856  # Patch length (m)
W = 0.034765096524721845   # Patch width (m)
h = 0.001989666846530309  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012854151088279427  # Feed x position
feed_y = 0.012874122811022428  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0474_2d7a13b2')
