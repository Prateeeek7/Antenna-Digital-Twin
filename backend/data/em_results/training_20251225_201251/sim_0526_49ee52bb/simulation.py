...
# Antenna parameters
L = 0.03414917572010543  # Patch length (m)
W = 0.03002255152654279   # Patch width (m)
h = 0.001354669371978287  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00760450660041895  # Feed x position
feed_y = 0.009419260670445195  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0526_49ee52bb')
