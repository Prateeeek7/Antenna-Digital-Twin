...
# Antenna parameters
L = 0.03432949166538052  # Patch length (m)
W = 0.038280279193481204   # Patch width (m)
h = 0.00207807438781037  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0013406223427550764  # Feed x position
feed_y = 0.008623100650887542  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0297_0c7062c4')
