...
# Antenna parameters
L = 0.03182123732766974  # Patch length (m)
W = 0.04379795294168933   # Patch width (m)
h = 0.0021624316136746573  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004162721506391001  # Feed x position
feed_y = 0.017519181176675735  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0447_29cde712')
