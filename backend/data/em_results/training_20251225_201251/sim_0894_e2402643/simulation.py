...
# Antenna parameters
L = 0.03439094382602933  # Patch length (m)
W = 0.039505820751611874   # Patch width (m)
h = 0.0019264450401916995  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005966132355225611  # Feed x position
feed_y = 0.011585167782060871  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0894_e2402643')
