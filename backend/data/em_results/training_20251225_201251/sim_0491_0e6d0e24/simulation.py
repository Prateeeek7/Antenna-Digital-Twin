...
# Antenna parameters
L = 0.03434462492337463  # Patch length (m)
W = 0.03728090705356668   # Patch width (m)
h = 0.0018893571359197923  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006177341756739142  # Feed x position
feed_y = 0.004929889213496192  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0491_0e6d0e24')
