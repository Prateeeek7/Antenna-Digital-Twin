...
# Antenna parameters
L = 0.027366980726085576  # Patch length (m)
W = 0.03820622337156727   # Patch width (m)
h = 0.0015901248943149646  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008372782866726058  # Feed x position
feed_y = 0.005902918158169658  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0080_43a45e9e')
