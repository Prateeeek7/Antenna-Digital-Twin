...
# Antenna parameters
L = 0.02896503582517561  # Patch length (m)
W = 0.039548013638394636   # Patch width (m)
h = 0.001997586864538797  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010155334906084518  # Feed x position
feed_y = 0.010928486189257063  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0264_63f21aba')
