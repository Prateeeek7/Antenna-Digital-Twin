...
# Antenna parameters
L = 0.034112377486516965  # Patch length (m)
W = 0.04047019220501937   # Patch width (m)
h = 0.0020910922872260573  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010954370122443787  # Feed x position
feed_y = 0.016044977071458254  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0477_4ee1ecf2')
