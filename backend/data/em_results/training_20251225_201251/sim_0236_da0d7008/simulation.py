...
# Antenna parameters
L = 0.03058248509189429  # Patch length (m)
W = 0.03851821634477949   # Patch width (m)
h = 0.0019181936423597339  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010838795251055215  # Feed x position
feed_y = 0.001421796987325099  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0236_da0d7008')
