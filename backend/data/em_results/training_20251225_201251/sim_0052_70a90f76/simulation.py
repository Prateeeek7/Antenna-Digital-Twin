...
# Antenna parameters
L = 0.034698538267558074  # Patch length (m)
W = 0.030077630037143154   # Patch width (m)
h = 0.0011424551967825823  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00931406145195343  # Feed x position
feed_y = 0.010693785988649658  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0052_70a90f76')
