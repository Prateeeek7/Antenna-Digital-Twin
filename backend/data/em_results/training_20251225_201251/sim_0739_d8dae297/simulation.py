...
# Antenna parameters
L = 0.033135764146517054  # Patch length (m)
W = 0.03907050882757775   # Patch width (m)
h = 0.002993486277838838  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00221968568090294  # Feed x position
feed_y = 0.011419723153623778  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0739_d8dae297')
