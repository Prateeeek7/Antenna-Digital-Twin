...
# Antenna parameters
L = 0.03366232338967302  # Patch length (m)
W = 0.03204160304540895   # Patch width (m)
h = 0.0015712338385957592  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011039148100443576  # Feed x position
feed_y = 0.008902833249330007  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0518_1082f550')
