...
# Antenna parameters
L = 0.03383884729232194  # Patch length (m)
W = 0.03589059937240812   # Patch width (m)
h = 0.0011066291263125473  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009416631659182394  # Feed x position
feed_y = 0.014356239748963249  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0973_355850e6')
