...
# Antenna parameters
L = 0.03131967132329734  # Patch length (m)
W = 0.031318258510381475   # Patch width (m)
h = 0.0021199070657570507  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012527868529318937  # Feed x position
feed_y = 0.004736957201365039  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0670_fa1db729')
