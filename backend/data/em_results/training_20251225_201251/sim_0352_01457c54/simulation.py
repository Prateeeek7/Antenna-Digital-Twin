...
# Antenna parameters
L = 0.03142667836952297  # Patch length (m)
W = 0.03268246297938926   # Patch width (m)
h = 0.002726691746807681  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.004786018070869666  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0352_01457c54')
