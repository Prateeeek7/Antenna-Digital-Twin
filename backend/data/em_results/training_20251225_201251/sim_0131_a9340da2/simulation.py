...
# Antenna parameters
L = 0.03391651968576591  # Patch length (m)
W = 0.03606219982993284   # Patch width (m)
h = 0.0009312825352373146  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006705460093576658  # Feed x position
feed_y = 0.0015795795264952302  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0131_a9340da2')
