...
# Antenna parameters
L = 0.03403767919539331  # Patch length (m)
W = 0.032900699526859326   # Patch width (m)
h = 0.000836511711891146  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006653391052907592  # Feed x position
feed_y = 0.0129324377998002  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0683_09d592f8')
