...
# Antenna parameters
L = 0.03209173708075806  # Patch length (m)
W = 0.0397665575884224   # Patch width (m)
h = 0.0027772634021864034  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012836694832303226  # Feed x position
feed_y = 0.015906623035368963  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0030_74c76de6')
