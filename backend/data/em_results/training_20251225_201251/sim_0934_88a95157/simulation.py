...
# Antenna parameters
L = 0.03149842482364112  # Patch length (m)
W = 0.04387040279434022   # Patch width (m)
h = 0.0008239162020996255  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011272006684391248  # Feed x position
feed_y = 0.013629215455794784  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0934_88a95157')
