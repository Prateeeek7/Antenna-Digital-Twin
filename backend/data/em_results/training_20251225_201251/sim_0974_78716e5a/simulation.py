...
# Antenna parameters
L = 0.03450566580244492  # Patch length (m)
W = 0.03844133195136372   # Patch width (m)
h = 0.0026943298909562524  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001111350356446808  # Feed x position
feed_y = 0.01138787336442838  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0974_78716e5a')
