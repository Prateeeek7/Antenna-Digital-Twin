...
# Antenna parameters
L = 0.033519959968375576  # Patch length (m)
W = 0.03385285204893385   # Patch width (m)
h = 0.0029762084579526  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013407983987350231  # Feed x position
feed_y = 0.013541140819573541  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0721_4d828b33')
