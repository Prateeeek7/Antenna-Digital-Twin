...
# Antenna parameters
L = 0.0303813919902638  # Patch length (m)
W = 0.03570265313085075   # Patch width (m)
h = 0.002085106539760966  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037548483904671073  # Feed x position
feed_y = 0.005692917355341662  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0233_c1bfe6e9')
