...
# Antenna parameters
L = 0.026668464221330523  # Patch length (m)
W = 0.03468334966985476   # Patch width (m)
h = 0.0029020449274080686  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008828416653690673  # Feed x position
feed_y = 0.0058871885620120894  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0590_09318a75')
