...
# Antenna parameters
L = 0.03440715994183664  # Patch length (m)
W = 0.03086821758686607   # Patch width (m)
h = 0.0019075710993596878  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011471938358647493  # Feed x position
feed_y = 0.001765808092634095  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0874_cbc3e75d')
