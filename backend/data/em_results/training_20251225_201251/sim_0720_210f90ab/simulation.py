...
# Antenna parameters
L = 0.033587131644453205  # Patch length (m)
W = 0.03922304962507473   # Patch width (m)
h = 0.0020419970980795074  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009585430688537394  # Feed x position
feed_y = 0.015689219850029894  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0720_210f90ab')
