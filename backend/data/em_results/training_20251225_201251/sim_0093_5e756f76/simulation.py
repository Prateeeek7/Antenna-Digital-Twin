...
# Antenna parameters
L = 0.03186300224055411  # Patch length (m)
W = 0.04343026150267132   # Patch width (m)
h = 0.002192142573416731  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012745200896221645  # Feed x position
feed_y = 0.006264633840952831  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0093_5e756f76')
