...
# Antenna parameters
L = 0.025259550357575013  # Patch length (m)
W = 0.03202690140095469   # Patch width (m)
h = 0.0012615355869815457  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001982370188189701  # Feed x position
feed_y = 0.00952755010934248  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0562_9c791fa4')
