...
# Antenna parameters
L = 0.031160960267091222  # Patch length (m)
W = 0.043502016411910184   # Patch width (m)
h = 0.0020220845661540364  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011231970270944896  # Feed x position
feed_y = 0.016221806272833834  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0173_9b67f2fb')
