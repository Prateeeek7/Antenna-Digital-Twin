...
# Antenna parameters
L = 0.029782422834791877  # Patch length (m)
W = 0.034415553183379126   # Patch width (m)
h = 0.002886109849849905  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011912969133916752  # Feed x position
feed_y = 0.013325168267221778  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0986_eac7035e')
