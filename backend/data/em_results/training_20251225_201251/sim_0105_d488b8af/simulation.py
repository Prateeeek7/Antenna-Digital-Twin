...
# Antenna parameters
L = 0.03113635080638922  # Patch length (m)
W = 0.033165623562286486   # Patch width (m)
h = 0.0025592108852657996  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008737294312217097  # Feed x position
feed_y = 0.013266249424914596  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0105_d488b8af')
