...
# Antenna parameters
L = 0.034715315833587536  # Patch length (m)
W = 0.03988110840240218   # Patch width (m)
h = 0.0030414915845192255  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009208558791842207  # Feed x position
feed_y = 0.015952443360960872  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0180_0dba748f')
