...
# Antenna parameters
L = 0.03181309352926895  # Patch length (m)
W = 0.038158557134999785   # Patch width (m)
h = 0.002393147455811277  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008317904901451484  # Feed x position
feed_y = 0.004243152675758984  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0633_4666bfe2')
