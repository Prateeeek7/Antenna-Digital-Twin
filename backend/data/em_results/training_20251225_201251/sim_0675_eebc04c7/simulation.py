...
# Antenna parameters
L = 0.02503575663571077  # Patch length (m)
W = 0.042974848059939875   # Patch width (m)
h = 0.001179403047350985  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007242156847398775  # Feed x position
feed_y = 0.0019133633955961905  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0675_eebc04c7')
