...
# Antenna parameters
L = 0.03029540803904308  # Patch length (m)
W = 0.04425546121102216   # Patch width (m)
h = 0.0009541030081559707  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012118163215617234  # Feed x position
feed_y = 0.017702184484408866  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0896_2ead86a4')
