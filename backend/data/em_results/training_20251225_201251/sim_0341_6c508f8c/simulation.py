...
# Antenna parameters
L = 0.03350013371253137  # Patch length (m)
W = 0.03869859288263988   # Patch width (m)
h = 0.0017782103002056868  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005077354986773666  # Feed x position
feed_y = 0.00539295751411634  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0341_6c508f8c')
