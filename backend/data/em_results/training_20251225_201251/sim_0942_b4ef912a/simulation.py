...
# Antenna parameters
L = 0.030532064222506088  # Patch length (m)
W = 0.03121131108524116   # Patch width (m)
h = 0.001890531452908779  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0098328332472739  # Feed x position
feed_y = 0.003939383550673165  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0942_b4ef912a')
