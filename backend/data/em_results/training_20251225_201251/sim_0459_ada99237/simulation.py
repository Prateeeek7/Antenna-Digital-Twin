...
# Antenna parameters
L = 0.0266196047638131  # Patch length (m)
W = 0.03897407277199647   # Patch width (m)
h = 0.0030726963794598635  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002728444838084925  # Feed x position
feed_y = 0.0033180675246851444  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0459_ada99237')
