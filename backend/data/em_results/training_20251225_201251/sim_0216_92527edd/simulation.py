...
# Antenna parameters
L = 0.028467557949992343  # Patch length (m)
W = 0.04254130992247117   # Patch width (m)
h = 0.0011385827012012036  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004656675832238252  # Feed x position
feed_y = 0.01416671981021579  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0216_92527edd')
