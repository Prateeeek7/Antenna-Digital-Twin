...
# Antenna parameters
L = 0.026854057055719863  # Patch length (m)
W = 0.04372188544241859   # Patch width (m)
h = 0.003129048474695396  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010689500343340916  # Feed x position
feed_y = 0.017488754176967436  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0586_ea87009d')
