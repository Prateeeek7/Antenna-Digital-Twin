...
# Antenna parameters
L = 0.032737848217253715  # Patch length (m)
W = 0.04197621343012268   # Patch width (m)
h = 0.0019347308323770032  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009204581147113417  # Feed x position
feed_y = 0.016790485372049073  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0246_91552e35')
