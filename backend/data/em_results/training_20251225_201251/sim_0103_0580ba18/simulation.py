...
# Antenna parameters
L = 0.03482827005554809  # Patch length (m)
W = 0.03383529159945297   # Patch width (m)
h = 0.00171981753783986  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004701560768478645  # Feed x position
feed_y = 0.0035894647283307535  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0103_0580ba18')
