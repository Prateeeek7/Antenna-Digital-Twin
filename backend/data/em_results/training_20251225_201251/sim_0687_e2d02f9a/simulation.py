...
# Antenna parameters
L = 0.02605438059076399  # Patch length (m)
W = 0.03562006821603285   # Patch width (m)
h = 0.0012600263869452608  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009640028516325594  # Feed x position
feed_y = 0.010034240192700671  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0687_e2d02f9a')
