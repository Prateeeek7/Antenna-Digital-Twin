...
# Antenna parameters
L = 0.028372956031210227  # Patch length (m)
W = 0.0398227622372417   # Patch width (m)
h = 0.0010531198701660056  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005721782330797308  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0582_240e4284')
