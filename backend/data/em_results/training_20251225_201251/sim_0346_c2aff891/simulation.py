...
# Antenna parameters
L = 0.030980548517123296  # Patch length (m)
W = 0.04442923678898182   # Patch width (m)
h = 0.0012686007061974928  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010653318199813288  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0346_c2aff891')
