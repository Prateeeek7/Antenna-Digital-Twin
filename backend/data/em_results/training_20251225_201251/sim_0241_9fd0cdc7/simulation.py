...
# Antenna parameters
L = 0.031199505408628543  # Patch length (m)
W = 0.03593097662321316   # Patch width (m)
h = 0.002044433139018507  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0033498880151467607  # Feed x position
feed_y = 0.007088846522041363  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0241_9fd0cdc7')
