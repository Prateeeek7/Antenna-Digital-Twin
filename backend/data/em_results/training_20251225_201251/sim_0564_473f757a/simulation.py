...
# Antenna parameters
L = 0.029987121909850388  # Patch length (m)
W = 0.03640981281947341   # Patch width (m)
h = 0.003118270269652115  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0062379831650200375  # Feed x position
feed_y = 0.014563925127789366  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0564_473f757a')
