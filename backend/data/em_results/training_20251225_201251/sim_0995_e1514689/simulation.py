...
# Antenna parameters
L = 0.028505880252759883  # Patch length (m)
W = 0.030563023471073036   # Patch width (m)
h = 0.0011979001280133543  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0016845281766199075  # Feed x position
feed_y = 0.007260032212482699  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0995_e1514689')
