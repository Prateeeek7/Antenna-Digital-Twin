...
# Antenna parameters
L = 0.026924385106055857  # Patch length (m)
W = 0.032208120383622876   # Patch width (m)
h = 0.0021829188221374985  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010769754042422343  # Feed x position
feed_y = 0.010459969448313166  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0141_3f607f97')
