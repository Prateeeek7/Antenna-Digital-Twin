...
# Antenna parameters
L = 0.02611822764498751  # Patch length (m)
W = 0.0414048285890868   # Patch width (m)
h = 0.0016091695818528612  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010081110192793523  # Feed x position
feed_y = 0.004213984033890758  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0203_c918a012')
