...
# Antenna parameters
L = 0.02686915655105562  # Patch length (m)
W = 0.03271402084148282   # Patch width (m)
h = 0.0011742201879289774  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010747662620422248  # Feed x position
feed_y = 0.0015897447257837737  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0858_bda3c322')
