...
# Antenna parameters
L = 0.027719151415564452  # Patch length (m)
W = 0.03462732703295043   # Patch width (m)
h = 0.0031725182297892363  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010453566791827278  # Feed x position
feed_y = 0.005653523997023852  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0750_99477867')
