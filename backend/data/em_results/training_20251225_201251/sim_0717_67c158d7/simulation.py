...
# Antenna parameters
L = 0.028951992870264457  # Patch length (m)
W = 0.044994143302344046   # Patch width (m)
h = 0.001499637887565728  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004461800921415846  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0717_67c158d7')
