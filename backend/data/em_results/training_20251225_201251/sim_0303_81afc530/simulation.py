...
# Antenna parameters
L = 0.02822727413502584  # Patch length (m)
W = 0.03676333913612099   # Patch width (m)
h = 0.0019017054880171459  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0070122981511347325  # Feed x position
feed_y = 0.014705335654448396  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0303_81afc530')
