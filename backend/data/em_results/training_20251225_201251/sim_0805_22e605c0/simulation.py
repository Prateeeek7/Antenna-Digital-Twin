...
# Antenna parameters
L = 0.03266053107708867  # Patch length (m)
W = 0.030920220564809503   # Patch width (m)
h = 0.0025672089883735233  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013064212430835468  # Feed x position
feed_y = 0.009463053322728735  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0805_22e605c0')
