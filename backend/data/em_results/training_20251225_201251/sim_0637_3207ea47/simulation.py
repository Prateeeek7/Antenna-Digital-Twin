...
# Antenna parameters
L = 0.02769919455053287  # Patch length (m)
W = 0.03562909483641058   # Patch width (m)
h = 0.0008915262212702189  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021585525437279036  # Feed x position
feed_y = 0.001028107485458098  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0637_3207ea47')
