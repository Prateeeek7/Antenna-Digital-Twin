...
# Antenna parameters
L = 0.0259034741265944  # Patch length (m)
W = 0.033992934122580795   # Patch width (m)
h = 0.0011779214665374423  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010361389650637761  # Feed x position
feed_y = 0.005348989496901497  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0065_51b3eb8f')
