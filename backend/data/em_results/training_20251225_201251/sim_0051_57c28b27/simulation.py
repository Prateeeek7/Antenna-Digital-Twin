...
# Antenna parameters
L = 0.031052539857197567  # Patch length (m)
W = 0.04153775146854864   # Patch width (m)
h = 0.0022421473326083505  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012421015942879027  # Feed x position
feed_y = 0.016615100587419458  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0051_57c28b27')
