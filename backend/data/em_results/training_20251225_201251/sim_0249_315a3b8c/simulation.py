...
# Antenna parameters
L = 0.03372735192822679  # Patch length (m)
W = 0.03932084272398988   # Patch width (m)
h = 0.0029691070632855863  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01322300452469085  # Feed x position
feed_y = 0.005054111073901234  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0249_315a3b8c')
