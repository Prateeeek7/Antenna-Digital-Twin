...
# Antenna parameters
L = 0.030607031315144927  # Patch length (m)
W = 0.033554090538867154   # Patch width (m)
h = 0.0023183146918862303  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011749204525593629  # Feed x position
feed_y = 0.00391935397407014  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0448_566dfe06')
