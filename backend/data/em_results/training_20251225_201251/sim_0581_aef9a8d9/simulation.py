...
# Antenna parameters
L = 0.030153512250961117  # Patch length (m)
W = 0.04134048139902775   # Patch width (m)
h = 0.002904661757479091  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006695242674902129  # Feed x position
feed_y = 0.0165361925596111  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0581_aef9a8d9')
