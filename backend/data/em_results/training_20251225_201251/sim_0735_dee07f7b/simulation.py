...
# Antenna parameters
L = 0.03281121685269107  # Patch length (m)
W = 0.031750169488777034   # Patch width (m)
h = 0.0025242283620767712  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007706072538873887  # Feed x position
feed_y = 0.0024121661891901374  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0735_dee07f7b')
