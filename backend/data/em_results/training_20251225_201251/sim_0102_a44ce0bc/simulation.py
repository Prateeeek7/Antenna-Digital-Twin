...
# Antenna parameters
L = 0.034999279408529274  # Patch length (m)
W = 0.03492237010183441   # Patch width (m)
h = 0.0021966666369994236  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.002875261226933071  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0102_a44ce0bc')
