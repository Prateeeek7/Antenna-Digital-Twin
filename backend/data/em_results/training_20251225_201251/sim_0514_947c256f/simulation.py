...
# Antenna parameters
L = 0.02857984196760837  # Patch length (m)
W = 0.0435516362475476   # Patch width (m)
h = 0.001758197578993082  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011120033899419745  # Feed x position
feed_y = 0.01742065449901904  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0514_947c256f')
