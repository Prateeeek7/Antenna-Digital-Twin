...
# Antenna parameters
L = 0.029726767927105074  # Patch length (m)
W = 0.03747613383574569   # Patch width (m)
h = 0.00261530768913488  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009219953953591833  # Feed x position
feed_y = 0.0011635366533864877  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0819_fec4d22d')
