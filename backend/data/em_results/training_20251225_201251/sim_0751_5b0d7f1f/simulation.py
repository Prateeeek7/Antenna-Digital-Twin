...
# Antenna parameters
L = 0.03210656184031076  # Patch length (m)
W = 0.043406075176265504   # Patch width (m)
h = 0.0012049324478108723  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014299002797947653  # Feed x position
feed_y = 0.012844615545068484  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0751_5b0d7f1f')
