...
# Antenna parameters
L = 0.03355712526981452  # Patch length (m)
W = 0.0341973819430256   # Patch width (m)
h = 0.0016405662174717893  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005058798903985433  # Feed x position
feed_y = 0.0061740082355503725  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0463_b1a779d1')
