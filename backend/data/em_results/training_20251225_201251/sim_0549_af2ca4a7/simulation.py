...
# Antenna parameters
L = 0.02587217238651944  # Patch length (m)
W = 0.04246190590644892   # Patch width (m)
h = 0.002095552010951131  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00801394387063408  # Feed x position
feed_y = 0.016984762362579568  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0549_af2ca4a7')
