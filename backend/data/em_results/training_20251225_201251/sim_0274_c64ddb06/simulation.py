...
# Antenna parameters
L = 0.02620903189850695  # Patch length (m)
W = 0.042945790203064056   # Patch width (m)
h = 0.00260862801425241  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01017160773751144  # Feed x position
feed_y = 0.010329011882268785  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0274_c64ddb06')
