...
# Antenna parameters
L = 0.025063474807992474  # Patch length (m)
W = 0.03017256740165057   # Patch width (m)
h = 0.001954134339022329  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.006241274408710773  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0181_0cac7e82')
