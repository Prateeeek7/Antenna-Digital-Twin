...
# Antenna parameters
L = 0.025948302858949016  # Patch length (m)
W = 0.04447805142405296   # Patch width (m)
h = 0.002133774310924794  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008184697610467037  # Feed x position
feed_y = 0.017791220569621184  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0356_f11b8403')
