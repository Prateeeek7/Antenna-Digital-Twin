...
# Antenna parameters
L = 0.033313857181495286  # Patch length (m)
W = 0.034703290864696375   # Patch width (m)
h = 0.0031054432524299518  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005322357065708957  # Feed x position
feed_y = 0.010834679752693501  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0534_673a707e')
