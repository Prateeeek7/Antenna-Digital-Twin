...
# Antenna parameters
L = 0.031512019921451154  # Patch length (m)
W = 0.04311380098553917   # Patch width (m)
h = 0.001023153385308659  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012604807968580461  # Feed x position
feed_y = 0.004236613486957237  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0880_85e4a105')
