...
# Antenna parameters
L = 0.03065736450337323  # Patch length (m)
W = 0.03510985967729433   # Patch width (m)
h = 0.002200042156161951  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012224659395690635  # Feed x position
feed_y = 0.014043943870917733  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0787_267fa728')
