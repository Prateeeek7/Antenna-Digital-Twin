...
# Antenna parameters
L = 0.033303710519828375  # Patch length (m)
W = 0.0337258134100612   # Patch width (m)
h = 0.002415789031290945  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013490325364024482  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0454_6c72389a')
