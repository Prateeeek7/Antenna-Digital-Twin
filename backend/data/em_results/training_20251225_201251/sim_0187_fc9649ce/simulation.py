...
# Antenna parameters
L = 0.031647931864724865  # Patch length (m)
W = 0.030060876917148927   # Patch width (m)
h = 0.0019109104271901353  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012659172745889947  # Feed x position
feed_y = 0.0119777504609104  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0187_fc9649ce')
