...
# Antenna parameters
L = 0.02532380084019816  # Patch length (m)
W = 0.03453454912582088   # Patch width (m)
h = 0.0025547384810007357  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010129520336079265  # Feed x position
feed_y = 0.013417946967665963  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0515_8bd505fe')
