...
# Antenna parameters
L = 0.028122462293203563  # Patch length (m)
W = 0.04394572316399377   # Patch width (m)
h = 0.0016799958874939877  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011248984917281426  # Feed x position
feed_y = 0.01757828926559751  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0399_86b60d81')
