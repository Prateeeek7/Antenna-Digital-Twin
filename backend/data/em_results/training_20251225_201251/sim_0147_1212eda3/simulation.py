...
# Antenna parameters
L = 0.030363018102743902  # Patch length (m)
W = 0.040781894691877124   # Patch width (m)
h = 0.0011112750282349193  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012145207241097562  # Feed x position
feed_y = 0.004171649140825681  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0147_1212eda3')
