...
# Antenna parameters
L = 0.028364374718792443  # Patch length (m)
W = 0.03378663602113312   # Patch width (m)
h = 0.002914436942296158  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011345749887516979  # Feed x position
feed_y = 0.008377802713343393  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0686_48fe4aec')
