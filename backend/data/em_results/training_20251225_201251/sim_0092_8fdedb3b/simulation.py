...
# Antenna parameters
L = 0.031184275868500415  # Patch length (m)
W = 0.03800782304618002   # Patch width (m)
h = 0.0017073295413114606  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002801886252273398  # Feed x position
feed_y = 0.007799623047961965  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0092_8fdedb3b')
