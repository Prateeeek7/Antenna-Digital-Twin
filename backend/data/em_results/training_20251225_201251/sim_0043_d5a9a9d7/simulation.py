...
# Antenna parameters
L = 0.03197261015996085  # Patch length (m)
W = 0.04361803413372664   # Patch width (m)
h = 0.0017189029908712392  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002718829870755498  # Feed x position
feed_y = 0.007188304842450355  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0043_d5a9a9d7')
