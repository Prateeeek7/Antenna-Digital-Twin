...
# Antenna parameters
L = 0.02835268860623092  # Patch length (m)
W = 0.04370059775645804   # Patch width (m)
h = 0.0014733741699419637  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0020341590237413576  # Feed x position
feed_y = 0.002523506305811828  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0826_35cdb651')
