...
# Antenna parameters
L = 0.032030893359577504  # Patch length (m)
W = 0.03506664098412461   # Patch width (m)
h = 0.0022320542233573368  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001951312049448706  # Feed x position
feed_y = 0.0027999450227984687  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0996_590fc813')
