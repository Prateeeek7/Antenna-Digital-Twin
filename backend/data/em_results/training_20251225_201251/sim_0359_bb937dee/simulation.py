...
# Antenna parameters
L = 0.03239704980791288  # Patch length (m)
W = 0.03735646749291924   # Patch width (m)
h = 0.0019657043981267616  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012958819923165152  # Feed x position
feed_y = 0.014942586997167696  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0359_bb937dee')
