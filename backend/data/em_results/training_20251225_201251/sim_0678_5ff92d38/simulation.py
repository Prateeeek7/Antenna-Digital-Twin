...
# Antenna parameters
L = 0.03189861712998506  # Patch length (m)
W = 0.0397845204964697   # Patch width (m)
h = 0.0017624621369144466  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012759446851994025  # Feed x position
feed_y = 0.009036249281250014  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0678_5ff92d38')
