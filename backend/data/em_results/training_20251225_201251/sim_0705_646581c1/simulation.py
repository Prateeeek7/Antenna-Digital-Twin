...
# Antenna parameters
L = 0.03467567674704131  # Patch length (m)
W = 0.03254837120178267   # Patch width (m)
h = 0.001550831532094293  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00671255881568362  # Feed x position
feed_y = 0.005948468970589834  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0705_646581c1')
