...
# Antenna parameters
L = 0.033347132560990214  # Patch length (m)
W = 0.03465200586339876   # Patch width (m)
h = 0.0022761862650224106  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005643054586886355  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0676_a9e8ce09')
