...
# Antenna parameters
L = 0.029201270127845985  # Patch length (m)
W = 0.039334814226655676   # Patch width (m)
h = 0.0030221830206116677  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00702885851040194  # Feed x position
feed_y = 0.015159209873100413  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0492_76dc23f8')
