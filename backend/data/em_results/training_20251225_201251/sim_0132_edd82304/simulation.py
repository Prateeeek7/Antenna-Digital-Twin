...
# Antenna parameters
L = 0.026537251749492452  # Patch length (m)
W = 0.04461170163656742   # Patch width (m)
h = 0.0008883497751633453  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004483670212390275  # Feed x position
feed_y = 0.016855596247340534  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0132_edd82304')
