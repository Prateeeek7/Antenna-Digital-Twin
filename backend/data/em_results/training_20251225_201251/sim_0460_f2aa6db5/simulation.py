...
# Antenna parameters
L = 0.03299051126242851  # Patch length (m)
W = 0.03030365245428409   # Patch width (m)
h = 0.0029108680635425016  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006705551601264358  # Feed x position
feed_y = 0.010160267135125006  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0460_f2aa6db5')
