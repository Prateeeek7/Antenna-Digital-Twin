...
# Antenna parameters
L = 0.028119192282407928  # Patch length (m)
W = 0.03729414482495138   # Patch width (m)
h = 0.0026010743394045193  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004192067040452704  # Feed x position
feed_y = 0.002400254968877304  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0838_9e6c67aa')
