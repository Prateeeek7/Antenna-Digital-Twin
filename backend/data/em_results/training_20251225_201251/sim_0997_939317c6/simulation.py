...
# Antenna parameters
L = 0.028136671946278776  # Patch length (m)
W = 0.03846550341394403   # Patch width (m)
h = 0.0014763448486842844  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011254668778511511  # Feed x position
feed_y = 0.015386201365577612  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0997_939317c6')
