...
# Antenna parameters
L = 0.029945970372582297  # Patch length (m)
W = 0.03177832746361077   # Patch width (m)
h = 0.0013433857095112049  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009260296621235063  # Feed x position
feed_y = 0.006789629351677869  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0859_67512b21')
