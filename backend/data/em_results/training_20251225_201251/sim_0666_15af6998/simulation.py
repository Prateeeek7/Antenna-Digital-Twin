...
# Antenna parameters
L = 0.0318505585435334  # Patch length (m)
W = 0.041950875436892444   # Patch width (m)
h = 0.0024823371164379494  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012740223417413361  # Feed x position
feed_y = 0.002152778652896677  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0666_15af6998')
