...
# Antenna parameters
L = 0.02534960680616967  # Patch length (m)
W = 0.03789019661696193   # Patch width (m)
h = 0.0008243614602758998  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010039345093303972  # Feed x position
feed_y = 0.007402706749995239  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0777_bb7d26d1')
