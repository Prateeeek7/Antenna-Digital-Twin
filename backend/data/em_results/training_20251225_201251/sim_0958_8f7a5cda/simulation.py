...
# Antenna parameters
L = 0.027045089181735055  # Patch length (m)
W = 0.03319474761091121   # Patch width (m)
h = 0.0024721418484262635  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002637499541173865  # Feed x position
feed_y = 0.013277899044364484  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0958_8f7a5cda')
