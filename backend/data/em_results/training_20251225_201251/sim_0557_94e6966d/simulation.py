...
# Antenna parameters
L = 0.029853081149072945  # Patch length (m)
W = 0.0344596972565135   # Patch width (m)
h = 0.0015523059960983435  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007374681898606625  # Feed x position
feed_y = 0.008815041868800545  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0557_94e6966d')
