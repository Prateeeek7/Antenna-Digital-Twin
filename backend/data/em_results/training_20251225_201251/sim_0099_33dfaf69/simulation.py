...
# Antenna parameters
L = 0.032044508556164  # Patch length (m)
W = 0.0441235287270723   # Patch width (m)
h = 0.0020488975700457416  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00877441680086912  # Feed x position
feed_y = 0.009166382042836587  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0099_33dfaf69')
