...
# Antenna parameters
L = 0.02732192166090294  # Patch length (m)
W = 0.03325984236057505   # Patch width (m)
h = 0.002580332389552445  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007969147539187628  # Feed x position
feed_y = 0.009537533997005396  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0645_572226f0')
