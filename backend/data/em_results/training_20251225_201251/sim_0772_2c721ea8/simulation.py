...
# Antenna parameters
L = 0.034465300346058755  # Patch length (m)
W = 0.03617957670701734   # Patch width (m)
h = 0.0028791778160196426  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0010797339253830153  # Feed x position
feed_y = 0.014471830682806936  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0772_2c721ea8')
