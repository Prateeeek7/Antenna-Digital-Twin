...
# Antenna parameters
L = 0.026584948466051413  # Patch length (m)
W = 0.03983647739755111   # Patch width (m)
h = 0.0020381461996700928  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005272615353042531  # Feed x position
feed_y = 0.009424997225706805  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0496_a4f72451')
