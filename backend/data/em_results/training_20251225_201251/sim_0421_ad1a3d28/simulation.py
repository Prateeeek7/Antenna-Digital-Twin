...
# Antenna parameters
L = 0.030842896408079773  # Patch length (m)
W = 0.03960429620085139   # Patch width (m)
h = 0.002134417260902551  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006487162679280553  # Feed x position
feed_y = 0.007085944110405565  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0421_ad1a3d28')
