...
# Antenna parameters
L = 0.028198000917975252  # Patch length (m)
W = 0.039704889565953735   # Patch width (m)
h = 0.000884511381493995  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007801472521746896  # Feed x position
feed_y = 0.0021300647798194556  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0010_ee3b3b2d')
