...
# Antenna parameters
L = 0.02776072141774537  # Patch length (m)
W = 0.042825596609932154   # Patch width (m)
h = 0.0017068930822775547  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010502588752076993  # Feed x position
feed_y = 0.005894983101781982  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0757_642c7d42')
