...
# Antenna parameters
L = 0.02986952636226701  # Patch length (m)
W = 0.03200907171784462   # Patch width (m)
h = 0.0027391387962464957  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008653207478794276  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0661_73738fd7')
