...
# Antenna parameters
L = 0.027158069924638414  # Patch length (m)
W = 0.03614187392142505   # Patch width (m)
h = 0.001020490694228791  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010863227969855366  # Feed x position
feed_y = 0.011873618511143135  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0625_139c01ed')
