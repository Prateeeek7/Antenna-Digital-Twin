...
# Antenna parameters
L = 0.027029008430294012  # Patch length (m)
W = 0.042266895222605384   # Patch width (m)
h = 0.001329385438317747  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00860635876326202  # Feed x position
feed_y = 0.009443804575399926  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0247_3986f7a3')
