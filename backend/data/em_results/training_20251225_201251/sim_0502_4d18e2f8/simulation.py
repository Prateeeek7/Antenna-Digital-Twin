...
# Antenna parameters
L = 0.03132537399939289  # Patch length (m)
W = 0.033338703519493515   # Patch width (m)
h = 0.0011021133237537712  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009756338590447543  # Feed x position
feed_y = 0.013335481407797407  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0502_4d18e2f8')
