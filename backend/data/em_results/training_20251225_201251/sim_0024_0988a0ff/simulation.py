...
# Antenna parameters
L = 0.029594159020310876  # Patch length (m)
W = 0.04418025230097668   # Patch width (m)
h = 0.002923797333629264  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006504562249277563  # Feed x position
feed_y = 0.016522495098215018  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0024_0988a0ff')
