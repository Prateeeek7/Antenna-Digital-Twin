...
# Antenna parameters
L = 0.034337888062799714  # Patch length (m)
W = 0.0441421655942367   # Patch width (m)
h = 0.0011891444095978362  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006000361261455291  # Feed x position
feed_y = 0.005868918603239833  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0748_b6c72706')
