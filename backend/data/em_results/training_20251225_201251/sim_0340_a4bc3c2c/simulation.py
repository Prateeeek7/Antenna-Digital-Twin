...
# Antenna parameters
L = 0.03207082140003375  # Patch length (m)
W = 0.04333523722102578   # Patch width (m)
h = 0.001514355078381826  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0128283285600135  # Feed x position
feed_y = 0.017334094888410312  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0340_a4bc3c2c')
