...
# Antenna parameters
L = 0.030452100940182646  # Patch length (m)
W = 0.034364033138513175   # Patch width (m)
h = 0.0013321906613889864  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006909123351184456  # Feed x position
feed_y = 0.01374561325540527  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0606_74a06f47')
