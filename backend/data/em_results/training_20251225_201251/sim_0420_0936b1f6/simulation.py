...
# Antenna parameters
L = 0.026392528891273127  # Patch length (m)
W = 0.044743038722799354   # Patch width (m)
h = 0.0023412633338615505  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006757319984276336  # Feed x position
feed_y = 0.004952908253603142  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0420_0936b1f6')
