...
# Antenna parameters
L = 0.03248340048698871  # Patch length (m)
W = 0.03495600456964926   # Patch width (m)
h = 0.002994865318465379  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018523649204899547  # Feed x position
feed_y = 0.013982401827859703  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0202_613ae899')
