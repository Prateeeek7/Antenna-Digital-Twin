...
# Antenna parameters
L = 0.031031189639480823  # Patch length (m)
W = 0.04082582829964693   # Patch width (m)
h = 0.002282714988556051  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.012196266869301484  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0179_aa4d8f42')
