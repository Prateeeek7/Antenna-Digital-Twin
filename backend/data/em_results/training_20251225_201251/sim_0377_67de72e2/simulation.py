...
# Antenna parameters
L = 0.03421669323003054  # Patch length (m)
W = 0.03143809161057162   # Patch width (m)
h = 0.0019395470906959306  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004211210607908879  # Feed x position
feed_y = 0.00679933170116652  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0377_67de72e2')
