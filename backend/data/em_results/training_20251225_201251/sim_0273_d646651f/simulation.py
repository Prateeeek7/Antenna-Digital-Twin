...
# Antenna parameters
L = 0.02556477749106018  # Patch length (m)
W = 0.04228178510395717   # Patch width (m)
h = 0.0022564649032299705  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008804656693860585  # Feed x position
feed_y = 0.00538365215120048  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0273_d646651f')
