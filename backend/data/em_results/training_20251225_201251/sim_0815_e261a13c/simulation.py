...
# Antenna parameters
L = 0.03240593401856298  # Patch length (m)
W = 0.03872026186460127   # Patch width (m)
h = 0.0011658224379004342  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006154595891873636  # Feed x position
feed_y = 0.01548810474584051  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0815_e261a13c')
