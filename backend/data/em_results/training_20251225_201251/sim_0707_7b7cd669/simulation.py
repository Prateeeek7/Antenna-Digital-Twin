...
# Antenna parameters
L = 0.030162046765374727  # Patch length (m)
W = 0.04285157554937314   # Patch width (m)
h = 0.0015929787753322837  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012064818706149892  # Feed x position
feed_y = 0.012827542379572118  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0707_7b7cd669')
