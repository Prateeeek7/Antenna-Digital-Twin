...
# Antenna parameters
L = 0.025587132257892397  # Patch length (m)
W = 0.041997959588321684   # Patch width (m)
h = 0.002771481636602538  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005034951490516815  # Feed x position
feed_y = 0.0020051466679487187  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0923_0786a6bb')
