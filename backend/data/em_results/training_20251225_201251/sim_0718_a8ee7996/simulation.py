...
# Antenna parameters
L = 0.029541961172596914  # Patch length (m)
W = 0.03665507893286159   # Patch width (m)
h = 0.0009564656226022747  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007960276408351253  # Feed x position
feed_y = 0.008668112474410435  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0718_a8ee7996')
