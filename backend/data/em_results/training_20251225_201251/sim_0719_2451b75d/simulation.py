...
# Antenna parameters
L = 0.03285002324552631  # Patch length (m)
W = 0.03151695814315148   # Patch width (m)
h = 0.003125881165991681  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013140009298210523  # Feed x position
feed_y = 0.004436983899795721  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0719_2451b75d')
