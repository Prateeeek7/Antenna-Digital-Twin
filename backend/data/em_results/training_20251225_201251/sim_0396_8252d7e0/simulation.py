...
# Antenna parameters
L = 0.03146140438866581  # Patch length (m)
W = 0.037719326992154856   # Patch width (m)
h = 0.0013619558667613942  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008537969187126437  # Feed x position
feed_y = 0.009738778296512632  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0396_8252d7e0')
