...
# Antenna parameters
L = 0.03179118280576725  # Patch length (m)
W = 0.0402568535900908   # Patch width (m)
h = 0.002465381284530977  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0037178144775877795  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0789_73a6f84d')
