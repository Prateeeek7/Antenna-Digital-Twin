...
# Antenna parameters
L = 0.026548381306393715  # Patch length (m)
W = 0.03751359650421587   # Patch width (m)
h = 0.0028074807838417695  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005106195198911908  # Feed x position
feed_y = 0.012800607020493003  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0576_06471a14')
