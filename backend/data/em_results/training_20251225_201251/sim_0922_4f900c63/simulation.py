...
# Antenna parameters
L = 0.026361358613231797  # Patch length (m)
W = 0.03415044532298193   # Patch width (m)
h = 0.0026751795902806856  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006491919278962272  # Feed x position
feed_y = 0.01242524461149728  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0922_4f900c63')
