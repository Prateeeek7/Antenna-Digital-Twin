...
# Antenna parameters
L = 0.03387776455899161  # Patch length (m)
W = 0.032532474155270316   # Patch width (m)
h = 0.003050069242075667  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007091409068038547  # Feed x position
feed_y = 0.01137635847648532  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0999_0abb054f')
