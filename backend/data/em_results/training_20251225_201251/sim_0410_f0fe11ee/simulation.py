...
# Antenna parameters
L = 0.028240123525522437  # Patch length (m)
W = 0.03914975654315486   # Patch width (m)
h = 0.0017037139809643416  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007118732854891079  # Feed x position
feed_y = 0.006746992675904473  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0410_f0fe11ee')
