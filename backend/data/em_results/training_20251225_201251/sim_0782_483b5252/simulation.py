...
# Antenna parameters
L = 0.029114886940465875  # Patch length (m)
W = 0.03041288204866218   # Patch width (m)
h = 0.0024755229635465073  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011101704751052186  # Feed x position
feed_y = 0.012165152819464873  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0782_483b5252')
