...
# Antenna parameters
L = 0.03430209970230837  # Patch length (m)
W = 0.034177311706311886   # Patch width (m)
h = 0.0008615912321147197  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009404571522510674  # Feed x position
feed_y = 0.010191150642887146  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0753_c41cc48e')
