...
# Antenna parameters
L = 0.02513033180121918  # Patch length (m)
W = 0.043264445128487164   # Patch width (m)
h = 0.0016636122782565173  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003159056898871378  # Feed x position
feed_y = 0.004864680663792462  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0812_6c820637')
