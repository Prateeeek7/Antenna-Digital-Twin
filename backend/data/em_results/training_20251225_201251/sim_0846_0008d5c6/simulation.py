...
# Antenna parameters
L = 0.029560237991356424  # Patch length (m)
W = 0.03215950864154604   # Patch width (m)
h = 0.0018254424357867973  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01182409519654257  # Feed x position
feed_y = 0.012863803456618417  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0846_0008d5c6')
