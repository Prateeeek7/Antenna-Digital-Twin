...
# Antenna parameters
L = 0.02727732124397923  # Patch length (m)
W = 0.03251115740504395   # Patch width (m)
h = 0.0021875235597085094  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010910928497591692  # Feed x position
feed_y = 0.007242127716528794  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0823_606ab9e2')
