...
# Antenna parameters
L = 0.02863477874907097  # Patch length (m)
W = 0.03450430875459358   # Patch width (m)
h = 0.001845326257395699  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01145391149962839  # Feed x position
feed_y = 0.011378353876711288  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0355_cfa910d5')
