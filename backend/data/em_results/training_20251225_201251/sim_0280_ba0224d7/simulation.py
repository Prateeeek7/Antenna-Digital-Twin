...
# Antenna parameters
L = 0.032245549839451465  # Patch length (m)
W = 0.03910405324243944   # Patch width (m)
h = 0.0010496749944287323  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0016072688844686403  # Feed x position
feed_y = 0.01564162129697578  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0280_ba0224d7')
