...
# Antenna parameters
L = 0.03369506009180756  # Patch length (m)
W = 0.03892005208181501   # Patch width (m)
h = 0.0009244531419467215  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0047368107753040555  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0025_d7ded2d4')
