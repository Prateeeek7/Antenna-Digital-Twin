...
# Antenna parameters
L = 0.032065914833298646  # Patch length (m)
W = 0.04216783651871499   # Patch width (m)
h = 0.0024983831732865768  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009509549515930577  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0933_4a46f926')
