...
# Antenna parameters
L = 0.03195524087565343  # Patch length (m)
W = 0.04319068617390437   # Patch width (m)
h = 0.0021766070184200347  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01727627446956175  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0766_a7671774')
