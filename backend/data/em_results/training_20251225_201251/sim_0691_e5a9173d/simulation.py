...
# Antenna parameters
L = 0.02873217716076497  # Patch length (m)
W = 0.031230936521118406   # Patch width (m)
h = 0.0016474344723081968  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010170897029204122  # Feed x position
feed_y = 0.005171970396284713  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0691_e5a9173d')
