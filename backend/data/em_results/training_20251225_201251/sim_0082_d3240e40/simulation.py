...
# Antenna parameters
L = 0.028593343152638936  # Patch length (m)
W = 0.037565248124766616   # Patch width (m)
h = 0.003065382942255238  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010409448987239878  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0082_d3240e40')
