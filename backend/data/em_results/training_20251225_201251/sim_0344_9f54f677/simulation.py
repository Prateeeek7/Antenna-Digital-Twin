...
# Antenna parameters
L = 0.029529755491591182  # Patch length (m)
W = 0.04133669763163271   # Patch width (m)
h = 0.0017510913972545875  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.009517865465460188  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0344_9f54f677')
