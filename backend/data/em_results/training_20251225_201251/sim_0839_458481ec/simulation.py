...
# Antenna parameters
L = 0.02649480859215839  # Patch length (m)
W = 0.03740823780471134   # Patch width (m)
h = 0.0022618769359936393  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010410141415228974  # Feed x position
feed_y = 0.009686818995699868  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0839_458481ec')
