...
# Antenna parameters
L = 0.02519908276320941  # Patch length (m)
W = 0.0399049876511528   # Patch width (m)
h = 0.002288826757427977  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010079633105283765  # Feed x position
feed_y = 0.013866588818896946  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0208_637adf53')
