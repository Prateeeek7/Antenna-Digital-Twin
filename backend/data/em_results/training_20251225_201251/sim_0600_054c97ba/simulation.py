...
# Antenna parameters
L = 0.02539170778858797  # Patch length (m)
W = 0.04463108856019573   # Patch width (m)
h = 0.0011162123486067352  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0028851877070380175  # Feed x position
feed_y = 0.0020734603808807974  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0600_054c97ba')
