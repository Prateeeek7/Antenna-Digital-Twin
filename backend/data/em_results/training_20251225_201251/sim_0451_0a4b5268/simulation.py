...
# Antenna parameters
L = 0.03256478019885882  # Patch length (m)
W = 0.044341353036352234   # Patch width (m)
h = 0.002130095185701785  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002750767846322818  # Feed x position
feed_y = 0.013891500764622765  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0451_0a4b5268')
