...
# Antenna parameters
L = 0.032982662465025625  # Patch length (m)
W = 0.03460875024693097   # Patch width (m)
h = 0.0011447684171328487  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001333755052346555  # Feed x position
feed_y = 0.006315388358503952  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0123_de514c60')
