...
# Antenna parameters
L = 0.03250577504916082  # Patch length (m)
W = 0.03584159439156048   # Patch width (m)
h = 0.0029063777543440394  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0022219557713005007  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0525_95ca9c93')
