...
# Antenna parameters
L = 0.032606816736123714  # Patch length (m)
W = 0.042563081866712434   # Patch width (m)
h = 0.001235780535380443  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013042726694449487  # Feed x position
feed_y = 0.007263980176196706  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0227_9f75a236')
