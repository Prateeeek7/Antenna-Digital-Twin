...
# Antenna parameters
L = 0.02934653521344593  # Patch length (m)
W = 0.04294471448778274   # Patch width (m)
h = 0.0017164028293818038  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00462611175479368  # Feed x position
feed_y = 0.016132008259432444  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0159_66768b5c')
