...
# Antenna parameters
L = 0.03392222595161759  # Patch length (m)
W = 0.03447042260360909   # Patch width (m)
h = 0.0026275982211531146  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006222287800324119  # Feed x position
feed_y = 0.005963142915560958  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0040_3a3e65fb')
