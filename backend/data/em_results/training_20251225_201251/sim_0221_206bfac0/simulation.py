...
# Antenna parameters
L = 0.032622256640988175  # Patch length (m)
W = 0.03686826443749036   # Patch width (m)
h = 0.0027574638497836245  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011287323478160976  # Feed x position
feed_y = 0.011849596771953595  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0221_206bfac0')
