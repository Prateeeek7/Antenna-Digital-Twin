...
# Antenna parameters
L = 0.027843617129760877  # Patch length (m)
W = 0.033412275904176406   # Patch width (m)
h = 0.0011555575112307391  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003042870769895016  # Feed x position
feed_y = 0.012332141478071419  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0744_342f4838')
