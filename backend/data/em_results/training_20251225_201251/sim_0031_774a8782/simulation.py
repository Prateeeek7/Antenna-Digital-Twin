...
# Antenna parameters
L = 0.032233277599069604  # Patch length (m)
W = 0.042100781493242416   # Patch width (m)
h = 0.00271841738567674  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012893311039627842  # Feed x position
feed_y = 0.006341037675428328  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0031_774a8782')
