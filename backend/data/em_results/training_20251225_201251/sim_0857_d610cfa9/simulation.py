...
# Antenna parameters
L = 0.030448437260228833  # Patch length (m)
W = 0.044326353096824936   # Patch width (m)
h = 0.001644280665659161  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0035777784807960473  # Feed x position
feed_y = 0.017606322203487717  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0857_d610cfa9')
