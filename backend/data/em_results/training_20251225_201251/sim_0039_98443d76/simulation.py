...
# Antenna parameters
L = 0.03180820731691843  # Patch length (m)
W = 0.03801600925812719   # Patch width (m)
h = 0.00232190105110199  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012723282926767372  # Feed x position
feed_y = 0.014554232912051721  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0039_98443d76')
