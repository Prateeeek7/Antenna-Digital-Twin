...
# Antenna parameters
L = 0.030229678509121973  # Patch length (m)
W = 0.03059145025644609   # Patch width (m)
h = 0.0027220297204990076  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01209187140364879  # Feed x position
feed_y = 0.0073393880925164195  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0368_b78a100b')
