...
# Antenna parameters
L = 0.028714121780704312  # Patch length (m)
W = 0.03236651170477194   # Patch width (m)
h = 0.0013086458987562428  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0027168224184618748  # Feed x position
feed_y = 0.005884612629090891  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0569_6328ad63')
