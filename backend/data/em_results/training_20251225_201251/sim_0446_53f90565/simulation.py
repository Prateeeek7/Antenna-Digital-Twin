...
# Antenna parameters
L = 0.02663660984142427  # Patch length (m)
W = 0.0306951681091092   # Patch width (m)
h = 0.0009101743491147948  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037697481871751676  # Feed x position
feed_y = 0.004577439743615134  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0446_53f90565')
