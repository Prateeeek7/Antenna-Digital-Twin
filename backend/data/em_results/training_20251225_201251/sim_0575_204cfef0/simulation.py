...
# Antenna parameters
L = 0.025447832058542688  # Patch length (m)
W = 0.034435881446348085   # Patch width (m)
h = 0.0010486368647950827  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006622428798431441  # Feed x position
feed_y = 0.013774352578539234  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0575_204cfef0')
