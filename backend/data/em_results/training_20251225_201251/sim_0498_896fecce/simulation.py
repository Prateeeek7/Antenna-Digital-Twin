...
# Antenna parameters
L = 0.03283040903936629  # Patch length (m)
W = 0.043913967928876446   # Patch width (m)
h = 0.001092677734186393  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001527873022356059  # Feed x position
feed_y = 0.012342379325604318  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0498_896fecce')
