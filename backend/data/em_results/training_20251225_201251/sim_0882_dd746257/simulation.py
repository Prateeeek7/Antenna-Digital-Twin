...
# Antenna parameters
L = 0.03191628719512492  # Patch length (m)
W = 0.03859421576983768   # Patch width (m)
h = 0.0022574180257014663  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007593672214103247  # Feed x position
feed_y = 0.010511964054310218  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0882_dd746257')
