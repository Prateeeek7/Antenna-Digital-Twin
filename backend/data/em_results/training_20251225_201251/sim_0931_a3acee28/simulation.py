...
# Antenna parameters
L = 0.025151299046103862  # Patch length (m)
W = 0.03697676872501356   # Patch width (m)
h = 0.0016565423219607523  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010060519618441545  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0931_a3acee28')
