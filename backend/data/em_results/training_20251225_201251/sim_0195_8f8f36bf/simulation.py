...
# Antenna parameters
L = 0.025023918707880854  # Patch length (m)
W = 0.03590302478802016   # Patch width (m)
h = 0.0015358389170114113  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0035592534787171736  # Feed x position
feed_y = 0.008828782875618056  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0195_8f8f36bf')
