...
# Antenna parameters
L = 0.034538185455446985  # Patch length (m)
W = 0.030552187028301415   # Patch width (m)
h = 0.0013412498881648595  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006927623488670758  # Feed x position
feed_y = 0.003058915490496224  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0959_224a3969')
