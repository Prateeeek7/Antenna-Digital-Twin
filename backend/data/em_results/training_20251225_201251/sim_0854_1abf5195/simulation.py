...
# Antenna parameters
L = 0.02810001744048785  # Patch length (m)
W = 0.03839282231308588   # Patch width (m)
h = 0.0018084633848532324  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0032615342032396946  # Feed x position
feed_y = 0.010573160537099788  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0854_1abf5195')
