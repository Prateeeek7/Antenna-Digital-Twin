...
# Antenna parameters
L = 0.030997049598595037  # Patch length (m)
W = 0.0326301186151619   # Patch width (m)
h = 0.001943456665170134  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005993189071273056  # Feed x position
feed_y = 0.007539067926824105  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0820_dbafbce2')
