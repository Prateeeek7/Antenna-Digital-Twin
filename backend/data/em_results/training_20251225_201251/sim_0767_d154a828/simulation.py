...
# Antenna parameters
L = 0.026805601466994084  # Patch length (m)
W = 0.03301971611651343   # Patch width (m)
h = 0.002592704139379793  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034740725967915714  # Feed x position
feed_y = 0.006500212122900134  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0767_d154a828')
