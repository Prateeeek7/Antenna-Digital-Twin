...
# Antenna parameters
L = 0.030178743749544486  # Patch length (m)
W = 0.040656697287225194   # Patch width (m)
h = 0.002558373781310853  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.012346881032441685  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0861_419ad66a')
