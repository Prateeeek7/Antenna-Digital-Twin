...
# Antenna parameters
L = 0.03346929688861436  # Patch length (m)
W = 0.030989726533905165   # Patch width (m)
h = 0.001956740125475104  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013387718755445744  # Feed x position
feed_y = 0.00909840402038269  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0867_eca639ec')
