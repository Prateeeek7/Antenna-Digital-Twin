...
# Antenna parameters
L = 0.027666472551281417  # Patch length (m)
W = 0.04426919311270716   # Patch width (m)
h = 0.0018858103361403225  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011066589020512567  # Feed x position
feed_y = 0.009728443332873581  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0658_769e4a24')
