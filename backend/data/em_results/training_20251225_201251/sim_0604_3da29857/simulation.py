...
# Antenna parameters
L = 0.026446067498655995  # Patch length (m)
W = 0.03361886501017719   # Patch width (m)
h = 0.002836461817804579  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0016188863611008412  # Feed x position
feed_y = 0.0012890455375045252  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0604_3da29857')
