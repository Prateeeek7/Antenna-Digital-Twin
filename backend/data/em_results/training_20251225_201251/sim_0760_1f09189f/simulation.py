...
# Antenna parameters
L = 0.025299844192999577  # Patch length (m)
W = 0.040106900552609216   # Patch width (m)
h = 0.0012144502692507152  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0032234758317559063  # Feed x position
feed_y = 0.00687792947861498  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0760_1f09189f')
