...
# Antenna parameters
L = 0.034137586279383736  # Patch length (m)
W = 0.03392516261479247   # Patch width (m)
h = 0.0008524269402461998  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013571835848154518  # Feed x position
feed_y = 0.01091909776282785  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0140_4dbc617f')
