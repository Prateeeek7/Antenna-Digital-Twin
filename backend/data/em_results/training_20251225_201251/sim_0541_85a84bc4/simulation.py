...
# Antenna parameters
L = 0.031065315946803847  # Patch length (m)
W = 0.03513161273494185   # Patch width (m)
h = 0.0029666481247572355  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015816844802536635  # Feed x position
feed_y = 0.00160476281935076  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0541_85a84bc4')
