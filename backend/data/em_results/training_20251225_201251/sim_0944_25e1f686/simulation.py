...
# Antenna parameters
L = 0.027935532036553096  # Patch length (m)
W = 0.039186853999576346   # Patch width (m)
h = 0.0011833584014853018  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006095359254329641  # Feed x position
feed_y = 0.013635650515065007  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0944_25e1f686')
