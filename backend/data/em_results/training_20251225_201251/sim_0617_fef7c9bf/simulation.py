...
# Antenna parameters
L = 0.030866837246228154  # Patch length (m)
W = 0.03967192110224302   # Patch width (m)
h = 0.001137311325971709  # Substrate height (m)
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0617_fef7c9bf')
