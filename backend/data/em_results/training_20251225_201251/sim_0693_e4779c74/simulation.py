...
# Antenna parameters
L = 0.025302069792113985  # Patch length (m)
W = 0.04419570428098178   # Patch width (m)
h = 0.001725676985145329  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004310076491582621  # Feed x position
feed_y = 0.017678281712392715  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0693_e4779c74')
