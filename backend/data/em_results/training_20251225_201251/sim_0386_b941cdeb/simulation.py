...
# Antenna parameters
L = 0.0343835599059855  # Patch length (m)
W = 0.030650843938362385   # Patch width (m)
h = 0.0019933360437538673  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013309695186970196  # Feed x position
feed_y = 0.012260337575344955  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0386_b941cdeb')
