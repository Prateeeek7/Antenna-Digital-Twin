...
# Antenna parameters
L = 0.028213315970382097  # Patch length (m)
W = 0.03225793355690785   # Patch width (m)
h = 0.0010410434333444451  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007620910392747728  # Feed x position
feed_y = 0.0051510320184082895  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0012_b730eca3')
