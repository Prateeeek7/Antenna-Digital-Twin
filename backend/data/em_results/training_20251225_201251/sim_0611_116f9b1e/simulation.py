...
# Antenna parameters
L = 0.029535044651958477  # Patch length (m)
W = 0.038240739793501115   # Patch width (m)
h = 0.0031468360070989296  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00987628899080248  # Feed x position
feed_y = 0.013015811324395794  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0611_116f9b1e')
