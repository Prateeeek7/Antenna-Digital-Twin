...
# Antenna parameters
L = 0.026938341339702767  # Patch length (m)
W = 0.03573270512670697   # Patch width (m)
h = 0.002839922841451759  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030387351211900926  # Feed x position
feed_y = 0.013795133702035868  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0539_855c7992')
