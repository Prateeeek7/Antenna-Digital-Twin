...
# Antenna parameters
L = 0.029214634319864232  # Patch length (m)
W = 0.03689348155372953   # Patch width (m)
h = 0.002424483788401059  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.011271839451778188  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0192_84c5c903')
