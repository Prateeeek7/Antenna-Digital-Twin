...
# Antenna parameters
L = 0.03232283377243273  # Patch length (m)
W = 0.044868600224827554   # Patch width (m)
h = 0.0008130203142991335  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01183237246470884  # Feed x position
feed_y = 0.016370509571107358  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0528_6728442f')
