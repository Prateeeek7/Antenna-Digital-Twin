...
# Antenna parameters
L = 0.028539064170546618  # Patch length (m)
W = 0.037846679568626584   # Patch width (m)
h = 0.001765365895161008  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007502922896680258  # Feed x position
feed_y = 0.014376206725418901  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0457_d659390b')
