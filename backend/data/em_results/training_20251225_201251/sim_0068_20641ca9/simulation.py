...
# Antenna parameters
L = 0.033858625920699624  # Patch length (m)
W = 0.034560616796311366   # Patch width (m)
h = 0.002458877877977396  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0011411426528512483  # Feed x position
feed_y = 0.013741601499044095  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0068_20641ca9')
