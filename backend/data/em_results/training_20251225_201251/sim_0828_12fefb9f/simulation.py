...
# Antenna parameters
L = 0.028086095150102318  # Patch length (m)
W = 0.044887065401446304   # Patch width (m)
h = 0.002784719639434407  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009403463416961244  # Feed x position
feed_y = 0.006116436855280126  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0828_12fefb9f')
