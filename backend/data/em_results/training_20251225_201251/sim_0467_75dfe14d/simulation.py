...
# Antenna parameters
L = 0.03023310238151556  # Patch length (m)
W = 0.03808697645339576   # Patch width (m)
h = 0.0030455130281447436  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011056733116222666  # Feed x position
feed_y = 0.015234790581358305  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0467_75dfe14d')
