...
# Antenna parameters
L = 0.033159328333311526  # Patch length (m)
W = 0.038081970314434666   # Patch width (m)
h = 0.0023791575949256003  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011266656404536855  # Feed x position
feed_y = 0.012402640050739095  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0136_17f927ef')
