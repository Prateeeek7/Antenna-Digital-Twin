...
# Antenna parameters
L = 0.032788596604029364  # Patch length (m)
W = 0.03744871328521025   # Patch width (m)
h = 0.0019304810434108565  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.011273316795933816  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0046_7b1b5539')
