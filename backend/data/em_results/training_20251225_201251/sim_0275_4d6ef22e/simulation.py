...
# Antenna parameters
L = 0.029099192647199977  # Patch length (m)
W = 0.04161522495798097   # Patch width (m)
h = 0.001815508618191821  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006799983224456052  # Feed x position
feed_y = 0.010852646704756464  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0275_4d6ef22e')
