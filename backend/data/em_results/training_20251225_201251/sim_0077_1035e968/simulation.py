...
# Antenna parameters
L = 0.031120133684550758  # Patch length (m)
W = 0.03691923359645995   # Patch width (m)
h = 0.003192917132815991  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010625682118693209  # Feed x position
feed_y = 0.014548937128011597  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0077_1035e968')
