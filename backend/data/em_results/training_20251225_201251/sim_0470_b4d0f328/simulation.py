...
# Antenna parameters
L = 0.031609437111870184  # Patch length (m)
W = 0.0412221955474028   # Patch width (m)
h = 0.002412236711626276  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011702631144467427  # Feed x position
feed_y = 0.010173096939261274  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0470_b4d0f328')
