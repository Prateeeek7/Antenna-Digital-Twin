...
# Antenna parameters
L = 0.02648797209547391  # Patch length (m)
W = 0.04353510020633644   # Patch width (m)
h = 0.002682260439626608  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004137428832652195  # Feed x position
feed_y = 0.0054211398206765555  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0383_dfd5ec06')
