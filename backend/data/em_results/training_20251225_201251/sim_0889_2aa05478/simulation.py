...
# Antenna parameters
L = 0.03427541941458382  # Patch length (m)
W = 0.04113927976647618   # Patch width (m)
h = 0.0022748255379281043  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012723811690345605  # Feed x position
feed_y = 0.016455711906590474  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0889_2aa05478')
