...
# Antenna parameters
L = 0.03437411012709432  # Patch length (m)
W = 0.03678726404728562   # Patch width (m)
h = 0.0028090941750098805  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012235086127893077  # Feed x position
feed_y = 0.010390300381630458  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0902_64cc9ac9')
