...
# Antenna parameters
L = 0.027616448351130064  # Patch length (m)
W = 0.04172321324647748   # Patch width (m)
h = 0.0019918012119678388  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011046579340452027  # Feed x position
feed_y = 0.00469598154299221  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0444_a0577a77')
