...
# Antenna parameters
L = 0.02990406659874589  # Patch length (m)
W = 0.038835163830974365   # Patch width (m)
h = 0.0011073274010517825  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011496528654419821  # Feed x position
feed_y = 0.011837036240903568  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0791_e219d4da')
