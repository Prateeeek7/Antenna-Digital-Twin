...
# Antenna parameters
L = 0.031849447900432926  # Patch length (m)
W = 0.043029775861748075   # Patch width (m)
h = 0.0026483237594434146  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004999871360466131  # Feed x position
feed_y = 0.014557049848026112  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0345_69e16b30')
