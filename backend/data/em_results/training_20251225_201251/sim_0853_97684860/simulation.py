...
# Antenna parameters
L = 0.026174881776110954  # Patch length (m)
W = 0.03306865625785436   # Patch width (m)
h = 0.001741242793385779  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010469952710444382  # Feed x position
feed_y = 0.010437179943730796  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0853_97684860')
