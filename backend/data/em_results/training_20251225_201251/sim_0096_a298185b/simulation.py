...
# Antenna parameters
L = 0.03406591216890571  # Patch length (m)
W = 0.031136735572099544   # Patch width (m)
h = 0.0011753880650038186  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006995144806790682  # Feed x position
feed_y = 0.006911793904243765  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0096_a298185b')
