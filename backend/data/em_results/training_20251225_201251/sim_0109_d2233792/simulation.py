...
# Antenna parameters
L = 0.03489551754386746  # Patch length (m)
W = 0.03395411140926237   # Patch width (m)
h = 0.002040607881719249  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003214656554159654  # Feed x position
feed_y = 0.007496494330736627  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0109_d2233792')
