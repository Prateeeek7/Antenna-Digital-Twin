...
# Antenna parameters
L = 0.028094872679357  # Patch length (m)
W = 0.038783505412606986   # Patch width (m)
h = 0.0013735139773965966  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005352638310254322  # Feed x position
feed_y = 0.003566085095381105  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0144_1d284cf9')
