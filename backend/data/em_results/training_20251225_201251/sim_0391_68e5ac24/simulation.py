...
# Antenna parameters
L = 0.034430292898388046  # Patch length (m)
W = 0.030051745147414533   # Patch width (m)
h = 0.0014238124252642752  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009539777033811526  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0391_68e5ac24')
