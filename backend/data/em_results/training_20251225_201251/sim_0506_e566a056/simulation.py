...
# Antenna parameters
L = 0.026153798533425344  # Patch length (m)
W = 0.03350041181010095   # Patch width (m)
h = 0.0022527428106770774  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030728557916005882  # Feed x position
feed_y = 0.008593557587218902  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0506_e566a056')
