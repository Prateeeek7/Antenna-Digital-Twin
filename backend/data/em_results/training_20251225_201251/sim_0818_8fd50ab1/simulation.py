...
# Antenna parameters
L = 0.028658990488007022  # Patch length (m)
W = 0.03964852780577466   # Patch width (m)
h = 0.0017531937894057997  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014732661998953106  # Feed x position
feed_y = 0.004852597755150648  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0818_8fd50ab1')
