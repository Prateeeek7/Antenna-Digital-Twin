...
# Antenna parameters
L = 0.028168049705323554  # Patch length (m)
W = 0.0331345971633461   # Patch width (m)
h = 0.0008154717647122713  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005835012592615489  # Feed x position
feed_y = 0.013253838865338442  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0638_08ef8ddd')
