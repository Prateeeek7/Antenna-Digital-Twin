...
# Antenna parameters
L = 0.03476109207509122  # Patch length (m)
W = 0.040126598300404534   # Patch width (m)
h = 0.0024571547399350724  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013904436830036488  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0036_61f6cf70')
