...
# Antenna parameters
L = 0.027394685718278283  # Patch length (m)
W = 0.04332620835924128   # Patch width (m)
h = 0.0009787756008960854  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001725371754751127  # Feed x position
feed_y = 0.001137375994726461  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0786_ce67c7bd')
