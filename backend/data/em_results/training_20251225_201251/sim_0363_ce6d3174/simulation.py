...
# Antenna parameters
L = 0.028704542017142606  # Patch length (m)
W = 0.04186859367472223   # Patch width (m)
h = 0.0010268658656399916  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011481816806857044  # Feed x position
feed_y = 0.013615253851468945  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0363_ce6d3174')
