...
# Antenna parameters
L = 0.0281806876376431  # Patch length (m)
W = 0.03649320399617248   # Patch width (m)
h = 0.0008981189514418398  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007692091874942735  # Feed x position
feed_y = 0.014597281598468993  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0072_c5c1e66b')
