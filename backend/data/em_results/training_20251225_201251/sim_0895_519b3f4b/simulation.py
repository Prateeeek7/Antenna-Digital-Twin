...
# Antenna parameters
L = 0.02797345430033721  # Patch length (m)
W = 0.03411695520334166   # Patch width (m)
h = 0.0023690291950762836  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008478355419392172  # Feed x position
feed_y = 0.011890268314018718  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0895_519b3f4b')
