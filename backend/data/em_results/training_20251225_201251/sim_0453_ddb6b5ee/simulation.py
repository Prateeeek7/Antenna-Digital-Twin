...
# Antenna parameters
L = 0.03194873436207876  # Patch length (m)
W = 0.031068727206595807   # Patch width (m)
h = 0.002932381575206092  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010962833895065313  # Feed x position
feed_y = 0.012427490882638323  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0453_ddb6b5ee')
