...
# Antenna parameters
L = 0.03284149002879948  # Patch length (m)
W = 0.03612227428868908   # Patch width (m)
h = 0.0018770536132476819  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006616730402219422  # Feed x position
feed_y = 0.007226849339373334  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0333_5d05cb23')
