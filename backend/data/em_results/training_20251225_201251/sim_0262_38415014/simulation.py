...
# Antenna parameters
L = 0.03304607515265735  # Patch length (m)
W = 0.034441141493991814   # Patch width (m)
h = 0.0011514104539405996  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013218430061062943  # Feed x position
feed_y = 0.008523518804536894  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0262_38415014')
