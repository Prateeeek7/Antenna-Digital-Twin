...
# Antenna parameters
L = 0.026775539682807704  # Patch length (m)
W = 0.03503385448385177   # Patch width (m)
h = 0.003053163336907336  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0036852296221351302  # Feed x position
feed_y = 0.0023919634213926417  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0613_9125155a')
