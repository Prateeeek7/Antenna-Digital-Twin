...
# Antenna parameters
L = 0.029553823305394467  # Patch length (m)
W = 0.04273982534087397   # Patch width (m)
h = 0.001491807843884389  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010779512130648879  # Feed x position
feed_y = 0.0031925806558171783  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0512_1db77a95')
