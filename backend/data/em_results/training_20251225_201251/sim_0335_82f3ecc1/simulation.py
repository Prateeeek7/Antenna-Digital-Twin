...
# Antenna parameters
L = 0.02781061488541039  # Patch length (m)
W = 0.0386740743755138   # Patch width (m)
h = 0.0014469410654036467  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007649633921882923  # Feed x position
feed_y = 0.003702511672241646  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0335_82f3ecc1')
