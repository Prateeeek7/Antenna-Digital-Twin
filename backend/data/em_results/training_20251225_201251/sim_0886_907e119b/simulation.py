...
# Antenna parameters
L = 0.025286918730379637  # Patch length (m)
W = 0.037726470679647274   # Patch width (m)
h = 0.001686004730897881  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006456104321230215  # Feed x position
feed_y = 0.012382283533200238  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0886_907e119b')
