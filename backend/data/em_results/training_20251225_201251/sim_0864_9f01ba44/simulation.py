...
# Antenna parameters
L = 0.033441757610539004  # Patch length (m)
W = 0.03146173752502454   # Patch width (m)
h = 0.0022673155034323923  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013376703044215602  # Feed x position
feed_y = 0.012584695010009818  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0864_9f01ba44')
