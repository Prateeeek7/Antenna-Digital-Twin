...
# Antenna parameters
L = 0.02750513341669162  # Patch length (m)
W = 0.03917263939508468   # Patch width (m)
h = 0.00107374921650806  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010004005835496415  # Feed x position
feed_y = 0.004926478648998171  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0028_98256d0f')
