...
# Antenna parameters
L = 0.031938476878972874  # Patch length (m)
W = 0.034309555194373835   # Patch width (m)
h = 0.0025077292249386226  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006812780194850669  # Feed x position
feed_y = 0.013723822077749534  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0018_370c3358')
