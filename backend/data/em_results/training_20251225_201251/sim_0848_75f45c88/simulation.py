...
# Antenna parameters
L = 0.034842169871645436  # Patch length (m)
W = 0.035852578158174934   # Patch width (m)
h = 0.0016028569170965993  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007273149774688559  # Feed x position
feed_y = 0.0020307257744613377  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0848_75f45c88')
