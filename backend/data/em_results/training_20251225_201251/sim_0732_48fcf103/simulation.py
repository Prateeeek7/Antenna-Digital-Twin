...
# Antenna parameters
L = 0.0260378732529324  # Patch length (m)
W = 0.040486374814866874   # Patch width (m)
h = 0.001489063964782016  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00818006541070776  # Feed x position
feed_y = 0.008031677449528993  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0732_48fcf103')
