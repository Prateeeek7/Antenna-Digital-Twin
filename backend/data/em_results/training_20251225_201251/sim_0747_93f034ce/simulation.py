...
# Antenna parameters
L = 0.029890250372975765  # Patch length (m)
W = 0.04325617473805945   # Patch width (m)
h = 0.0019406606330757172  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.012751028900245234  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0747_93f034ce')
