...
# Antenna parameters
L = 0.030782441222691744  # Patch length (m)
W = 0.04230974935166441   # Patch width (m)
h = 0.0014806655983865802  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004551998629216628  # Feed x position
feed_y = 0.009903460409924299  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0729_48daf3d3')
