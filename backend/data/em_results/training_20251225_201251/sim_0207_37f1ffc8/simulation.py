...
# Antenna parameters
L = 0.02795352928201857  # Patch length (m)
W = 0.0379298645635005   # Patch width (m)
h = 0.0008470204239962456  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0023279692182555196  # Feed x position
feed_y = 0.012305855129273052  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0207_37f1ffc8')
