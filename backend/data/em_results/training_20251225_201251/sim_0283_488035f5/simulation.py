...
# Antenna parameters
L = 0.028232042114348332  # Patch length (m)
W = 0.03890181486458878   # Patch width (m)
h = 0.0022050956105718086  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009120376428091596  # Feed x position
feed_y = 0.0046882171324963955  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0283_488035f5')
