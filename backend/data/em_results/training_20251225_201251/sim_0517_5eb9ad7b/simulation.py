...
# Antenna parameters
L = 0.03218554743294464  # Patch length (m)
W = 0.03711998461159924   # Patch width (m)
h = 0.0015172016170124313  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009857610996313987  # Feed x position
feed_y = 0.014847993844639695  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0517_5eb9ad7b')
