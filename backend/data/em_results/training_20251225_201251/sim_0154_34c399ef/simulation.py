...
# Antenna parameters
L = 0.029777583610912612  # Patch length (m)
W = 0.04104646181924354   # Patch width (m)
h = 0.0030809835310813614  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011704832085067542  # Feed x position
feed_y = 0.016418584727697416  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0154_34c399ef')
