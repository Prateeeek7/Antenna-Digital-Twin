...
# Antenna parameters
L = 0.033220503646118234  # Patch length (m)
W = 0.03154850949890099   # Patch width (m)
h = 0.002823494779120691  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006170383222917976  # Feed x position
feed_y = 0.00899397024519862  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0869_c9bbffa4')
