...
# Antenna parameters
L = 0.03200505740223188  # Patch length (m)
W = 0.03091203776922205   # Patch width (m)
h = 0.0013331338731955495  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005811749284049108  # Feed x position
feed_y = 0.002088074925995424  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0523_ab5ba318')
