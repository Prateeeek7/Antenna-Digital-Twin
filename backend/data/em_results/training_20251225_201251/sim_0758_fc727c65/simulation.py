...
# Antenna parameters
L = 0.02851778441500614  # Patch length (m)
W = 0.030745128440570483   # Patch width (m)
h = 0.0008791441014559888  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006685231396219027  # Feed x position
feed_y = 0.012135681287759444  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0758_fc727c65')
