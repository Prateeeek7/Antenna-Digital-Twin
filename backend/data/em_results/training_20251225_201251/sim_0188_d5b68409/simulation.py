...
# Antenna parameters
L = 0.02543735460188849  # Patch length (m)
W = 0.04384730282195898   # Patch width (m)
h = 0.0023547692190263696  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006583014804828769  # Feed x position
feed_y = 0.0118946801576859  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0188_d5b68409')
