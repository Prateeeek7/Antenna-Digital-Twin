...
# Antenna parameters
L = 0.030437026704738936  # Patch length (m)
W = 0.03923684711145373   # Patch width (m)
h = 0.0028848578006567933  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012904820004291913  # Feed x position
feed_y = 0.014472164689459981  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0730_852e7dda')
