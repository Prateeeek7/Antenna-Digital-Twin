...
# Antenna parameters
L = 0.030908972023038554  # Patch length (m)
W = 0.031687874663339936   # Patch width (m)
h = 0.00258895182570203  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008913443331734938  # Feed x position
feed_y = 0.012675149865335975  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0387_bae0996a')
