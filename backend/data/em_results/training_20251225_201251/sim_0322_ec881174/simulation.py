...
# Antenna parameters
L = 0.027237469652500707  # Patch length (m)
W = 0.04072836313370344   # Patch width (m)
h = 0.0008941475615762501  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006681646586973216  # Feed x position
feed_y = 0.016291345253481377  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0322_ec881174')
