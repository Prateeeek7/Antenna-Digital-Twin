...
# Antenna parameters
L = 0.028303785415934982  # Patch length (m)
W = 0.044858133972200245   # Patch width (m)
h = 0.0024199513732923103  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005940263358334992  # Feed x position
feed_y = 0.0179432535888801  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0574_195d4ae5')
