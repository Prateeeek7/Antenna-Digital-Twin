...
# Antenna parameters
L = 0.03258072539541496  # Patch length (m)
W = 0.030458276890076144   # Patch width (m)
h = 0.00269766191582619  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.002862966634799621  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0118_7136f5bd')
