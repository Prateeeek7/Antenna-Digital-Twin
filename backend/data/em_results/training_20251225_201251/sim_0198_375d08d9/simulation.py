...
# Antenna parameters
L = 0.02545377291255012  # Patch length (m)
W = 0.036873737421228826   # Patch width (m)
h = 0.0025044952750787304  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006768006072469227  # Feed x position
feed_y = 0.009717635007488547  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0198_375d08d9')
