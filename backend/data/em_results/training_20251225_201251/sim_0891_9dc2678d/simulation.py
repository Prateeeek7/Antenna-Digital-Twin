...
# Antenna parameters
L = 0.028556657265882857  # Patch length (m)
W = 0.0388927653326373   # Patch width (m)
h = 0.0015113982479775297  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011422662906353144  # Feed x position
feed_y = 0.009434908383390166  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0891_9dc2678d')
