...
# Antenna parameters
L = 0.030198182704321883  # Patch length (m)
W = 0.03262478858031807   # Patch width (m)
h = 0.0015095972890587076  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007335851055716471  # Feed x position
feed_y = 0.006554019692860648  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0844_261e7b64')
