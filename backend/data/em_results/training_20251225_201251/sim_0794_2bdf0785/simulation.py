...
# Antenna parameters
L = 0.0264004615011005  # Patch length (m)
W = 0.030582825262002043   # Patch width (m)
h = 0.0030763474708307586  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0042610743532803174  # Feed x position
feed_y = 0.0036381885263320956  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0794_2bdf0785')
