...
# Antenna parameters
L = 0.031833081203403335  # Patch length (m)
W = 0.04116661136656949   # Patch width (m)
h = 0.0016735976180862785  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0011613489403236666  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0690_980243c8')
