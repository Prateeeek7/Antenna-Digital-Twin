...
# Antenna parameters
L = 0.029640973468560726  # Patch length (m)
W = 0.0363003064397912   # Patch width (m)
h = 0.0015276751378873435  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01185638938742429  # Feed x position
feed_y = 0.014520122575916481  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0059_1f216de1')
