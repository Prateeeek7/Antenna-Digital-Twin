...
# Antenna parameters
L = 0.027678367933152825  # Patch length (m)
W = 0.04307155025637453   # Patch width (m)
h = 0.0016463165761496082  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0025654226842340864  # Feed x position
feed_y = 0.017228620102549812  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0504_37770174')
