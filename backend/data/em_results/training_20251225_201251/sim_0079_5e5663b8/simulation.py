...
# Antenna parameters
L = 0.031535456820381585  # Patch length (m)
W = 0.03618261900733205   # Patch width (m)
h = 0.0015816911383391744  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018375939623755094  # Feed x position
feed_y = 0.008422548186937738  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0079_5e5663b8')
