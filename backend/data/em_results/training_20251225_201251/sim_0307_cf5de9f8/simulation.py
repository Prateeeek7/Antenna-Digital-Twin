...
# Antenna parameters
L = 0.03158518876898237  # Patch length (m)
W = 0.033003266832070985   # Patch width (m)
h = 0.0011918048236905143  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005846180397843936  # Feed x position
feed_y = 0.00495959495561593  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0307_cf5de9f8')
