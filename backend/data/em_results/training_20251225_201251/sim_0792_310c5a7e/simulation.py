...
# Antenna parameters
L = 0.03205684463254097  # Patch length (m)
W = 0.038323054078396424   # Patch width (m)
h = 0.000951932484053003  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01532922163135857  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0792_310c5a7e')
