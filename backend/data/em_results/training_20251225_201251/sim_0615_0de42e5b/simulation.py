...
# Antenna parameters
L = 0.026300931927463946  # Patch length (m)
W = 0.031704937654404235   # Patch width (m)
h = 0.0014585336991718  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010170454549555135  # Feed x position
feed_y = 0.003625978001761943  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0615_0de42e5b')
