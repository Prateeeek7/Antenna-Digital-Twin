...
# Antenna parameters
L = 0.02740377149034144  # Patch length (m)
W = 0.037697258072720334   # Patch width (m)
h = 0.0028416057901284454  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010961508596136578  # Feed x position
feed_y = 0.006064263261428112  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0925_9fbb16a5')
