...
# Antenna parameters
L = 0.0272060816229009  # Patch length (m)
W = 0.03244199724854123   # Patch width (m)
h = 0.0009279679161550211  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008186564045289588  # Feed x position
feed_y = 0.003882093533096532  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0416_466cfe95')
