...
# Antenna parameters
L = 0.029667993333745875  # Patch length (m)
W = 0.03814498610839903   # Patch width (m)
h = 0.0030740629573956044  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00952284794558008  # Feed x position
feed_y = 0.013860496807738756  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0928_aacf1b50')
