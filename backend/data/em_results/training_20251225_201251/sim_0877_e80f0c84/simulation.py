...
# Antenna parameters
L = 0.028010847227944734  # Patch length (m)
W = 0.03776545127072778   # Patch width (m)
h = 0.0028708298153069718  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011204338891177895  # Feed x position
feed_y = 0.005974834304157436  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0877_e80f0c84')
