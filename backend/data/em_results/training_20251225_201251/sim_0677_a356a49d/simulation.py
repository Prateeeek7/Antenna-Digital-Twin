...
# Antenna parameters
L = 0.029493147525678946  # Patch length (m)
W = 0.044601765329002056   # Patch width (m)
h = 0.001618533128801954  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004240535485836325  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0677_a356a49d')
