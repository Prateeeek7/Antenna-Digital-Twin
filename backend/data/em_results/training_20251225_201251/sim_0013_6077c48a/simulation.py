...
# Antenna parameters
L = 0.030724464205993424  # Patch length (m)
W = 0.037011611892588815   # Patch width (m)
h = 0.00239527051976465  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01228978568239737  # Feed x position
feed_y = 0.0017869813695320512  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0013_6077c48a')
