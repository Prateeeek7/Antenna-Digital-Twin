...
# Antenna parameters
L = 0.026767854153271806  # Patch length (m)
W = 0.04215887207034413   # Patch width (m)
h = 0.003056351832624157  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0031688596881435413  # Feed x position
feed_y = 0.0042146582181203035  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0014_72a26506')
