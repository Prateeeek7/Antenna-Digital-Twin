...
# Antenna parameters
L = 0.027055316794653058  # Patch length (m)
W = 0.03910556700017198   # Patch width (m)
h = 0.002166918616487358  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008898752282658065  # Feed x position
feed_y = 0.0014622174485195499  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0366_49b5a5d7')
