...
# Antenna parameters
L = 0.033591397181137815  # Patch length (m)
W = 0.03913019404194604   # Patch width (m)
h = 0.0024791341791523566  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0057647116498308745  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0248_920e6aba')
