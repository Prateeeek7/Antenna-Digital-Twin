...
# Antenna parameters
L = 0.02660361269087103  # Patch length (m)
W = 0.04023557285054692   # Patch width (m)
h = 0.0021069894682088103  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01609422914021877  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0657_17497317')
