...
# Antenna parameters
L = 0.03198477368224487  # Patch length (m)
W = 0.0384935411491499   # Patch width (m)
h = 0.002948481812680371  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011778518397298652  # Feed x position
feed_y = 0.0054930361469214305  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0071_7179cabc')
