...
# Antenna parameters
L = 0.0303553067306581  # Patch length (m)
W = 0.0425227399053928   # Patch width (m)
h = 0.0016371657760346462  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01214212269226324  # Feed x position
feed_y = 0.008928826079333756  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0110_980e29bb')
