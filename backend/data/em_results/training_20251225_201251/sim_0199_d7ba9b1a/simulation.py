...
# Antenna parameters
L = 0.026845620103970798  # Patch length (m)
W = 0.039425414795261036   # Patch width (m)
h = 0.0019135944589457918  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01073824804158832  # Feed x position
feed_y = 0.015770165918104415  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0199_d7ba9b1a')
