...
# Antenna parameters
L = 0.028271416573279078  # Patch length (m)
W = 0.044084199735264826   # Patch width (m)
h = 0.0027929714823475603  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0064178402708233  # Feed x position
feed_y = 0.01763367989410593  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0988_6ba1c8bc')
