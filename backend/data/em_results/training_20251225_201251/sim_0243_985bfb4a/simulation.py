...
# Antenna parameters
L = 0.03352478081529231  # Patch length (m)
W = 0.034720278755721534   # Patch width (m)
h = 0.0014706461716710868  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0020839564895498786  # Feed x position
feed_y = 0.0030542373861919556  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0243_985bfb4a')
