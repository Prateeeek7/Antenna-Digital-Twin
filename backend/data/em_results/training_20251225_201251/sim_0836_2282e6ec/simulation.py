...
# Antenna parameters
L = 0.03178274249765281  # Patch length (m)
W = 0.040588089208174125   # Patch width (m)
h = 0.0017751213830952267  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012713096999061126  # Feed x position
feed_y = 0.0012801727272098425  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0836_2282e6ec')
