...
# Antenna parameters
L = 0.03133998339292325  # Patch length (m)
W = 0.040318318944435015   # Patch width (m)
h = 0.002168329365047022  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01197185433401736  # Feed x position
feed_y = 0.016127327577774006  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0148_87866433')
