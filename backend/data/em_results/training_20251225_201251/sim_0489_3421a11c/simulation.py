...
# Antenna parameters
L = 0.03202428430215493  # Patch length (m)
W = 0.034304263889284134   # Patch width (m)
h = 0.002159829736504807  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002360462307556283  # Feed x position
feed_y = 0.009698069401396964  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0489_3421a11c')
