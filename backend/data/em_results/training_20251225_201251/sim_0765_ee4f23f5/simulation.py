...
# Antenna parameters
L = 0.03424455017060422  # Patch length (m)
W = 0.03391093888424004   # Patch width (m)
h = 0.0015696131791067519  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010103244858643935  # Feed x position
feed_y = 0.011841286785073995  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0765_ee4f23f5')
