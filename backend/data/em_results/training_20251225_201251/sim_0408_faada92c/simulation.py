...
# Antenna parameters
L = 0.029507151924113503  # Patch length (m)
W = 0.04345818666622705   # Patch width (m)
h = 0.002029682347878161  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011802860769645401  # Feed x position
feed_y = 0.003107673094862208  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0408_faada92c')
