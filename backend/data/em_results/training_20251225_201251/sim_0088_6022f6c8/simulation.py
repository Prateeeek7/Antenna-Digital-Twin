...
# Antenna parameters
L = 0.030801488689002385  # Patch length (m)
W = 0.032457671805113386   # Patch width (m)
h = 0.0014630369093793557  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010869952524569087  # Feed x position
feed_y = 0.0024786177937468562  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0088_6022f6c8')
