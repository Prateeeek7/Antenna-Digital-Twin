...
# Antenna parameters
L = 0.02589780109957265  # Patch length (m)
W = 0.03288293562201185   # Patch width (m)
h = 0.0028917499127437485  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013153174248804739  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0771_9edfc29e')
