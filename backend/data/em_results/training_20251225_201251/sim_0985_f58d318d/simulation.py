...
# Antenna parameters
L = 0.0324765864667781  # Patch length (m)
W = 0.034871758319173767   # Patch width (m)
h = 0.0030236360953994155  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003512072209209605  # Feed x position
feed_y = 0.0031857671586925126  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0985_f58d318d')
