...
# Antenna parameters
L = 0.02607295161676957  # Patch length (m)
W = 0.03984775592415792   # Patch width (m)
h = 0.0021981046307410356  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034365930823527166  # Feed x position
feed_y = 0.009635952478709804  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0284_b82f5bfb')
