...
# Antenna parameters
L = 0.03148378188615547  # Patch length (m)
W = 0.03628083733320849   # Patch width (m)
h = 0.003098117803358811  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00951069146544527  # Feed x position
feed_y = 0.014512334933283397  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0724_759a6904')
