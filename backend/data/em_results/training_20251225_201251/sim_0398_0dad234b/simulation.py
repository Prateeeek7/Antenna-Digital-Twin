...
# Antenna parameters
L = 0.027559115977092995  # Patch length (m)
W = 0.044404887072113326   # Patch width (m)
h = 0.0028295846337254025  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007081711088705663  # Feed x position
feed_y = 0.012200790998687733  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0398_0dad234b')
