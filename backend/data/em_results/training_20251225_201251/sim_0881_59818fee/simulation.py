...
# Antenna parameters
L = 0.03253404455621284  # Patch length (m)
W = 0.039961211668509466   # Patch width (m)
h = 0.0023758985456668914  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012007095439700284  # Feed x position
feed_y = 0.008768220545049794  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0881_59818fee')
