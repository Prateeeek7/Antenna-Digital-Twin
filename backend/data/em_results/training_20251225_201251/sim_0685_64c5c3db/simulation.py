...
# Antenna parameters
L = 0.02713471337581437  # Patch length (m)
W = 0.043018704604882475   # Patch width (m)
h = 0.0029242916668270496  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00755804486300332  # Feed x position
feed_y = 0.0068868297226633455  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0685_64c5c3db')
