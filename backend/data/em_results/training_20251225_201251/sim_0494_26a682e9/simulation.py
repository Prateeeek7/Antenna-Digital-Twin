...
# Antenna parameters
L = 0.02551553749978839  # Patch length (m)
W = 0.036047038374692766   # Patch width (m)
h = 0.0014774640312056788  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0017666989592379822  # Feed x position
feed_y = 0.0011648919036985653  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0494_26a682e9')
