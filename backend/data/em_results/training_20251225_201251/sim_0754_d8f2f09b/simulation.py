...
# Antenna parameters
L = 0.03473060127910772  # Patch length (m)
W = 0.04087558109224877   # Patch width (m)
h = 0.0008079663589384031  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00578580879416658  # Feed x position
feed_y = 0.015536963187376516  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0754_d8f2f09b')
