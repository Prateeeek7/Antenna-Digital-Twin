...
# Antenna parameters
L = 0.0257514761768207  # Patch length (m)
W = 0.04086368592727593   # Patch width (m)
h = 0.0010596324587402288  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001486812200692765  # Feed x position
feed_y = 0.008581441935420387  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0251_af26f4ab')
