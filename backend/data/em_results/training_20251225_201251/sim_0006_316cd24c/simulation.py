...
# Antenna parameters
L = 0.031042552378440925  # Patch length (m)
W = 0.03415548735401348   # Patch width (m)
h = 0.0016248180191404684  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011992196486853074  # Feed x position
feed_y = 0.007779432162928057  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0006_316cd24c')
