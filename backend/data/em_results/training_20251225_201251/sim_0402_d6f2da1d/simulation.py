...
# Antenna parameters
L = 0.026049526274932705  # Patch length (m)
W = 0.031900701093526294   # Patch width (m)
h = 0.0014836645097828724  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009033440688355602  # Feed x position
feed_y = 0.006453282883525391  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0402_d6f2da1d')
