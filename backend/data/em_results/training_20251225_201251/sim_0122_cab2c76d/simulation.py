...
# Antenna parameters
L = 0.030254468961975887  # Patch length (m)
W = 0.04143518846385776   # Patch width (m)
h = 0.0010136724437199067  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012101787584790356  # Feed x position
feed_y = 0.01246602033178499  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0122_cab2c76d')
