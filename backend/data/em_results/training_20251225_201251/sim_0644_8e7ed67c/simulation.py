...
# Antenna parameters
L = 0.029717257544647824  # Patch length (m)
W = 0.041117821947702186   # Patch width (m)
h = 0.0009445761766457742  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004922729802999802  # Feed x position
feed_y = 0.012702549188805928  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0644_8e7ed67c')
