...
# Antenna parameters
L = 0.03492933601720957  # Patch length (m)
W = 0.03285206178299387   # Patch width (m)
h = 0.0009899947275245334  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010774147050335359  # Feed x position
feed_y = 0.006290779606334387  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0469_8e345a46')
