...
# Antenna parameters
L = 0.02700609741371053  # Patch length (m)
W = 0.037808582792859556   # Patch width (m)
h = 0.0014065284177958528  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.015123433117143823  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0763_6e79efb0')
