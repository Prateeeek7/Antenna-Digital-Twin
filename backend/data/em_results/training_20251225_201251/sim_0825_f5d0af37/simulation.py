...
# Antenna parameters
L = 0.03332847434395317  # Patch length (m)
W = 0.030757218441251753   # Patch width (m)
h = 0.0026708497438824893  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.009351599737706736  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0825_f5d0af37')
