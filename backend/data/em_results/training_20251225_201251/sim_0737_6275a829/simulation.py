...
# Antenna parameters
L = 0.03162905444649337  # Patch length (m)
W = 0.03642977980477993   # Patch width (m)
h = 0.0031905145138218793  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00671144599134598  # Feed x position
feed_y = 0.014571911921911974  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0737_6275a829')
