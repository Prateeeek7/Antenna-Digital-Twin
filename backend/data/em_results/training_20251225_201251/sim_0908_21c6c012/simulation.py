...
# Antenna parameters
L = 0.030889513325451593  # Patch length (m)
W = 0.03968955552171036   # Patch width (m)
h = 0.0013376248196079877  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012355805330180637  # Feed x position
feed_y = 0.01449947734727056  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0908_21c6c012')
