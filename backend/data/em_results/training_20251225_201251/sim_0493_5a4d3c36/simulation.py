...
# Antenna parameters
L = 0.034092659834402114  # Patch length (m)
W = 0.03153258838721237   # Patch width (m)
h = 0.0017465757049457842  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013637063933760846  # Feed x position
feed_y = 0.00970669889095631  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0493_5a4d3c36')
