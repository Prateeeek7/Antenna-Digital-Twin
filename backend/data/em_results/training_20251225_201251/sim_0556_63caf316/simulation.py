...
# Antenna parameters
L = 0.02563883052766911  # Patch length (m)
W = 0.03926845015713437   # Patch width (m)
h = 0.002970469303903677  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010255532211067645  # Feed x position
feed_y = 0.011128352189862314  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0556_63caf316')
