...
# Antenna parameters
L = 0.03422200129589237  # Patch length (m)
W = 0.036340283239623836   # Patch width (m)
h = 0.002530790282330372  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01279057322663001  # Feed x position
feed_y = 0.008301649587165267  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0101_c13b8dbb')
