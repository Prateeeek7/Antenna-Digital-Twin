...
# Antenna parameters
L = 0.027996734531573284  # Patch length (m)
W = 0.04258203285229111   # Patch width (m)
h = 0.0010933324365858944  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.010235726825012482  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0209_07013237')
