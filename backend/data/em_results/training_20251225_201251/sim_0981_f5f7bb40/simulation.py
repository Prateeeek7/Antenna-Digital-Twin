...
# Antenna parameters
L = 0.025994278366968528  # Patch length (m)
W = 0.0388668084803107   # Patch width (m)
h = 0.0010589079433103023  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010180886711610257  # Feed x position
feed_y = 0.012569201085409565  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0981_f5f7bb40')
