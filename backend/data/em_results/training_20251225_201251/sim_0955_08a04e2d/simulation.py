...
# Antenna parameters
L = 0.03394925001510701  # Patch length (m)
W = 0.04223354085146279   # Patch width (m)
h = 0.0018414033922779555  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003543017309212601  # Feed x position
feed_y = 0.016893416340585117  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0955_08a04e2d')
