...
# Antenna parameters
L = 0.026820049905826763  # Patch length (m)
W = 0.043903818850651755   # Patch width (m)
h = 0.002488676759665613  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008727502969752233  # Feed x position
feed_y = 0.002626499414288689  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0462_42a3db99')
