...
# Antenna parameters
L = 0.029037719205920437  # Patch length (m)
W = 0.03767716831653205   # Patch width (m)
h = 0.002086967812895042  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0027302491574508394  # Feed x position
feed_y = 0.0038027532120989554  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0653_16b62f04')
