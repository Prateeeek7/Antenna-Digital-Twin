...
# Antenna parameters
L = 0.02963439347159271  # Patch length (m)
W = 0.03945172255685049   # Patch width (m)
h = 0.0012879861450266798  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.008872894235341676  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0725_9b2e40aa')
