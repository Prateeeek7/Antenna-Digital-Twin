...
# Antenna parameters
L = 0.026599249826926488  # Patch length (m)
W = 0.03523905328849434   # Patch width (m)
h = 0.0020507624517857007  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008505476288421507  # Feed x position
feed_y = 0.013787106392726747  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0393_b447c80f')
