...
# Antenna parameters
L = 0.03050487710957295  # Patch length (m)
W = 0.03745788828935385   # Patch width (m)
h = 0.0011855473243050734  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003364530214244716  # Feed x position
feed_y = 0.010822184414564857  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0544_268c79b3')
