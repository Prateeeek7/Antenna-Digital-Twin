...
# Antenna parameters
L = 0.03466987534340162  # Patch length (m)
W = 0.040358489465763654   # Patch width (m)
h = 0.001379101565815808  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006504045230780021  # Feed x position
feed_y = 0.004851003515647294  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0664_31dea88a')
