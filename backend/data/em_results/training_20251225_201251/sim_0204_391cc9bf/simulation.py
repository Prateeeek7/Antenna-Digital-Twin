...
# Antenna parameters
L = 0.03305107512310313  # Patch length (m)
W = 0.03147375572071616   # Patch width (m)
h = 0.0013208196614804058  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00471752184369947  # Feed x position
feed_y = 0.012589502288286465  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0204_391cc9bf')
