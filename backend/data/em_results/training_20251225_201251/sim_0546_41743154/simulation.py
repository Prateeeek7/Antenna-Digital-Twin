...
# Antenna parameters
L = 0.030969972927263244  # Patch length (m)
W = 0.03191551861394066   # Patch width (m)
h = 0.001849867898515874  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008883208791230135  # Feed x position
feed_y = 0.012766207445576265  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0546_41743154')
