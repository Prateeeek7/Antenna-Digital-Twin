...
# Antenna parameters
L = 0.02751150342797554  # Patch length (m)
W = 0.038110604434883504   # Patch width (m)
h = 0.002568911791403232  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011004601371190217  # Feed x position
feed_y = 0.003986367736256776  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0811_1e628fef')
