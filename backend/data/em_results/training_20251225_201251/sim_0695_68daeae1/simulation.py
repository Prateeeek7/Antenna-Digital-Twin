...
# Antenna parameters
L = 0.025425676645772326  # Patch length (m)
W = 0.03660259927620597   # Patch width (m)
h = 0.0022906182775524844  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008238782304520985  # Feed x position
feed_y = 0.007969039288265372  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0695_68daeae1')
