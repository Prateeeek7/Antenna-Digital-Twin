...
# Antenna parameters
L = 0.03365718616107978  # Patch length (m)
W = 0.0355305960936335   # Patch width (m)
h = 0.0026728114003646557  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013462874464431913  # Feed x position
feed_y = 0.014212238437453402  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0015_3edb5d89')
