...
# Antenna parameters
L = 0.029102314830074014  # Patch length (m)
W = 0.04100058371856313   # Patch width (m)
h = 0.0022339079724816007  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002822472227720765  # Feed x position
feed_y = 0.016400233487425253  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0764_39c23544')
