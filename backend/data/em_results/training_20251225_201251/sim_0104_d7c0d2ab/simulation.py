...
# Antenna parameters
L = 0.03127143451976426  # Patch length (m)
W = 0.03198941607640213   # Patch width (m)
h = 0.0015076313290422545  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012508573807905704  # Feed x position
feed_y = 0.012795766430560851  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0104_d7c0d2ab')
