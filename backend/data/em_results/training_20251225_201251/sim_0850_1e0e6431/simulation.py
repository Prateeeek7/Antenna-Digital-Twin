...
# Antenna parameters
L = 0.03498659741788108  # Patch length (m)
W = 0.040032752507509616   # Patch width (m)
h = 0.0022107517885862926  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006323289452355725  # Feed x position
feed_y = 0.005067222080583374  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0850_1e0e6431')
