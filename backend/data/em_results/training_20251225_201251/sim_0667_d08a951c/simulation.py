...
# Antenna parameters
L = 0.02578648650316711  # Patch length (m)
W = 0.03576712998735834   # Patch width (m)
h = 0.002722680495483114  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010314594601266845  # Feed x position
feed_y = 0.014306851994943338  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0667_d08a951c')
