...
# Antenna parameters
L = 0.030332825224140297  # Patch length (m)
W = 0.04305128101133442   # Patch width (m)
h = 0.001086289072900563  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01722051240453377  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0776_8b752395')
