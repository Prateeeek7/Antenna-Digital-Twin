...
# Antenna parameters
L = 0.025544952085170967  # Patch length (m)
W = 0.034396356716341926   # Patch width (m)
h = 0.0012113909025427113  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003910290036962263  # Feed x position
feed_y = 0.009023186096790021  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0115_d0bc269c')
