...
# Antenna parameters
L = 0.03221519091887819  # Patch length (m)
W = 0.030296686817477256   # Patch width (m)
h = 0.002536384702233232  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012886076367551276  # Feed x position
feed_y = 0.005441400145771832  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0979_e9ecb96a')
