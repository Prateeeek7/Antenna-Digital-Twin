...
# Antenna parameters
L = 0.033292192709689784  # Patch length (m)
W = 0.03329311626336692   # Patch width (m)
h = 0.0024858350211297135  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0073552475145404915  # Feed x position
feed_y = 0.006523544256092975  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0011_dda54e69')
