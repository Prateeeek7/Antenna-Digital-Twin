...
# Antenna parameters
L = 0.0345569820666004  # Patch length (m)
W = 0.041921172202315594   # Patch width (m)
h = 0.0018206932092843342  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0041182169136698196  # Feed x position
feed_y = 0.016214034152460838  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0622_589e6faa')
