...
# Antenna parameters
L = 0.032934035549006396  # Patch length (m)
W = 0.031383115937442446   # Patch width (m)
h = 0.0030541926241433107  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010886468270061844  # Feed x position
feed_y = 0.001  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0480_2aa100f2')
