...
# Antenna parameters
L = 0.026270069011372826  # Patch length (m)
W = 0.03240869755718213   # Patch width (m)
h = 0.002091646602359097  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007542864759936182  # Feed x position
feed_y = 0.005761409699061803  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0530_0fa86f0a')
