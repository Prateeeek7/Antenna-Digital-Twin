...
# Antenna parameters
L = 0.0269947621763063  # Patch length (m)
W = 0.03830579654836804   # Patch width (m)
h = 0.0011987359844046498  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.007361631815379145  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0832_118e9575')
