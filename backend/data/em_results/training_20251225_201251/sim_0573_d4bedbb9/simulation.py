...
# Antenna parameters
L = 0.02946876143118871  # Patch length (m)
W = 0.034343843377896664   # Patch width (m)
h = 0.0015402633590690879  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011184415890971565  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0573_d4bedbb9')
