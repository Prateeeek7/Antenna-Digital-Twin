...
# Antenna parameters
L = 0.02996687430050972  # Patch length (m)
W = 0.04388923559276137   # Patch width (m)
h = 0.0015221321591162018  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003859965587584144  # Feed x position
feed_y = 0.012243768456661228  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0146_346937ee')
