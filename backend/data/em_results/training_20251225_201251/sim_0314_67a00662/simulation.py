...
# Antenna parameters
L = 0.030775926376121372  # Patch length (m)
W = 0.031641477489730625   # Patch width (m)
h = 0.0026994748095120697  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0022799327443429798  # Feed x position
feed_y = 0.0073549244807188845  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0314_67a00662')
