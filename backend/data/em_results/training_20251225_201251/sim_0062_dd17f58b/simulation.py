...
# Antenna parameters
L = 0.034585221227259766  # Patch length (m)
W = 0.030893746659471075   # Patch width (m)
h = 0.003005041832142731  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008432438740823153  # Feed x position
feed_y = 0.008675483193549934  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0062_dd17f58b')
