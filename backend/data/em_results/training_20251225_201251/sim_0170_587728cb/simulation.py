...
# Antenna parameters
L = 0.034918215582381784  # Patch length (m)
W = 0.0414270068701065   # Patch width (m)
h = 0.0028187384411346617  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013637089412212923  # Feed x position
feed_y = 0.006810348314078049  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0170_587728cb')
