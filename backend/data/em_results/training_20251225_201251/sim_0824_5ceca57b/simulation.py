...
# Antenna parameters
L = 0.030640489551458275  # Patch length (m)
W = 0.031953026822370424   # Patch width (m)
h = 0.0015298711063512068  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0065818031742915575  # Feed x position
feed_y = 0.008882997290385296  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0824_5ceca57b')
