...
# Antenna parameters
L = 0.027432829805272372  # Patch length (m)
W = 0.04166624743420792   # Patch width (m)
h = 0.002657896652598198  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010973131922108949  # Feed x position
feed_y = 0.01587066800545302  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0749_124f3160')
