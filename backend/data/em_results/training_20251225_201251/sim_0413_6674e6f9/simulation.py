...
# Antenna parameters
L = 0.0255706989448075  # Patch length (m)
W = 0.03353246380509554   # Patch width (m)
h = 0.0029072692756356745  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006261511937399845  # Feed x position
feed_y = 0.006161514017643376  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0413_6674e6f9')
