...
# Antenna parameters
L = 0.02537260925370984  # Patch length (m)
W = 0.030938021812926545   # Patch width (m)
h = 0.0030266720157456147  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009758146732871606  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0565_32eb61b0')
