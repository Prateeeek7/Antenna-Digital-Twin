...
# Antenna parameters
L = 0.030208922590540442  # Patch length (m)
W = 0.03781625982232294   # Patch width (m)
h = 0.0024410474864218525  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012083569036216178  # Feed x position
feed_y = 0.01263904768799424  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0032_9114f8dd')
