...
# Antenna parameters
L = 0.02790695044486251  # Patch length (m)
W = 0.03142229532831007   # Patch width (m)
h = 0.0022361273745494814  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0011409974855913542  # Feed x position
feed_y = 0.001624655103095655  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0884_04bf9ddf')
