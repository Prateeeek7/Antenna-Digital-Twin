...
# Antenna parameters
L = 0.03280234260892485  # Patch length (m)
W = 0.04089311965135755   # Patch width (m)
h = 0.002759835922938794  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012674418792066246  # Feed x position
feed_y = 0.01016367536106708  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0716_3b620628')
