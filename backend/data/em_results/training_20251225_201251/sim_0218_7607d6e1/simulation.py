...
# Antenna parameters
L = 0.026977597737238512  # Patch length (m)
W = 0.03275032771208461   # Patch width (m)
h = 0.0012793056316733546  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008143756990860918  # Feed x position
feed_y = 0.008276237697643272  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0218_7607d6e1')
