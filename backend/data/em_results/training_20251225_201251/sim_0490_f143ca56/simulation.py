...
# Antenna parameters
L = 0.03157342666038232  # Patch length (m)
W = 0.03148919675956496   # Patch width (m)
h = 0.0012760602867119821  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00513399320348704  # Feed x position
feed_y = 0.005327582245469653  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0490_f143ca56')
