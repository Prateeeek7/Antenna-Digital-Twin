...
# Antenna parameters
L = 0.027628562813385448  # Patch length (m)
W = 0.04458460356859605   # Patch width (m)
h = 0.0023139849345525394  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006085090216216275  # Feed x position
feed_y = 0.01783384142743842  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0161_694f1dd8')
