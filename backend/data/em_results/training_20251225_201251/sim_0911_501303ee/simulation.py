...
# Antenna parameters
L = 0.03481253895767929  # Patch length (m)
W = 0.03817845374748974   # Patch width (m)
h = 0.0031310621426268383  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0019142634772924064  # Feed x position
feed_y = 0.0010173844631904806  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0911_501303ee')
