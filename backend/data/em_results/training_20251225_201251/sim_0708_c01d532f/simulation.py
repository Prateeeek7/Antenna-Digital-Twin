...
# Antenna parameters
L = 0.03111111204505819  # Patch length (m)
W = 0.030351838528627766   # Patch width (m)
h = 0.0022954738671316544  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010838718692865913  # Feed x position
feed_y = 0.010754718335610144  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0708_c01d532f')
