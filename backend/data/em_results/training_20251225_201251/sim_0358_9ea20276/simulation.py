...
# Antenna parameters
L = 0.03459234975594822  # Patch length (m)
W = 0.04009038501800431   # Patch width (m)
h = 0.0029786801063259585  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005470972076322476  # Feed x position
feed_y = 0.016036154007201726  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0358_9ea20276')
