...
# Antenna parameters
L = 0.02625562848081128  # Patch length (m)
W = 0.031862509827059134   # Patch width (m)
h = 0.0012567193637551947  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006021566045103226  # Feed x position
feed_y = 0.0012771727049455846  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0008_5aa6418b')
