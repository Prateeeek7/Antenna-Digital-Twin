...
# Antenna parameters
L = 0.025850730696374405  # Patch length (m)
W = 0.03260887827698659   # Patch width (m)
h = 0.002002135591891745  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018135327157916617  # Feed x position
feed_y = 0.004049240666058564  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0679_5e24ff89')
