...
# Antenna parameters
L = 0.02825341153851527  # Patch length (m)
W = 0.03479799034171156   # Patch width (m)
h = 0.0016507731848899984  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037569354964743255  # Feed x position
feed_y = 0.013374616070016195  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0682_50629fb5')
