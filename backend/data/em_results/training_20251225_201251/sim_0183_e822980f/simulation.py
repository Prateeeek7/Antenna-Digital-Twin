...
# Antenna parameters
L = 0.02505047000867232  # Patch length (m)
W = 0.03220392266789245   # Patch width (m)
h = 0.0023476692955137733  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005908097407251602  # Feed x position
feed_y = 0.0059649249085854976  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0183_e822980f')
