...
# Antenna parameters
L = 0.029304102100161444  # Patch length (m)
W = 0.04266473999844658   # Patch width (m)
h = 0.0012977884487645262  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013403186045579555  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0585_f34ecf1a')
