...
# Antenna parameters
L = 0.029831840987845373  # Patch length (m)
W = 0.03737898709028373   # Patch width (m)
h = 0.0023251706168693443  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006663559842471041  # Feed x position
feed_y = 0.0035573035448641798  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0439_04ce3365')
