...
# Antenna parameters
L = 0.03407290095302719  # Patch length (m)
W = 0.03694529692822652   # Patch width (m)
h = 0.002749732295345655  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005007787948177693  # Feed x position
feed_y = 0.014778118771290608  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0089_59fae4f3')
