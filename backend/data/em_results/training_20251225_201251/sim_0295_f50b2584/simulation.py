...
# Antenna parameters
L = 0.02831491807085222  # Patch length (m)
W = 0.04055344998765992   # Patch width (m)
h = 0.0024488124442572094  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011325967228340889  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0295_f50b2584')
