...
# Antenna parameters
L = 0.029382582835894806  # Patch length (m)
W = 0.0414940329603502   # Patch width (m)
h = 0.0023557208956879374  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011753033134357924  # Feed x position
feed_y = 0.006927333053241001  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0172_8943f8c8')
