...
# Antenna parameters
L = 0.03419810528640916  # Patch length (m)
W = 0.035548051177419965   # Patch width (m)
h = 0.001295658308177058  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0031423457514449865  # Feed x position
feed_y = 0.003471803724305994  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0007_6e4f1b46')
