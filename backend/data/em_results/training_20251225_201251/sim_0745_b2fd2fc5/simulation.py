...
# Antenna parameters
L = 0.030052006454249432  # Patch length (m)
W = 0.03228057170847947   # Patch width (m)
h = 0.0020258025903217825  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010432409497806102  # Feed x position
feed_y = 0.008671256892520301  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0745_b2fd2fc5')
