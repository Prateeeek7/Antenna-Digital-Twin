...
# Antenna parameters
L = 0.029315372006344067  # Patch length (m)
W = 0.031119223657558495   # Patch width (m)
h = 0.0023056650481490313  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008307002228159253  # Feed x position
feed_y = 0.006112752706489875  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0061_0c2844a9')
