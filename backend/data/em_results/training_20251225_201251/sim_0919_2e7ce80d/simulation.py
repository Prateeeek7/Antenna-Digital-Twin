...
# Antenna parameters
L = 0.03144021957259595  # Patch length (m)
W = 0.03575348084458894   # Patch width (m)
h = 0.002851563642912983  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.002388379426334898  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0919_2e7ce80d')
