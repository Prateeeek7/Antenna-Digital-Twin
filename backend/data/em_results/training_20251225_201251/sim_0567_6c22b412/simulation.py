...
# Antenna parameters
L = 0.030523568324564602  # Patch length (m)
W = 0.04109025258866155   # Patch width (m)
h = 0.0028993508718094824  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009395586066947688  # Feed x position
feed_y = 0.015058639436323273  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0567_6c22b412')
