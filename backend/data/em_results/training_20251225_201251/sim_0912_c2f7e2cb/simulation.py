...
# Antenna parameters
L = 0.03338009854385945  # Patch length (m)
W = 0.030851360619472114   # Patch width (m)
h = 0.0021793418274266593  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0036582330416280173  # Feed x position
feed_y = 0.0018948844482600368  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0912_c2f7e2cb')
