...
# Antenna parameters
L = 0.03199195998839737  # Patch length (m)
W = 0.03455847847423718   # Patch width (m)
h = 0.0009408590036275929  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001334619527336409  # Feed x position
feed_y = 0.013823391389694873  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0651_79770275')
