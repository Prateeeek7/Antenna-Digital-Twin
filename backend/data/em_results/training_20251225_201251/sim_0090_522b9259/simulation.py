...
# Antenna parameters
L = 0.0286995764944842  # Patch length (m)
W = 0.0336017378143295   # Patch width (m)
h = 0.0025022970121157586  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008119495800003165  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0090_522b9259')
