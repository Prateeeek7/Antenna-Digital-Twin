...
# Antenna parameters
L = 0.025263174402065675  # Patch length (m)
W = 0.0334853591202798   # Patch width (m)
h = 0.001429633692682061  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00250600421957038  # Feed x position
feed_y = 0.004588178944298133  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0768_ca6a1c46')
