...
# Antenna parameters
L = 0.033261836429274244  # Patch length (m)
W = 0.04090924414550339   # Patch width (m)
h = 0.0020701800810956875  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013304734571709699  # Feed x position
feed_y = 0.0031939032759739725  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0699_2d11b47b')
