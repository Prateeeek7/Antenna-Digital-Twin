...
# Antenna parameters
L = 0.026984946023454408  # Patch length (m)
W = 0.03622670672529916   # Patch width (m)
h = 0.0020065485453978457  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003146779436782047  # Feed x position
feed_y = 0.014490682690119664  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0972_7419463d')
