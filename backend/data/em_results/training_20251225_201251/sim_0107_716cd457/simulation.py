...
# Antenna parameters
L = 0.03368790942341398  # Patch length (m)
W = 0.03377212367545549   # Patch width (m)
h = 0.0009676069968697802  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006835851085184165  # Feed x position
feed_y = 0.007196226518744359  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0107_716cd457')
