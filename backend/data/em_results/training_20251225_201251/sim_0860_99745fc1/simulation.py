...
# Antenna parameters
L = 0.03496528214279837  # Patch length (m)
W = 0.03489429208972404   # Patch width (m)
h = 0.001464806454217888  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010168772972110206  # Feed x position
feed_y = 0.00898506708813845  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0860_99745fc1')
