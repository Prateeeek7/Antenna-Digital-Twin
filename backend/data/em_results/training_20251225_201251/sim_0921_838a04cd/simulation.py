...
# Antenna parameters
L = 0.028996781708303037  # Patch length (m)
W = 0.044972142621068266   # Patch width (m)
h = 0.0008066772839954712  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034490746750550326  # Feed x position
feed_y = 0.011266123094291394  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0921_838a04cd')
