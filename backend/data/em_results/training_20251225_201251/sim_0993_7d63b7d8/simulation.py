...
# Antenna parameters
L = 0.03156990761078582  # Patch length (m)
W = 0.04335944325613203   # Patch width (m)
h = 0.000984036198668916  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012627963044314329  # Feed x position
feed_y = 0.00939553102421086  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0993_7d63b7d8')
