...
# Antenna parameters
L = 0.032717467445256  # Patch length (m)
W = 0.044727595319625266   # Patch width (m)
h = 0.0028115553604212925  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006533936261055117  # Feed x position
feed_y = 0.017891038127850107  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0185_d17a3bce')
