...
# Antenna parameters
L = 0.03136638463921361  # Patch length (m)
W = 0.0432178026098127   # Patch width (m)
h = 0.002690435842117212  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011326413827701975  # Feed x position
feed_y = 0.01728712104392508  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0157_6a89f433')
