...
# Antenna parameters
L = 0.029050551948280563  # Patch length (m)
W = 0.037088321018010004   # Patch width (m)
h = 0.0022263791732703773  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007657128213281755  # Feed x position
feed_y = 0.005470694243000686  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0553_348a36e1')
