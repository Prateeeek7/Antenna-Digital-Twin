...
# Antenna parameters
L = 0.02691560649938144  # Patch length (m)
W = 0.039088318152547916   # Patch width (m)
h = 0.003016356069737972  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010616861901382443  # Feed x position
feed_y = 0.0033192968486372583  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0646_821bf346')
