...
# Antenna parameters
L = 0.028523174118777833  # Patch length (m)
W = 0.03871388894170892   # Patch width (m)
h = 0.002939727586778206  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007367407019558052  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0361_0c0b2786')
