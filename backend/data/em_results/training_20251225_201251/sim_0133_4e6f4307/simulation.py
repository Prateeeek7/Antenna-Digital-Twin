...
# Antenna parameters
L = 0.025762823608523586  # Patch length (m)
W = 0.03271788852591036   # Patch width (m)
h = 0.0030320030159118397  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0031650097421488826  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0133_4e6f4307')
