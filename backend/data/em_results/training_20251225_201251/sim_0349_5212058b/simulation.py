...
# Antenna parameters
L = 0.0276036443964599  # Patch length (m)
W = 0.03796884007915957   # Patch width (m)
h = 0.001768324128995131  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002063701815393239  # Feed x position
feed_y = 0.012976809198185751  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0349_5212058b')
