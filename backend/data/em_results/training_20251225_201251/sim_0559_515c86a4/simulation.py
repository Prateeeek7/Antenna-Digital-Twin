...
# Antenna parameters
L = 0.0294242033528069  # Patch length (m)
W = 0.04313059850903509   # Patch width (m)
h = 0.0031871521050813516  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01176968134112276  # Feed x position
feed_y = 0.008350722303770203  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0559_515c86a4')
