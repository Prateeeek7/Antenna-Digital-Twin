...
# Antenna parameters
L = 0.027243675537653094  # Patch length (m)
W = 0.04345260760392358   # Patch width (m)
h = 0.0027279840120622355  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010362532327088544  # Feed x position
feed_y = 0.017244757501440285  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0623_8d985a15')
