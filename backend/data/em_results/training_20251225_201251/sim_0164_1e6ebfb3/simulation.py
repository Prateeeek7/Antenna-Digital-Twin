...
# Antenna parameters
L = 0.03364949480303628  # Patch length (m)
W = 0.03420608148586664   # Patch width (m)
h = 0.0028968925875363133  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001267515546034987  # Feed x position
feed_y = 0.0024314324909088443  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0164_1e6ebfb3')
