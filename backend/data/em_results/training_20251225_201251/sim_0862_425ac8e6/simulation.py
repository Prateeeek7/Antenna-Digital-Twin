...
# Antenna parameters
L = 0.028894796448140348  # Patch length (m)
W = 0.03031802940748092   # Patch width (m)
h = 0.002287379384309482  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007963120730555658  # Feed x position
feed_y = 0.011050875315693152  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0862_425ac8e6')
