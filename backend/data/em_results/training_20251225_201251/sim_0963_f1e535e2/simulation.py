...
# Antenna parameters
L = 0.03152984083696961  # Patch length (m)
W = 0.04357145439696886   # Patch width (m)
h = 0.001129998543540544  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012611936334787844  # Feed x position
feed_y = 0.015172617753015103  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0963_f1e535e2')
