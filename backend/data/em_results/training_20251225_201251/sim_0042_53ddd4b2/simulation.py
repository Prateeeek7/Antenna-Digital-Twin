...
# Antenna parameters
L = 0.029683057375643574  # Patch length (m)
W = 0.030786283250861687   # Patch width (m)
h = 0.002817920538436016  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0023478686241397493  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0042_53ddd4b2')
