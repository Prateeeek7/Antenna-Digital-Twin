...
# Antenna parameters
L = 0.02722828130635769  # Patch length (m)
W = 0.03315923540011344   # Patch width (m)
h = 0.0026363164284163303  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010891312522543077  # Feed x position
feed_y = 0.006239651135872035  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0847_85776122')
