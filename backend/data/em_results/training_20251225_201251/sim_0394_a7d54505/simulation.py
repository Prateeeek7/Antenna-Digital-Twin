...
# Antenna parameters
L = 0.02843687785727078  # Patch length (m)
W = 0.03210045812124412   # Patch width (m)
h = 0.0017486405012610573  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0038195136305924538  # Feed x position
feed_y = 0.0038010985887768998  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0394_a7d54505')
