...
# Antenna parameters
L = 0.03477752732916921  # Patch length (m)
W = 0.04436166183892686   # Patch width (m)
h = 0.0023592862112981755  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013911010931667684  # Feed x position
feed_y = 0.012844210632808554  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0481_ddc4edea')
