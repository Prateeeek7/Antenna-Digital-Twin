...
# Antenna parameters
L = 0.02561607142161399  # Patch length (m)
W = 0.0362602932181789   # Patch width (m)
h = 0.0025989928193772575  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.005130304417745271  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0814_d76515ac')
