...
# Antenna parameters
L = 0.029068725733289277  # Patch length (m)
W = 0.037993130846188806   # Patch width (m)
h = 0.0020178354875478805  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00707482937877568  # Feed x position
feed_y = 0.0016008365079705025  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0868_3cd920a3')
