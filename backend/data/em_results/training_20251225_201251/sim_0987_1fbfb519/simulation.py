...
# Antenna parameters
L = 0.030768462647205112  # Patch length (m)
W = 0.04496454304526753   # Patch width (m)
h = 0.0011582615357723773  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010974623432488657  # Feed x position
feed_y = 0.017985817218107013  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0987_1fbfb519')
