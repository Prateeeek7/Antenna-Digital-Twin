...
# Antenna parameters
L = 0.02785792001926292  # Patch length (m)
W = 0.03719221628036269   # Patch width (m)
h = 0.002202056142232532  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002394540859128743  # Feed x position
feed_y = 0.003525910720272408  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0324_eebeb756')
