...
# Antenna parameters
L = 0.0280326510683769  # Patch length (m)
W = 0.034091963931103114   # Patch width (m)
h = 0.0013455324844908357  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037443111245073655  # Feed x position
feed_y = 0.004906990983496608  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0066_35889761')
