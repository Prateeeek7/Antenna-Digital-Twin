...
# Antenna parameters
L = 0.03300990740218179  # Patch length (m)
W = 0.040302175170377826   # Patch width (m)
h = 0.001714324919569036  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003596253972597725  # Feed x position
feed_y = 0.0015189859738836183  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0153_a0f58648')
