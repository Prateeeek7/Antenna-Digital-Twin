...
# Antenna parameters
L = 0.02844669682114225  # Patch length (m)
W = 0.044554589324802205   # Patch width (m)
h = 0.0027160462140250977  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007280433511564327  # Feed x position
feed_y = 0.008856538055723652  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0673_08e151ea')
