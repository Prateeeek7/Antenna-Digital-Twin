...
# Antenna parameters
L = 0.03402293901417608  # Patch length (m)
W = 0.04145073321095417   # Patch width (m)
h = 0.0026575880360832933  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.016580293284381667  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0607_ee689eca')
