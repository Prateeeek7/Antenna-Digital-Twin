...
# Antenna parameters
L = 0.03009005196575408  # Patch length (m)
W = 0.032221224056829145   # Patch width (m)
h = 0.001973083818060425  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012036020786301633  # Feed x position
feed_y = 0.00816060973378546  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0929_08f258ff')
