...
# Antenna parameters
L = 0.025830666116431554  # Patch length (m)
W = 0.041055946401899655   # Patch width (m)
h = 0.0014442894702398046  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010332266446572622  # Feed x position
feed_y = 0.013008743008950172  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0662_74e69c46')
