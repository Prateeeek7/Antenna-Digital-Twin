...
# Antenna parameters
L = 0.026081418746953754  # Patch length (m)
W = 0.0443249324981259   # Patch width (m)
h = 0.0027883648895789207  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009067501415802478  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0129_0a4ec558')
