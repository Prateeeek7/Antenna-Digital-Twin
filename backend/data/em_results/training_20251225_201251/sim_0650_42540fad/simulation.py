...
# Antenna parameters
L = 0.03013028640975915  # Patch length (m)
W = 0.03369670480490483   # Patch width (m)
h = 0.002251349791055873  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034425513077550817  # Feed x position
feed_y = 0.00978826412887021  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0650_42540fad')
