...
# Antenna parameters
L = 0.027759469676283285  # Patch length (m)
W = 0.034824894543327906   # Patch width (m)
h = 0.0010383445952817428  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00450847307450466  # Feed x position
feed_y = 0.004575626737695996  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0927_e0f2291f')
