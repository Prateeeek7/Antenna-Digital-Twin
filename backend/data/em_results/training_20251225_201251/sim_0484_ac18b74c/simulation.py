...
# Antenna parameters
L = 0.030318761563180568  # Patch length (m)
W = 0.031377030288803745   # Patch width (m)
h = 0.0022237632290625477  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0017873374645977803  # Feed x position
feed_y = 0.005869069152550712  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0484_ac18b74c')
