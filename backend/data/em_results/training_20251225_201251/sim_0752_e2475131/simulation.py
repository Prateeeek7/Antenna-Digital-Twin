...
# Antenna parameters
L = 0.03243011823575443  # Patch length (m)
W = 0.043390096208172114   # Patch width (m)
h = 0.0031157878634349985  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002687667284341095  # Feed x position
feed_y = 0.017356038483268846  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0752_e2475131')
