...
# Antenna parameters
L = 0.03367850265791734  # Patch length (m)
W = 0.03986104743998174   # Patch width (m)
h = 0.002692153605414689  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005938525311056303  # Feed x position
feed_y = 0.015944418975992698  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0976_c2da7a04')
