...
# Antenna parameters
L = 0.028473620632557536  # Patch length (m)
W = 0.030497156564943048   # Patch width (m)
h = 0.0015952854429371077  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006159589103357577  # Feed x position
feed_y = 0.009535507370443027  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0299_1ba1a23c')
