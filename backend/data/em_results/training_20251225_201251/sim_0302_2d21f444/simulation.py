...
# Antenna parameters
L = 0.025128688448308154  # Patch length (m)
W = 0.03166202124504703   # Patch width (m)
h = 0.002264895620041318  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0034960630835410597  # Feed x position
feed_y = 0.0028195870879908617  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0302_2d21f444')
