...
# Antenna parameters
L = 0.02752773602459589  # Patch length (m)
W = 0.042007452322099126   # Patch width (m)
h = 0.002446421906052795  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00166526092373021  # Feed x position
feed_y = 0.0157621100654907  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0543_ff9a23a3')
