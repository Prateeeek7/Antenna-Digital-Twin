...
# Antenna parameters
L = 0.031591103435783245  # Patch length (m)
W = 0.040179074891399394   # Patch width (m)
h = 0.002269561804164298  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00942758492836907  # Feed x position
feed_y = 0.010085720247898385  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0169_6b174fbd')
