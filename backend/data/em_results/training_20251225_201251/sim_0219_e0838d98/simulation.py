...
# Antenna parameters
L = 0.03307590017611775  # Patch length (m)
W = 0.03515671715086808   # Patch width (m)
h = 0.0030468414655597936  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005029842714485381  # Feed x position
feed_y = 0.009981559788556712  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0219_e0838d98')
