...
# Antenna parameters
L = 0.03222638701101148  # Patch length (m)
W = 0.03834221065921441   # Patch width (m)
h = 0.0013578273184984614  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0061034548411859815  # Feed x position
feed_y = 0.015336884263685763  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0418_308d9cfe')
