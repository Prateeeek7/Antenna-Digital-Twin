...
# Antenna parameters
L = 0.033987727612782154  # Patch length (m)
W = 0.03537668122819476   # Patch width (m)
h = 0.0026790468385853505  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0029768553785060638  # Feed x position
feed_y = 0.014150672491277905  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0003_032d82b3')
