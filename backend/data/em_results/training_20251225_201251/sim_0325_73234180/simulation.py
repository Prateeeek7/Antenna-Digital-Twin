...
# Antenna parameters
L = 0.029692529241993705  # Patch length (m)
W = 0.0338644268518739   # Patch width (m)
h = 0.0026427467925908585  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007197535958397643  # Feed x position
feed_y = 0.00530977198216911  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0325_73234180')
