...
# Antenna parameters
L = 0.027180280056572984  # Patch length (m)
W = 0.031976291151400396   # Patch width (m)
h = 0.0010994007910905589  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014250688940924908  # Feed x position
feed_y = 0.01279051646056016  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0542_03e02287')
