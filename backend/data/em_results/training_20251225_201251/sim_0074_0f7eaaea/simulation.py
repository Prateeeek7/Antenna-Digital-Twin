...
# Antenna parameters
L = 0.025812374678529294  # Patch length (m)
W = 0.037795941975886344   # Patch width (m)
h = 0.001305525939157347  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006732971569804675  # Feed x position
feed_y = 0.015118376790354538  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0074_0f7eaaea')
