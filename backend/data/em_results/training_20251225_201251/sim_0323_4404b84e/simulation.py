...
# Antenna parameters
L = 0.029587869250656013  # Patch length (m)
W = 0.03502493541336498   # Patch width (m)
h = 0.0029538291983310662  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0055626070321705065  # Feed x position
feed_y = 0.012503225185343409  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0323_4404b84e')
