...
# Antenna parameters
L = 0.02884328145811386  # Patch length (m)
W = 0.038370591195562395   # Patch width (m)
h = 0.0023975098104283  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.007716093306833703  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0300_dd93f7cc')
