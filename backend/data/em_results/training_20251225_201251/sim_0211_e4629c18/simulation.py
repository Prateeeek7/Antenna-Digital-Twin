...
# Antenna parameters
L = 0.02719325263452651  # Patch length (m)
W = 0.04189634509634722   # Patch width (m)
h = 0.001577113946220982  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009999746523433108  # Feed x position
feed_y = 0.014963250510131533  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0211_e4629c18')
