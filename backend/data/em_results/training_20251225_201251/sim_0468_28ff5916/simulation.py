...
# Antenna parameters
L = 0.025778296809118882  # Patch length (m)
W = 0.03449896292756301   # Patch width (m)
h = 0.0018662530858592039  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008348455318468246  # Feed x position
feed_y = 0.011354924053664348  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0468_28ff5916')
