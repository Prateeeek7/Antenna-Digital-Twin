...
# Antenna parameters
L = 0.026181248923866775  # Patch length (m)
W = 0.0394858465883335   # Patch width (m)
h = 0.0015453345370726496  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008797738256556217  # Feed x position
feed_y = 0.015066733248710704  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0214_6d0ee61b')
