...
# Antenna parameters
L = 0.03235022494015871  # Patch length (m)
W = 0.041633334507560425   # Patch width (m)
h = 0.0008831784439850057  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012222342150832493  # Feed x position
feed_y = 0.004306262997326403  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0940_84be7cb9')
