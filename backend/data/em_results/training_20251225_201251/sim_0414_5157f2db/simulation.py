...
# Antenna parameters
L = 0.03397140469208191  # Patch length (m)
W = 0.03761327621468169   # Patch width (m)
h = 0.0009001292303034317  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011060147079731315  # Feed x position
feed_y = 0.00689470367525114  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0414_5157f2db')
