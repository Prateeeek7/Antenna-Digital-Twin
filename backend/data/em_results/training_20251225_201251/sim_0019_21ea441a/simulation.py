...
# Antenna parameters
L = 0.030593697174068814  # Patch length (m)
W = 0.0361145728108417   # Patch width (m)
h = 0.0028781896401936413  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007203010566076092  # Feed x position
feed_y = 0.010907289013658138  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0019_21ea441a')
