...
# Antenna parameters
L = 0.03291926958725239  # Patch length (m)
W = 0.03791721513456574   # Patch width (m)
h = 0.002510741875648227  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012021980625836311  # Feed x position
feed_y = 0.001987282679921075  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0788_fc7b7c48')
