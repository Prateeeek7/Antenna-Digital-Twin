...
# Antenna parameters
L = 0.02610931172584684  # Patch length (m)
W = 0.03363248365871773   # Patch width (m)
h = 0.0010675437827651723  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008003715550326322  # Feed x position
feed_y = 0.00761980928355018  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0680_219fe1b3')
