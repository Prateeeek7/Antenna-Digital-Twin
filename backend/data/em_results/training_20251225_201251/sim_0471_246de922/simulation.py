...
# Antenna parameters
L = 0.030682044744737715  # Patch length (m)
W = 0.03356266652547794   # Patch width (m)
h = 0.0014947984139824131  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014729054885475813  # Feed x position
feed_y = 0.01097247257970689  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0471_246de922')
