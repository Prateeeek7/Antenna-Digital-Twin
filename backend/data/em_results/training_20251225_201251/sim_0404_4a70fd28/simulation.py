...
# Antenna parameters
L = 0.0346034866500126  # Patch length (m)
W = 0.044158369995437936   # Patch width (m)
h = 0.0011887669343472944  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007954506006156912  # Feed x position
feed_y = 0.001358829277053977  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0404_4a70fd28')
