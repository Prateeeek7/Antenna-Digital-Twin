...
# Antenna parameters
L = 0.034797260938313944  # Patch length (m)
W = 0.04084450785000753   # Patch width (m)
h = 0.0021145295484507353  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011375347404853332  # Feed x position
feed_y = 0.015901203514856545  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0424_df16677a')
