...
# Antenna parameters
L = 0.0273026214281864  # Patch length (m)
W = 0.04168243494775146   # Patch width (m)
h = 0.0018189782899430077  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006218348876264481  # Feed x position
feed_y = 0.008853672813993557  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0736_cfb96b37')
