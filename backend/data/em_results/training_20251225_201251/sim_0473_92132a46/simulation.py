...
# Antenna parameters
L = 0.02647314785380634  # Patch length (m)
W = 0.04493605024076615   # Patch width (m)
h = 0.0011493954205007324  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004773550910264837  # Feed x position
feed_y = 0.017423471694272583  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0473_92132a46')
