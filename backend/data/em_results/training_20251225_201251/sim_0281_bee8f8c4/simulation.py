...
# Antenna parameters
L = 0.0317671395269816  # Patch length (m)
W = 0.04146053440207663   # Patch width (m)
h = 0.002294973713471629  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0051325007350211315  # Feed x position
feed_y = 0.005395925946403435  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0281_bee8f8c4')
