...
# Antenna parameters
L = 0.0302728544790173  # Patch length (m)
W = 0.04315088027786074   # Patch width (m)
h = 0.0017848042311703004  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012109141791606921  # Feed x position
feed_y = 0.007693558566339677  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0964_22aab41c')
