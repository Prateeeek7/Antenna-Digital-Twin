...
# Antenna parameters
L = 0.03456568923642363  # Patch length (m)
W = 0.04286946151670989   # Patch width (m)
h = 0.002430716958196906  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006619441084158356  # Feed x position
feed_y = 0.0030231821299911855  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0276_21267902')
