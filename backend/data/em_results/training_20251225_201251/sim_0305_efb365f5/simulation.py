...
# Antenna parameters
L = 0.027178248194321443  # Patch length (m)
W = 0.03812463476052711   # Patch width (m)
h = 0.002944451828177392  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.013700593992646367  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0305_efb365f5')
