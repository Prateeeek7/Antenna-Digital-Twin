...
# Antenna parameters
L = 0.032458450148218944  # Patch length (m)
W = 0.042686338213873715   # Patch width (m)
h = 0.003027549457301616  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012512173094637192  # Feed x position
feed_y = 0.009397208212945497  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0583_343c864c')
