...
# Antenna parameters
L = 0.026196039347487217  # Patch length (m)
W = 0.0446543812045124   # Patch width (m)
h = 0.0009629601155461412  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0062784702938955194  # Feed x position
feed_y = 0.00962311838724574  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0513_34319b12')
