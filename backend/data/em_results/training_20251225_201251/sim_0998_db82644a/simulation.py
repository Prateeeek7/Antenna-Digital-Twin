...
# Antenna parameters
L = 0.03431993121988966  # Patch length (m)
W = 0.04011217582307054   # Patch width (m)
h = 0.0012447109524613615  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004146613714452185  # Feed x position
feed_y = 0.007789874803134193  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0998_db82644a')
