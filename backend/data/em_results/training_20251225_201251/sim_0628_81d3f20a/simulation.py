...
# Antenna parameters
L = 0.02753696662367318  # Patch length (m)
W = 0.03398740464117985   # Patch width (m)
h = 0.002859209562187754  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00808122315298097  # Feed x position
feed_y = 0.009723337501681036  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0628_81d3f20a')
