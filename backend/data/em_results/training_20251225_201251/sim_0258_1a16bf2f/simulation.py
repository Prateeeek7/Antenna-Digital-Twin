...
# Antenna parameters
L = 0.028745381820885506  # Patch length (m)
W = 0.03594511869885275   # Patch width (m)
h = 0.0014106694423438888  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008044097364425134  # Feed x position
feed_y = 0.009609105584517618  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0258_1a16bf2f')
