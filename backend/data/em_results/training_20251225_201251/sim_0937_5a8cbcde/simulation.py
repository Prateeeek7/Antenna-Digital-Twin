...
# Antenna parameters
L = 0.026656521293382793  # Patch length (m)
W = 0.04291071736512464   # Patch width (m)
h = 0.0026205126029100567  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010662608517353117  # Feed x position
feed_y = 0.01114115427699792  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0937_5a8cbcde')
