...
# Antenna parameters
L = 0.027251072939212896  # Patch length (m)
W = 0.04282445541485843   # Patch width (m)
h = 0.003197947606528438  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008649992268269973  # Feed x position
feed_y = 0.011144909312348067  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0674_53a9ae64')
