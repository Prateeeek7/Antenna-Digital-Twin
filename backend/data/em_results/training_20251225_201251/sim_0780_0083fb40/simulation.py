...
# Antenna parameters
L = 0.03325856649929791  # Patch length (m)
W = 0.030332845629881828   # Patch width (m)
h = 0.002495108303676867  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011947635398979708  # Feed x position
feed_y = 0.010489486767086003  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0780_0083fb40')
