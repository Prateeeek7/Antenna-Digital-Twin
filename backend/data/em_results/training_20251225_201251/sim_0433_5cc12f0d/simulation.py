...
# Antenna parameters
L = 0.027467296590294725  # Patch length (m)
W = 0.04156659385306925   # Patch width (m)
h = 0.0015981776696844495  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008757565616359573  # Feed x position
feed_y = 0.003501933323453858  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0433_5cc12f0d')
