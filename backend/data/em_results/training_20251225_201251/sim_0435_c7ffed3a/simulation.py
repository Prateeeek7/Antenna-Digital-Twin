...
# Antenna parameters
L = 0.02901434209780626  # Patch length (m)
W = 0.03636879887633415   # Patch width (m)
h = 0.002125222610333478  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004740120626484758  # Feed x position
feed_y = 0.0021099400205123026  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0435_c7ffed3a')
