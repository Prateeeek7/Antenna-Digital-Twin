...
# Antenna parameters
L = 0.026953195811943303  # Patch length (m)
W = 0.04272655997979252   # Patch width (m)
h = 0.0008575363221507054  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018093214063495898  # Feed x position
feed_y = 0.00698895121725808  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0263_c0e4d6bc')
