...
# Antenna parameters
L = 0.034363356864596725  # Patch length (m)
W = 0.0441689041970784   # Patch width (m)
h = 0.0012900463510768017  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008519243627403231  # Feed x position
feed_y = 0.01766756167883136  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0016_c3b016f5')
