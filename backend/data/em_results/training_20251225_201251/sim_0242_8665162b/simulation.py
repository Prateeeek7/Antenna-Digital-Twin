...
# Antenna parameters
L = 0.028172420896812673  # Patch length (m)
W = 0.035207600827730126   # Patch width (m)
h = 0.002843453064637064  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01023524660038366  # Feed x position
feed_y = 0.014083040331092051  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0242_8665162b')
