...
# Antenna parameters
L = 0.026941768923771932  # Patch length (m)
W = 0.03140402240064789   # Patch width (m)
h = 0.002957623067702335  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.012561608960259155  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0237_a184bd62')
