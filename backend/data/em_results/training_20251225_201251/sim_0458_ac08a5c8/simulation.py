...
# Antenna parameters
L = 0.02706027929822869  # Patch length (m)
W = 0.03723437723269861   # Patch width (m)
h = 0.0010049347471898869  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010824111719291478  # Feed x position
feed_y = 0.014893750893079444  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0458_ac08a5c8')
