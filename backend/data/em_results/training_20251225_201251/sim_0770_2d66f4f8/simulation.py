...
# Antenna parameters
L = 0.033285759829018435  # Patch length (m)
W = 0.04310583453104305   # Patch width (m)
h = 0.002997519816562568  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003488498071498024  # Feed x position
feed_y = 0.016927577927778437  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0770_2d66f4f8')
