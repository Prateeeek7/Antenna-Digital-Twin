...
# Antenna parameters
L = 0.034187572210145394  # Patch length (m)
W = 0.042981872267698326   # Patch width (m)
h = 0.002768817278539987  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006273781740889841  # Feed x position
feed_y = 0.011567610205209468  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0872_632fa41f')
