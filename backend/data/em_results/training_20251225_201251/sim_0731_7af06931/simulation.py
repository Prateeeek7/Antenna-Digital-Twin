...
# Antenna parameters
L = 0.02951917063777132  # Patch length (m)
W = 0.04000262204956321   # Patch width (m)
h = 0.0016173990730798493  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008842770625241185  # Feed x position
feed_y = 0.013499739051683548  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0731_7af06931')
