...
# Antenna parameters
L = 0.03401892712942477  # Patch length (m)
W = 0.032081449470082096   # Patch width (m)
h = 0.0011251336727345494  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014786773293416198  # Feed x position
feed_y = 0.005743678855470522  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0483_2e737445')
