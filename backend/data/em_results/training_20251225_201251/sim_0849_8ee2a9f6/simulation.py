...
# Antenna parameters
L = 0.027967366576412647  # Patch length (m)
W = 0.03313718265395452   # Patch width (m)
h = 0.001169550111621258  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0056366314566632025  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0849_8ee2a9f6')
