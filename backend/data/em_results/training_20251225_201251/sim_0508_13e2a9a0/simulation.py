...
# Antenna parameters
L = 0.027894928098806844  # Patch length (m)
W = 0.039578445160675324   # Patch width (m)
h = 0.002469584679070011  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002144425023229798  # Feed x position
feed_y = 0.01583137806427013  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0508_13e2a9a0')
