...
# Antenna parameters
L = 0.032277693208746724  # Patch length (m)
W = 0.03670641312220629   # Patch width (m)
h = 0.002821999496841648  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00860594161540582  # Feed x position
feed_y = 0.0028842113629303045  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0370_59e71502')
