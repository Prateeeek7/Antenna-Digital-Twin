...
# Antenna parameters
L = 0.028720023326076614  # Patch length (m)
W = 0.03410759416013898   # Patch width (m)
h = 0.0024915142273291913  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.002942097616507784  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0488_db225913')
