...
# Antenna parameters
L = 0.0306718749223095  # Patch length (m)
W = 0.03144726151655633   # Patch width (m)
h = 0.0025297958944598014  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006786060686606698  # Feed x position
feed_y = 0.012578904606622532  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0681_e6469114')
