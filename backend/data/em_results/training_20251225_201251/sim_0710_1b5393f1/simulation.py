...
# Antenna parameters
L = 0.026561363179605783  # Patch length (m)
W = 0.04263670202052693   # Patch width (m)
h = 0.0010727743107961782  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010624545271842313  # Feed x position
feed_y = 0.013275097750203909  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0710_1b5393f1')
