...
# Antenna parameters
L = 0.02547759171941959  # Patch length (m)
W = 0.0335828546718725   # Patch width (m)
h = 0.0019861357569423387  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010191036687767836  # Feed x position
feed_y = 0.005576254387246576  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0083_093ce008')
