...
# Antenna parameters
L = 0.029176400673245353  # Patch length (m)
W = 0.03081583763174301   # Patch width (m)
h = 0.00242168898863509  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002912594730539034  # Feed x position
feed_y = 0.008184830175533727  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0734_d3bfe910')
