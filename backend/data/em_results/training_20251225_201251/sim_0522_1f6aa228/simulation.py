...
# Antenna parameters
L = 0.03461113354441873  # Patch length (m)
W = 0.0351177111092166   # Patch width (m)
h = 0.0020156171892798352  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003586182501081915  # Feed x position
feed_y = 0.0053506900731757475  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0522_1f6aa228')
