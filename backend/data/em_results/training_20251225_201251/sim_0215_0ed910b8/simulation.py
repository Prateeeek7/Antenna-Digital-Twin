...
# Antenna parameters
L = 0.03286677784326177  # Patch length (m)
W = 0.03833183177396938   # Patch width (m)
h = 0.0009140244217853782  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0041636915565326305  # Feed x position
feed_y = 0.012183118955682836  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0215_0ed910b8')
