...
# Antenna parameters
L = 0.02774331505709676  # Patch length (m)
W = 0.04437280641978456   # Patch width (m)
h = 0.000994685040282388  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001837342429516698  # Feed x position
feed_y = 0.0135377020593457  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0781_c0a09087')
