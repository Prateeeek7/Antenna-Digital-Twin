...
# Antenna parameters
L = 0.02815318104094933  # Patch length (m)
W = 0.03624038114380123   # Patch width (m)
h = 0.002145399409911875  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011261272416379732  # Feed x position
feed_y = 0.0073117303668084515  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0482_a8781c20')
