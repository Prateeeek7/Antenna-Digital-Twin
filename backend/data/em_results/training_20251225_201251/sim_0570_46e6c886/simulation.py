...
# Antenna parameters
L = 0.03410619764416101  # Patch length (m)
W = 0.04128853022577726   # Patch width (m)
h = 0.0030684438924238207  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008947405618300033  # Feed x position
feed_y = 0.004009982596502907  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0570_46e6c886')
