...
# Antenna parameters
L = 0.025865609024386976  # Patch length (m)
W = 0.034392294868524374   # Patch width (m)
h = 0.0018781843619176514  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0023129414109211784  # Feed x position
feed_y = 0.009031789744254103  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0879_cfddee89')
