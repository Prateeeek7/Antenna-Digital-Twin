...
# Antenna parameters
L = 0.02928163359253594  # Patch length (m)
W = 0.03481281251548896   # Patch width (m)
h = 0.0011330559232354048  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010738327370526296  # Feed x position
feed_y = 0.013925125006195586  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0503_1da66de8')
