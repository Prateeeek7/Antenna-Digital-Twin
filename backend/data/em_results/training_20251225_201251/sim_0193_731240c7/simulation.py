...
# Antenna parameters
L = 0.02943517969240414  # Patch length (m)
W = 0.03367570191712642   # Patch width (m)
h = 0.0010372074154934958  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002376089879667866  # Feed x position
feed_y = 0.01168197105308941  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0193_731240c7')
