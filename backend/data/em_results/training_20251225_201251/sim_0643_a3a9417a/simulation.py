...
# Antenna parameters
L = 0.02916252098397852  # Patch length (m)
W = 0.032589677971212934   # Patch width (m)
h = 0.0024847688159631877  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005084768575937176  # Feed x position
feed_y = 0.00359577233302075  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0643_a3a9417a')
