...
# Antenna parameters
L = 0.026897587065483106  # Patch length (m)
W = 0.03935908939223097   # Patch width (m)
h = 0.0008730826697863843  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002163099404433606  # Feed x position
feed_y = 0.015743635756892388  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0597_b1a42167')
