...
# Antenna parameters
L = 0.02721992651860936  # Patch length (m)
W = 0.039309669533515196   # Patch width (m)
h = 0.0015377227599325805  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0058641281741708025  # Feed x position
feed_y = 0.0013975254424975565  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0856_d4aa9212')
