...
# Antenna parameters
L = 0.026124490355844868  # Patch length (m)
W = 0.040409117984132645   # Patch width (m)
h = 0.0030182205276641895  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018830525201900075  # Feed x position
feed_y = 0.011599025904815277  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0865_39852200')
