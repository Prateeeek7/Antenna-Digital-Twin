...
# Antenna parameters
L = 0.030810242639756107  # Patch length (m)
W = 0.032276719436607725   # Patch width (m)
h = 0.002349162186376909  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012324097055902443  # Feed x position
feed_y = 0.004890291066574904  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0287_98932d17')
