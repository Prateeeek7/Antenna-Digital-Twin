...
# Antenna parameters
L = 0.028260379856361813  # Patch length (m)
W = 0.03997939741239231   # Patch width (m)
h = 0.001558410392478499  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005548995386658734  # Feed x position
feed_y = 0.009339406057177316  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0834_1a96c684')
