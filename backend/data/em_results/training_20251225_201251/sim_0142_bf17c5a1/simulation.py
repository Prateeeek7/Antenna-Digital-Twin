...
# Antenna parameters
L = 0.03062005298251065  # Patch length (m)
W = 0.040684881037845316   # Patch width (m)
h = 0.0029868448677365174  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012248021193004261  # Feed x position
feed_y = 0.010765471975632206  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0142_bf17c5a1')
