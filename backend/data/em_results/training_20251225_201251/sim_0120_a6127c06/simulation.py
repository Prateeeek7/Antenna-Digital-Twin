...
# Antenna parameters
L = 0.027455224941263724  # Patch length (m)
W = 0.03894357851155224   # Patch width (m)
h = 0.0017890320131072864  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01098208997650549  # Feed x position
feed_y = 0.015577431404620895  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0120_a6127c06')
