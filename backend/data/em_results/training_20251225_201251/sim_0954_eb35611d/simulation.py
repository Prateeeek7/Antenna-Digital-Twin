...
# Antenna parameters
L = 0.03228355913142664  # Patch length (m)
W = 0.0440190399917369   # Patch width (m)
h = 0.0016303894377874316  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007805412695320899  # Feed x position
feed_y = 0.017607615996694758  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0954_eb35611d')
