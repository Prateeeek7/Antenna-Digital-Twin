...
# Antenna parameters
L = 0.032960017715188826  # Patch length (m)
W = 0.04044761305624499   # Patch width (m)
h = 0.0015798528702421438  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006549223781016661  # Feed x position
feed_y = 0.0026671353403307555  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0560_92ed8b1d')
