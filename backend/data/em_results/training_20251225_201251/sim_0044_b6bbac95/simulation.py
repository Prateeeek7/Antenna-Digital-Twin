...
# Antenna parameters
L = 0.029446990513082194  # Patch length (m)
W = 0.03635267123931973   # Patch width (m)
h = 0.0017800091258893674  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00914394393507639  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0044_b6bbac95')
