...
# Antenna parameters
L = 0.030915553119719896  # Patch length (m)
W = 0.040853357227181517   # Patch width (m)
h = 0.001807827686858336  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012366221247887959  # Feed x position
feed_y = 0.0072128021331200045  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0381_ca0d0a24')
