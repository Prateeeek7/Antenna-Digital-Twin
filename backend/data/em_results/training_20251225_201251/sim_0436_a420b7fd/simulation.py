...
# Antenna parameters
L = 0.03378215277979149  # Patch length (m)
W = 0.03282048610461004   # Patch width (m)
h = 0.0018347884722684075  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037812008230697827  # Feed x position
feed_y = 0.0068508422578188385  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0436_a420b7fd')
