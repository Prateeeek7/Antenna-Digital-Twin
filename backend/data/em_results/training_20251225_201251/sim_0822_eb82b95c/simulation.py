...
# Antenna parameters
L = 0.02540678377661781  # Patch length (m)
W = 0.0366775838899521   # Patch width (m)
h = 0.0016261500553236023  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008517620251737464  # Feed x position
feed_y = 0.0012146174836582316  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0822_eb82b95c')
