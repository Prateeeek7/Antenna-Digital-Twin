...
# Antenna parameters
L = 0.03041955824897056  # Patch length (m)
W = 0.04224898102553721   # Patch width (m)
h = 0.0015264225519945498  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008685564970702725  # Feed x position
feed_y = 0.016899592410214884  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0252_e9146366')
