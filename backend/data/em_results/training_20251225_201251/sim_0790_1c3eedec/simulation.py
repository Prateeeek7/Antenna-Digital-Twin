...
# Antenna parameters
L = 0.030475745773701664  # Patch length (m)
W = 0.034935614604239815   # Patch width (m)
h = 0.0022281335138740217  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008110892436008212  # Feed x position
feed_y = 0.00829600425618248  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0790_1c3eedec')
