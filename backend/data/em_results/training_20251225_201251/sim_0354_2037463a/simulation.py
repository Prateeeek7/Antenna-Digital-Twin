...
# Antenna parameters
L = 0.030244197597832572  # Patch length (m)
W = 0.04438838374193146   # Patch width (m)
h = 0.0010072858111813457  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01209767903913303  # Feed x position
feed_y = 0.012925043589958427  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0354_2037463a')
