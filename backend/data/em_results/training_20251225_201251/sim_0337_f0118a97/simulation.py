...
# Antenna parameters
L = 0.03032761661470638  # Patch length (m)
W = 0.031717456875945294   # Patch width (m)
h = 0.0018427873353864966  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012131046645882554  # Feed x position
feed_y = 0.011380301205717345  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0337_f0118a97')
