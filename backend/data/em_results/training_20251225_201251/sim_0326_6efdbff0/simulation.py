...
# Antenna parameters
L = 0.03425520582925194  # Patch length (m)
W = 0.03345207278373276   # Patch width (m)
h = 0.003179258594195437  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013702082331700777  # Feed x position
feed_y = 0.008346576716729342  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0326_6efdbff0')
