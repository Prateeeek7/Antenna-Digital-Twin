...
# Antenna parameters
L = 0.027571183827787574  # Patch length (m)
W = 0.04330905884310601   # Patch width (m)
h = 0.0026532830004133722  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011028473531115031  # Feed x position
feed_y = 0.017323623537242407  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0529_1ad404b5')
