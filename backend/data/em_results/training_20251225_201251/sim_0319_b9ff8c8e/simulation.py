...
# Antenna parameters
L = 0.025923186705273105  # Patch length (m)
W = 0.03680712118257883   # Patch width (m)
h = 0.0015891788906082103  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010369274682109242  # Feed x position
feed_y = 0.002001116466444936  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0319_b9ff8c8e')
