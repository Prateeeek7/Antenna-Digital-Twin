...
# Antenna parameters
L = 0.029797402017543738  # Patch length (m)
W = 0.037541377655904526   # Patch width (m)
h = 0.0018577638145074204  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006371180317949366  # Feed x position
feed_y = 0.015016551062361811  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0809_2aaa0f94')
