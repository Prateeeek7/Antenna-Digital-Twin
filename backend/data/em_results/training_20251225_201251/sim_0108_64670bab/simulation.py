...
# Antenna parameters
L = 0.026520108669973164  # Patch length (m)
W = 0.036576660458579574   # Patch width (m)
h = 0.002060386232645884  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005396970449596445  # Feed x position
feed_y = 0.011647076803688339  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0108_64670bab')
