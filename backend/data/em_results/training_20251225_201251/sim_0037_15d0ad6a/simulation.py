...
# Antenna parameters
L = 0.025743383387368323  # Patch length (m)
W = 0.037584395134066896   # Patch width (m)
h = 0.0017453732799966525  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0017666810080910836  # Feed x position
feed_y = 0.0029266506105884494  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0037_15d0ad6a')
