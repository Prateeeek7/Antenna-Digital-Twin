...
# Antenna parameters
L = 0.029934704579447153  # Patch length (m)
W = 0.03621386523075873   # Patch width (m)
h = 0.0023009822124940072  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006770430332403617  # Feed x position
feed_y = 0.0014250267635293405  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0139_08f759ce')
