...
# Antenna parameters
L = 0.033999158846654436  # Patch length (m)
W = 0.036326344988189166   # Patch width (m)
h = 0.00154197538787657  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012330855921582362  # Feed x position
feed_y = 0.006781235906619408  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0112_f860477a')
