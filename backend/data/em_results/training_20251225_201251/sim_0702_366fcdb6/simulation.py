...
# Antenna parameters
L = 0.0321404092666192  # Patch length (m)
W = 0.03496939099208707   # Patch width (m)
h = 0.0010688289465706103  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005850016323053146  # Feed x position
feed_y = 0.008219224721944817  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0702_366fcdb6')
