...
# Antenna parameters
L = 0.025914022206593702  # Patch length (m)
W = 0.031178371483893824   # Patch width (m)
h = 0.001855413257978034  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010365608882637482  # Feed x position
feed_y = 0.007274320604467906  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0612_064bbe8d')
