...
# Antenna parameters
L = 0.02533164137028731  # Patch length (m)
W = 0.04447387290888102   # Patch width (m)
h = 0.0019286244053743078  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00737165396173846  # Feed x position
feed_y = 0.005940673219052021  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0558_dcdb01f6')
