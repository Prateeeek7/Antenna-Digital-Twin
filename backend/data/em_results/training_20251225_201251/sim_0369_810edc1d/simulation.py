...
# Antenna parameters
L = 0.030973733607823028  # Patch length (m)
W = 0.04406510642456754   # Patch width (m)
h = 0.0020728602528176858  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0035555947709274413  # Feed x position
feed_y = 0.009082707600700915  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0369_810edc1d')
