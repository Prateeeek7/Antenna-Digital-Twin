...
# Antenna parameters
L = 0.029327511202718523  # Patch length (m)
W = 0.04337970890774259   # Patch width (m)
h = 0.001065430029114528  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0010332597409301936  # Feed x position
feed_y = 0.005542635229365494  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0833_c1c5aab4')
