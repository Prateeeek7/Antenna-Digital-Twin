...
# Antenna parameters
L = 0.034269381880389284  # Patch length (m)
W = 0.04182266809089144   # Patch width (m)
h = 0.0018338800507146456  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013707752752155715  # Feed x position
feed_y = 0.00233089484695615  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0727_de0f5c28')
