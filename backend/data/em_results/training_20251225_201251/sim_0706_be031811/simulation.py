...
# Antenna parameters
L = 0.027449512775732474  # Patch length (m)
W = 0.03928475263111533   # Patch width (m)
h = 0.0016532636590352136  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004252418422269873  # Feed x position
feed_y = 0.006350279577059505  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0706_be031811')
