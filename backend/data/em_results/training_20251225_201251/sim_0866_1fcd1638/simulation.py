...
# Antenna parameters
L = 0.027018982315408203  # Patch length (m)
W = 0.04137090419627966   # Patch width (m)
h = 0.00286383771198169  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010807592926163283  # Feed x position
feed_y = 0.007760349016662967  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0866_1fcd1638')
