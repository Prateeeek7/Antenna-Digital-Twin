...
# Antenna parameters
L = 0.025806633929664348  # Patch length (m)
W = 0.04494293584750834   # Patch width (m)
h = 0.0021553777164778206  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01032265357186574  # Feed x position
feed_y = 0.004058121724640077  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0945_ce489616')
