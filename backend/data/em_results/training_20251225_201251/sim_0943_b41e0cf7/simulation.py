...
# Antenna parameters
L = 0.03404806207387228  # Patch length (m)
W = 0.03548482850709051   # Patch width (m)
h = 0.0030617831139027585  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013619224829548913  # Feed x position
feed_y = 0.0017538621363994613  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0943_b41e0cf7')
