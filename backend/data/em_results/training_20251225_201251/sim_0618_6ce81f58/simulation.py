...
# Antenna parameters
L = 0.02679125176845726  # Patch length (m)
W = 0.03879125912503047   # Patch width (m)
h = 0.0012803593702756738  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009230060691168168  # Feed x position
feed_y = 0.015516503650012187  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0618_6ce81f58')
