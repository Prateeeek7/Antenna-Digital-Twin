...
# Antenna parameters
L = 0.030795290478615435  # Patch length (m)
W = 0.03344279879887208   # Patch width (m)
h = 0.003149605644878759  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0028775974713297265  # Feed x position
feed_y = 0.003597576222643536  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0709_90947f7e')
