...
# Antenna parameters
L = 0.03361153125796886  # Patch length (m)
W = 0.03009890246694349   # Patch width (m)
h = 0.002398762946995855  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0046634911731041  # Feed x position
feed_y = 0.0010200061125444659  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0665_88ab7574')
