...
# Antenna parameters
L = 0.029623480689744203  # Patch length (m)
W = 0.04381698764052371   # Patch width (m)
h = 0.0024285106474830173  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00261800710578874  # Feed x position
feed_y = 0.009240199476233281  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0050_28759de8')
