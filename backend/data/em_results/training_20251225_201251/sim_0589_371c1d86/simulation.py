...
# Antenna parameters
L = 0.02712581722680772  # Patch length (m)
W = 0.03862013391503787   # Patch width (m)
h = 0.0013692839580493766  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0037981882121939123  # Feed x position
feed_y = 0.01544805356601515  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0589_371c1d86')
