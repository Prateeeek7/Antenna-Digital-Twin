...
# Antenna parameters
L = 0.02777551270492799  # Patch length (m)
W = 0.030219106227349544   # Patch width (m)
h = 0.0009202997979222702  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006930329341604208  # Feed x position
feed_y = 0.008281956150609105  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0238_487f4f1c')
