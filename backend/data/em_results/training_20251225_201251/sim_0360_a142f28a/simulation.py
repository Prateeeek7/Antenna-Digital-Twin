...
# Antenna parameters
L = 0.0308238966461121  # Patch length (m)
W = 0.03287064680445536   # Patch width (m)
h = 0.002957275808498678  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006909275987174949  # Feed x position
feed_y = 0.003555375437960529  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0360_a142f28a')
