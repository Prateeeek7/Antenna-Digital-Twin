...
# Antenna parameters
L = 0.028772052494415827  # Patch length (m)
W = 0.03903243424712719   # Patch width (m)
h = 0.001312917446877024  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005606179810284828  # Feed x position
feed_y = 0.015010423487958767  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0270_ccf250a3')
