...
# Antenna parameters
L = 0.027260604551592207  # Patch length (m)
W = 0.03707008697706113   # Patch width (m)
h = 0.0024429639654051753  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006300637353728373  # Feed x position
feed_y = 0.014828034790824451  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0571_2a24fe07')
