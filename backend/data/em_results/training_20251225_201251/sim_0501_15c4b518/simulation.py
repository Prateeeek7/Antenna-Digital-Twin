...
# Antenna parameters
L = 0.028889466749150668  # Patch length (m)
W = 0.042750894728811925   # Patch width (m)
h = 0.0031425510494602887  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011555786699660267  # Feed x position
feed_y = 0.016765996359034252  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0501_15c4b518')
