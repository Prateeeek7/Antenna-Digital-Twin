...
# Antenna parameters
L = 0.02927955089380608  # Patch length (m)
W = 0.04367347354409995   # Patch width (m)
h = 0.001450418298646266  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011711820357522433  # Feed x position
feed_y = 0.01746938941763998  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0035_db90a9ca')
