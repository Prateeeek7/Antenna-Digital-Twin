...
# Antenna parameters
L = 0.03215359560787897  # Patch length (m)
W = 0.040751976975369114   # Patch width (m)
h = 0.0017266686591319645  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011401476062058071  # Feed x position
feed_y = 0.014398701156670322  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0350_6d4a62fb')
