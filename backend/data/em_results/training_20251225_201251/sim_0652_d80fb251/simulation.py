...
# Antenna parameters
L = 0.025649206831008187  # Patch length (m)
W = 0.033799558254635806   # Patch width (m)
h = 0.0009990277349766542  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0021484149752487333  # Feed x position
feed_y = 0.009322954196883284  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0652_d80fb251')
