...
# Antenna parameters
L = 0.02980480832765086  # Patch length (m)
W = 0.03305200125285252   # Patch width (m)
h = 0.0010011730100280892  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004685120507246511  # Feed x position
feed_y = 0.013220800501141008  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0422_52909c06')
