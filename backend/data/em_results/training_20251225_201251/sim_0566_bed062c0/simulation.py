...
# Antenna parameters
L = 0.033497780459604394  # Patch length (m)
W = 0.03690823177058764   # Patch width (m)
h = 0.00271408928254924  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004458112231770943  # Feed x position
feed_y = 0.0054682526688800215  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0566_bed062c0')
