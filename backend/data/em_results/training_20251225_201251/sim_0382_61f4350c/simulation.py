...
# Antenna parameters
L = 0.03282988983332616  # Patch length (m)
W = 0.04316732093736454   # Patch width (m)
h = 0.001693030629946891  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003339628855613097  # Feed x position
feed_y = 0.004572497616046868  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0382_61f4350c')
