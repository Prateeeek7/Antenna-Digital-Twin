...
# Antenna parameters
L = 0.03395439942523764  # Patch length (m)
W = 0.03806195077359706   # Patch width (m)
h = 0.0027780112451649755  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009386034133354966  # Feed x position
feed_y = 0.007081236827334526  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0785_997cb312')
