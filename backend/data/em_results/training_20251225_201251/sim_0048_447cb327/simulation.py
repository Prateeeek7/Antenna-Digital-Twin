...
# Antenna parameters
L = 0.032631705713851177  # Patch length (m)
W = 0.03364804774367512   # Patch width (m)
h = 0.0017714416622192806  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013052682285540471  # Feed x position
feed_y = 0.003758385722657445  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0048_447cb327')
