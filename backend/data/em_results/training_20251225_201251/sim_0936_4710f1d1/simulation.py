...
# Antenna parameters
L = 0.02907055884884504  # Patch length (m)
W = 0.041699301582724065   # Patch width (m)
h = 0.0018301758277242956  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015445601917964738  # Feed x position
feed_y = 0.016679720633089628  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0936_4710f1d1')
