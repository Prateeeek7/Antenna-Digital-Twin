...
# Antenna parameters
L = 0.03109909641123299  # Patch length (m)
W = 0.03725253048661832   # Patch width (m)
h = 0.001250820397127235  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0016726323953359466  # Feed x position
feed_y = 0.009738866792001229  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0793_b700d0b6')
