...
# Antenna parameters
L = 0.025681665414462117  # Patch length (m)
W = 0.03073422057200302   # Patch width (m)
h = 0.002052980379514357  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0036840462917051985  # Feed x position
feed_y = 0.0072403127456770015  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0058_c909d19a')
