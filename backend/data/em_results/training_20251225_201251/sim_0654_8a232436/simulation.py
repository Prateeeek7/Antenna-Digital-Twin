...
# Antenna parameters
L = 0.02546040318780826  # Patch length (m)
W = 0.04206607856244787   # Patch width (m)
h = 0.0021736600150271284  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010184161275123305  # Feed x position
feed_y = 0.005264483099307728  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0654_8a232436')
