...
# Antenna parameters
L = 0.03287075191570688  # Patch length (m)
W = 0.0412796271076292   # Patch width (m)
h = 0.0030954675246984155  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008355186743239  # Feed x position
feed_y = 0.009347649837208765  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0045_fb887e66')
