...
# Antenna parameters
L = 0.027295282084926063  # Patch length (m)
W = 0.03523017623845696   # Patch width (m)
h = 0.0012173938730973498  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0012658920336519196  # Feed x position
feed_y = 0.007891362421772966  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0587_028a16e1')
