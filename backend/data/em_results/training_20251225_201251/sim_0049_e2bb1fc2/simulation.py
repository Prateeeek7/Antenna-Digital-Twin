...
# Antenna parameters
L = 0.02582132261046224  # Patch length (m)
W = 0.038810953392639916   # Patch width (m)
h = 0.002894209828233743  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0016477336836193312  # Feed x position
feed_y = 0.010587125831288197  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0049_e2bb1fc2')
