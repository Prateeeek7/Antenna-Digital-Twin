...
# Antenna parameters
L = 0.03217966122204858  # Patch length (m)
W = 0.042334754775653266   # Patch width (m)
h = 0.002403318808952474  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004186104898536628  # Feed x position
feed_y = 0.01693390191026131  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0500_66519f4d')
