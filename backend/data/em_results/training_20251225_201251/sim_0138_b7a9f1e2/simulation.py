...
# Antenna parameters
L = 0.025657154591248885  # Patch length (m)
W = 0.037486545048018405   # Patch width (m)
h = 0.0017738357669194865  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001291512622492066  # Feed x position
feed_y = 0.005830862177932154  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0138_b7a9f1e2')
