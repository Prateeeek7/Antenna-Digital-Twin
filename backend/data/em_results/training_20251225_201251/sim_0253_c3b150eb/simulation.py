...
# Antenna parameters
L = 0.027721938090345555  # Patch length (m)
W = 0.03560744488209512   # Patch width (m)
h = 0.001846451278054639  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0063829951025007  # Feed x position
feed_y = 0.006169102486420686  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0253_c3b150eb')
