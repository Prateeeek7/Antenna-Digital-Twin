...
# Antenna parameters
L = 0.03101959600771158  # Patch length (m)
W = 0.03901941304494556   # Patch width (m)
h = 0.0027984757643199276  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.015607765217978223  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0277_bca8011b')
