...
# Antenna parameters
L = 0.029886247218603067  # Patch length (m)
W = 0.03483045102175425   # Patch width (m)
h = 0.0023883849744613596  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008796723003787914  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0509_fefbadb0')
