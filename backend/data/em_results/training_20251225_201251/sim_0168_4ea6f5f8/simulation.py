...
# Antenna parameters
L = 0.02945987530122059  # Patch length (m)
W = 0.04180805957165534   # Patch width (m)
h = 0.00232995144783909  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003985803856882325  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0168_4ea6f5f8')
