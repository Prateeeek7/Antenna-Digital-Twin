...
# Antenna parameters
L = 0.02708113442086334  # Patch length (m)
W = 0.0418485368293984   # Patch width (m)
h = 0.0030424437243905898  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0031048558082891996  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0610_2caae927')
