...
# Antenna parameters
L = 0.0306623093808616  # Patch length (m)
W = 0.03647241362582518   # Patch width (m)
h = 0.0013738094314371654  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014005966721788723  # Feed x position
feed_y = 0.006147725276590217  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0917_fc0fa76d')
