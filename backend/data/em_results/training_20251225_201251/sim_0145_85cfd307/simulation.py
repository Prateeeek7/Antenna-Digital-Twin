...
# Antenna parameters
L = 0.029129589209066952  # Patch length (m)
W = 0.04189130900082742   # Patch width (m)
h = 0.000951042726958596  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.010273506562926122  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0145_85cfd307')
