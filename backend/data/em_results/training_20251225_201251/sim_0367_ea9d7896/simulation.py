...
# Antenna parameters
L = 0.02569904812461663  # Patch length (m)
W = 0.041774991478061116   # Patch width (m)
h = 0.002973363330413599  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0064277271541583235  # Feed x position
feed_y = 0.009592927762755353  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0367_ea9d7896')
