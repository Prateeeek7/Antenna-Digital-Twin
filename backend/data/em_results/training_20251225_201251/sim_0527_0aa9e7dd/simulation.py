...
# Antenna parameters
L = 0.025485714070817494  # Patch length (m)
W = 0.03608303397560524   # Patch width (m)
h = 0.0024458977343658275  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005456199113957972  # Feed x position
feed_y = 0.014433213590242099  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0527_0aa9e7dd')
