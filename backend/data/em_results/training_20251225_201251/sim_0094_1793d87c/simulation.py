...
# Antenna parameters
L = 0.03126595965609259  # Patch length (m)
W = 0.03600788746905776   # Patch width (m)
h = 0.0027461138779371255  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012506383862437038  # Feed x position
feed_y = 0.002227482566601387  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0094_1793d87c')
