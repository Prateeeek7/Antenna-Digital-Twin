...
# Antenna parameters
L = 0.03412539962515097  # Patch length (m)
W = 0.03845727715337835   # Patch width (m)
h = 0.0013531288994216972  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01292146831756808  # Feed x position
feed_y = 0.006449760423048475  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0547_32ec6c92')
