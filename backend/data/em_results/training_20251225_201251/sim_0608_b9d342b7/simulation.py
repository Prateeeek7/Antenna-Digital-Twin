...
# Antenna parameters
L = 0.03238620280673519  # Patch length (m)
W = 0.03717113579424482   # Patch width (m)
h = 0.00213736466187406  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012954481122694076  # Feed x position
feed_y = 0.0031827875168001065  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0608_b9d342b7')
