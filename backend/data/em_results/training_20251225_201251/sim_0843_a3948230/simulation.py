...
# Antenna parameters
L = 0.02709814475810368  # Patch length (m)
W = 0.042439815215086274   # Patch width (m)
h = 0.002316629194825885  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006801960940197931  # Feed x position
feed_y = 0.005693629547188642  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0843_a3948230')
