...
# Antenna parameters
L = 0.02838248918839517  # Patch length (m)
W = 0.03716714908670088   # Patch width (m)
h = 0.002165452102403894  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011204714108248545  # Feed x position
feed_y = 0.0074296669158328875  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0841_93045152')
