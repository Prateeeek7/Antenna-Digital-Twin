...
# Antenna parameters
L = 0.033097234279863434  # Patch length (m)
W = 0.04022954685077637   # Patch width (m)
h = 0.0023340419999472164  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013238893711945374  # Feed x position
feed_y = 0.01214828110077109  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0728_f0e126dc')
