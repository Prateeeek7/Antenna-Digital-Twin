...
# Antenna parameters
L = 0.02941745736516246  # Patch length (m)
W = 0.03339121809478646   # Patch width (m)
h = 0.0020997093021672833  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011581602595294786  # Feed x position
feed_y = 0.011837443099987213  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0156_b217f603')
