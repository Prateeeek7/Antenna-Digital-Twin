...
# Antenna parameters
L = 0.02894379919093347  # Patch length (m)
W = 0.041485334042473426   # Patch width (m)
h = 0.0015046398402645974  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011228262147760324  # Feed x position
feed_y = 0.007670797691756636  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0779_f7867c78')
