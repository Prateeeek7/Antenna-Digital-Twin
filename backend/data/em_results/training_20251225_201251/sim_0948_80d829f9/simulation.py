...
# Antenna parameters
L = 0.026027905671634738  # Patch length (m)
W = 0.03566661543021554   # Patch width (m)
h = 0.0026437300675631755  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005318985696050556  # Feed x position
feed_y = 0.009575209604625103  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0948_80d829f9')
