...
# Antenna parameters
L = 0.033123472127755085  # Patch length (m)
W = 0.0389562133550315   # Patch width (m)
h = 0.0019613587471966  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013249388851102035  # Feed x position
feed_y = 0.002491786369016999  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0552_e70732c9')
