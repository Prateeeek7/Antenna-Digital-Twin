...
# Antenna parameters
L = 0.029849991753831656  # Patch length (m)
W = 0.040566022072664354   # Patch width (m)
h = 0.002613550739265624  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004311476283022137  # Feed x position
feed_y = 0.005249524404006248  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0630_dc66a949')
