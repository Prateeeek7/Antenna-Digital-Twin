...
# Antenna parameters
L = 0.031286148322626446  # Patch length (m)
W = 0.04428991488389095   # Patch width (m)
h = 0.0015744129826795264  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0045820170562324795  # Feed x position
feed_y = 0.008768844984528974  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0425_199d94d3')
