...
# Antenna parameters
L = 0.029826567075376214  # Patch length (m)
W = 0.03860369427342742   # Patch width (m)
h = 0.002772897897745173  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008146351855873462  # Feed x position
feed_y = 0.013230627603656418  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0137_7e601ae8')
