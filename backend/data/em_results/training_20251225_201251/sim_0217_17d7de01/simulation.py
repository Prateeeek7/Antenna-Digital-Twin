...
# Antenna parameters
L = 0.025722550084742203  # Patch length (m)
W = 0.03184852999157157   # Patch width (m)
h = 0.00194776978377929  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002720409082053662  # Feed x position
feed_y = 0.001155202678989009  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0217_17d7de01')
