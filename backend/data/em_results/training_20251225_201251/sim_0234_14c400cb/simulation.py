...
# Antenna parameters
L = 0.029766055184820617  # Patch length (m)
W = 0.0449139330366584   # Patch width (m)
h = 0.0008713821152976226  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.005198693910214313  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0234_14c400cb')
