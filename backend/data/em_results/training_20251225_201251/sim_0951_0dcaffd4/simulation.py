...
# Antenna parameters
L = 0.029874551083461355  # Patch length (m)
W = 0.04208377319084082   # Patch width (m)
h = 0.0011168253442239207  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0107239896945317  # Feed x position
feed_y = 0.01395219927388446  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0951_0dcaffd4')
