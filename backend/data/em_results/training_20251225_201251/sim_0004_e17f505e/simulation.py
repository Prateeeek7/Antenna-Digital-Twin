...
# Antenna parameters
L = 0.02523241912259915  # Patch length (m)
W = 0.03231968211047805   # Patch width (m)
h = 0.0013592703247414524  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009438273158183156  # Feed x position
feed_y = 0.003849623458609394  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0004_e17f505e')
