...
# Antenna parameters
L = 0.03373863178721971  # Patch length (m)
W = 0.03827137692105566   # Patch width (m)
h = 0.0023648058079105694  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005571920177621304  # Feed x position
feed_y = 0.010723731418874257  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0134_15758adc')
