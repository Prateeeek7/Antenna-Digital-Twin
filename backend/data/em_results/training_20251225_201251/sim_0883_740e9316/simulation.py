...
# Antenna parameters
L = 0.02887224766747807  # Patch length (m)
W = 0.04136197924923866   # Patch width (m)
h = 0.003111166465473396  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0028583202513878018  # Feed x position
feed_y = 0.007207104411765431  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0883_740e9316')
