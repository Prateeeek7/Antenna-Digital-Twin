...
# Antenna parameters
L = 0.02782226043951444  # Patch length (m)
W = 0.042593416823403715   # Patch width (m)
h = 0.0015659393649922128  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002146524006599029  # Feed x position
feed_y = 0.017037366729361486  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0000_68f6a590')
