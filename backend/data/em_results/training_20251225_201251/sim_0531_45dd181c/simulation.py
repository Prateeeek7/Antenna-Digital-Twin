...
# Antenna parameters
L = 0.031680730510002676  # Patch length (m)
W = 0.04250408361105641   # Patch width (m)
h = 0.001583442881800937  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008932287838190042  # Feed x position
feed_y = 0.005159447974880407  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0531_45dd181c')
