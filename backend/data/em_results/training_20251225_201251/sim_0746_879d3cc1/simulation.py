...
# Antenna parameters
L = 0.032260637215071955  # Patch length (m)
W = 0.03436639646372917   # Patch width (m)
h = 0.0028890235379318997  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012904254886028782  # Feed x position
feed_y = 0.001818544414237524  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0746_879d3cc1')
