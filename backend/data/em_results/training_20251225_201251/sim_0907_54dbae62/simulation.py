...
# Antenna parameters
L = 0.027079099449622182  # Patch length (m)
W = 0.030605006742520417   # Patch width (m)
h = 0.0019571223511151495  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010098589178752204  # Feed x position
feed_y = 0.009466647253679765  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0907_54dbae62')
