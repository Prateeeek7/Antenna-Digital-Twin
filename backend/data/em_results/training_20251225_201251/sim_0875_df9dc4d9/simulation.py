...
# Antenna parameters
L = 0.025188303030677584  # Patch length (m)
W = 0.03852414607614596   # Patch width (m)
h = 0.001862731420104729  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015881692920879109  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0875_df9dc4d9')
