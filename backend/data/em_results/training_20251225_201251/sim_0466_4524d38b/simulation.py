...
# Antenna parameters
L = 0.03242419561702797  # Patch length (m)
W = 0.031284348970826874   # Patch width (m)
h = 0.0010452157703362522  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004699261683014713  # Feed x position
feed_y = 0.001964212992647573  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0466_4524d38b')
