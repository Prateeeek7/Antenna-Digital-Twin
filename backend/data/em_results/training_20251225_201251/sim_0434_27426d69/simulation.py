...
# Antenna parameters
L = 0.025245822567136374  # Patch length (m)
W = 0.03722613941530417   # Patch width (m)
h = 0.0017107935696204896  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00914969450077759  # Feed x position
feed_y = 0.0064707977617012285  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0434_27426d69')
