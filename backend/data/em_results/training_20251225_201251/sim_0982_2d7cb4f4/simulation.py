...
# Antenna parameters
L = 0.031708794225589844  # Patch length (m)
W = 0.041153015872349895   # Patch width (m)
h = 0.0029374702569685655  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.01628992791773566  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0982_2d7cb4f4')
