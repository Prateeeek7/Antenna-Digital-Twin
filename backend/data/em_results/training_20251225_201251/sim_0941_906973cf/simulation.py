...
# Antenna parameters
L = 0.03314703061262182  # Patch length (m)
W = 0.03281870328880097   # Patch width (m)
h = 0.00181417305376837  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011582113500846777  # Feed x position
feed_y = 0.013127481315520387  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0941_906973cf')
