...
# Antenna parameters
L = 0.03321797885699844  # Patch length (m)
W = 0.03099365025858875   # Patch width (m)
h = 0.0017600220565626773  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013287191542799377  # Feed x position
feed_y = 0.009507236830207171  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0426_7d4bf79f')
