...
# Antenna parameters
L = 0.0342985345317349  # Patch length (m)
W = 0.0378602808521401   # Patch width (m)
h = 0.001396117615423592  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01371941381269396  # Feed x position
feed_y = 0.01347851178827505  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0578_b3316e43')
