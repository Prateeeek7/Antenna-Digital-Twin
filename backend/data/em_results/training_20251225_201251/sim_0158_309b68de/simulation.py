...
# Antenna parameters
L = 0.029997836443047748  # Patch length (m)
W = 0.03539378960859316   # Patch width (m)
h = 0.0031560376744775276  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0119991345772191  # Feed x position
feed_y = 0.0058571441974342026  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0158_309b68de')
