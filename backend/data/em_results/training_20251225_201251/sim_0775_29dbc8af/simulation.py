...
# Antenna parameters
L = 0.03006587689273143  # Patch length (m)
W = 0.040019971054381896   # Patch width (m)
h = 0.0030993129709024976  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.011677455645565285  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0775_29dbc8af')
