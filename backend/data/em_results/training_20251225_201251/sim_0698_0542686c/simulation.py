...
# Antenna parameters
L = 0.03220411731445395  # Patch length (m)
W = 0.04445996283103715   # Patch width (m)
h = 0.003065945689978847  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006946266689504728  # Feed x position
feed_y = 0.009400411440510638  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0698_0542686c')
