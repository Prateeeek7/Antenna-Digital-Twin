...
# Antenna parameters
L = 0.026003314145541793  # Patch length (m)
W = 0.03396899681968235   # Patch width (m)
h = 0.0008660516157484605  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007612146339889634  # Feed x position
feed_y = 0.008360182402196966  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0939_35771063')
