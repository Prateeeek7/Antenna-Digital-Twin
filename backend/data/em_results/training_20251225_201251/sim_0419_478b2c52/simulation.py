...
# Antenna parameters
L = 0.027706573497039665  # Patch length (m)
W = 0.04160941530933694   # Patch width (m)
h = 0.0020348129594624617  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0026442608195600646  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0419_478b2c52')
