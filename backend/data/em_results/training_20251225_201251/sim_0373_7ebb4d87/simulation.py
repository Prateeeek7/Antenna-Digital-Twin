...
# Antenna parameters
L = 0.03494140029456299  # Patch length (m)
W = 0.0354460059981232   # Patch width (m)
h = 0.001418710734494409  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008359231376486156  # Feed x position
feed_y = 0.0022360610072633277  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0373_7ebb4d87')
