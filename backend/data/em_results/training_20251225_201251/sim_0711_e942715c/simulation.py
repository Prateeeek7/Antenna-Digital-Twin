...
# Antenna parameters
L = 0.033532008925515604  # Patch length (m)
W = 0.040537525812619345   # Patch width (m)
h = 0.0013473779787706941  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013412803570206243  # Feed x position
feed_y = 0.014643890964640858  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0711_e942715c')
