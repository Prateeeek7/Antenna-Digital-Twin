...
# Antenna parameters
L = 0.02967794949401477  # Patch length (m)
W = 0.035192906527669154   # Patch width (m)
h = 0.0015581460451335569  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0059116334499761765  # Feed x position
feed_y = 0.014077162611067662  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0840_1e3759c5')
