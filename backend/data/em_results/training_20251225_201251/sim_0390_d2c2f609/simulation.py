...
# Antenna parameters
L = 0.029260480712099194  # Patch length (m)
W = 0.041789819222054755   # Patch width (m)
h = 0.002742168753687736  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009875848198489013  # Feed x position
feed_y = 0.007962926726433832  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0390_d2c2f609')
