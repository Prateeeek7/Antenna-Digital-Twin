...
# Antenna parameters
L = 0.030838587107329132  # Patch length (m)
W = 0.04196599599526593   # Patch width (m)
h = 0.0009323367672770192  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012335434842931654  # Feed x position
feed_y = 0.006412866051702861  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0605_89fd30bb')
