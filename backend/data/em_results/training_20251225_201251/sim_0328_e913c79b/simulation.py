...
# Antenna parameters
L = 0.03327245426861782  # Patch length (m)
W = 0.03602853318003832   # Patch width (m)
h = 0.0010964762446263356  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0026447577891493554  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0328_e913c79b')
