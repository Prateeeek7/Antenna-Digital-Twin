...
# Antenna parameters
L = 0.03272091419309293  # Patch length (m)
W = 0.032419504392992834   # Patch width (m)
h = 0.0009433619120924972  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013088365677237172  # Feed x position
feed_y = 0.0030023905493722506  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0020_309aa4c8')
