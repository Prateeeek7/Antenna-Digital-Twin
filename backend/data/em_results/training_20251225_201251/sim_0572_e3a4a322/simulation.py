...
# Antenna parameters
L = 0.031085855727288923  # Patch length (m)
W = 0.04026712075254641   # Patch width (m)
h = 0.002299237466396458  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008640247538594912  # Feed x position
feed_y = 0.004682767119771177  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0572_e3a4a322')
