...
# Antenna parameters
L = 0.034081572680311936  # Patch length (m)
W = 0.03822830415761784   # Patch width (m)
h = 0.0014361128596122557  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007043795493269861  # Feed x position
feed_y = 0.003973528323854782  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0400_567450a0')
