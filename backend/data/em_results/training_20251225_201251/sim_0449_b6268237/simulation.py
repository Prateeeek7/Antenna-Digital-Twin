...
# Antenna parameters
L = 0.031668030404573805  # Patch length (m)
W = 0.03068607155438153   # Patch width (m)
h = 0.003152895314382963  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006058281788758348  # Feed x position
feed_y = 0.009660813309871933  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0449_b6268237')
