...
# Antenna parameters
L = 0.027651212363802177  # Patch length (m)
W = 0.041589404091186624   # Patch width (m)
h = 0.0024066438130144864  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004434281945292095  # Feed x position
feed_y = 0.007545137456438164  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0265_daa8a73b')
