...
# Antenna parameters
L = 0.03316770343970001  # Patch length (m)
W = 0.0358030226667332   # Patch width (m)
h = 0.0013359736191833292  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013267081375880006  # Feed x position
feed_y = 0.00969355507167537  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0041_fbb0d1da')
