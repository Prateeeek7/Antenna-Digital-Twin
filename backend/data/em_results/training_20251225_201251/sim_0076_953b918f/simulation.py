...
# Antenna parameters
L = 0.025494470069347474  # Patch length (m)
W = 0.042210957900197424   # Patch width (m)
h = 0.0024013272764146177  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010197788027738991  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0076_953b918f')
