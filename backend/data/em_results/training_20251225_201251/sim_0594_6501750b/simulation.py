...
# Antenna parameters
L = 0.033185308665630284  # Patch length (m)
W = 0.03230023781602434   # Patch width (m)
h = 0.0019780923630243613  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013274123466252114  # Feed x position
feed_y = 0.01058631048962508  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0594_6501750b')
