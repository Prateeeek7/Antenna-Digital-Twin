...
# Antenna parameters
L = 0.03123083651980462  # Patch length (m)
W = 0.033037786343575494   # Patch width (m)
h = 0.001238411933107989  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012492334607921849  # Feed x position
feed_y = 0.0072212579291791815  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0064_8845c48f')
