...
# Antenna parameters
L = 0.02672725122923375  # Patch length (m)
W = 0.04234529981032582   # Patch width (m)
h = 0.002080994598114748  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008342567913829523  # Feed x position
feed_y = 0.01693811992413033  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0909_1ca2a12f')
