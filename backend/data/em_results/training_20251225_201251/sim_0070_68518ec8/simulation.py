...
# Antenna parameters
L = 0.03447383834299976  # Patch length (m)
W = 0.03343243063043861   # Patch width (m)
h = 0.002754644118532466  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013789535337199905  # Feed x position
feed_y = 0.00843389922603482  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0070_68518ec8')
