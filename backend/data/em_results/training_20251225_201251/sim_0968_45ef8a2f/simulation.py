...
# Antenna parameters
L = 0.03308121070967053  # Patch length (m)
W = 0.03296362527446668   # Patch width (m)
h = 0.0018241401639392711  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005567086842418366  # Feed x position
feed_y = 0.012239479095849362  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0968_45ef8a2f')
