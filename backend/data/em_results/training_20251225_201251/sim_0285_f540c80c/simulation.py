...
# Antenna parameters
L = 0.026876084931583156  # Patch length (m)
W = 0.036643653701471234   # Patch width (m)
h = 0.0030318141533953753  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010750433972633262  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0285_f540c80c')
