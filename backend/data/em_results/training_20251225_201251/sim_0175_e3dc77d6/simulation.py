...
# Antenna parameters
L = 0.02560112428911512  # Patch length (m)
W = 0.03504908055167775   # Patch width (m)
h = 0.0012552340820273609  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0019250926551777814  # Feed x position
feed_y = 0.0140196322206711  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0175_e3dc77d6')
