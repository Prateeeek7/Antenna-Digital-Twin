...
# Antenna parameters
L = 0.025965576104060993  # Patch length (m)
W = 0.034038697491548316   # Patch width (m)
h = 0.0021124753233715734  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010386230441624398  # Feed x position
feed_y = 0.012449984465531945  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0808_bf599dc2')
