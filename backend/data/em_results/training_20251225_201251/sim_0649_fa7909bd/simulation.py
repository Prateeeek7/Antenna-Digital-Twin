...
# Antenna parameters
L = 0.034684437815472764  # Patch length (m)
W = 0.04016481694512315   # Patch width (m)
h = 0.002874075423599622  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01065021347498794  # Feed x position
feed_y = 0.002018832841449371  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0649_fa7909bd')
