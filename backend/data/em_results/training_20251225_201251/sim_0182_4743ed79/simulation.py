...
# Antenna parameters
L = 0.032312351964473934  # Patch length (m)
W = 0.04212184933804103   # Patch width (m)
h = 0.0009802360595514406  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010986448980201888  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0182_4743ed79')
