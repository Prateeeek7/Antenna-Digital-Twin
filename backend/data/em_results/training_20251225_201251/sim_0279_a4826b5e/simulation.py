...
# Antenna parameters
L = 0.025088442423290256  # Patch length (m)
W = 0.03569197652770536   # Patch width (m)
h = 0.0022714022123410914  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.010718349925739366  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0279_a4826b5e')
