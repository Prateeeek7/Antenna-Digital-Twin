...
# Antenna parameters
L = 0.03255114907011773  # Patch length (m)
W = 0.040972661022137535   # Patch width (m)
h = 0.0020980600664768654  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005661414818546382  # Feed x position
feed_y = 0.007893638529840308  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0401_5fe6afd2')
