...
# Antenna parameters
L = 0.026622293906673616  # Patch length (m)
W = 0.031150243190071873   # Patch width (m)
h = 0.00236323046444788  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0012848983321028956  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0906_35e37c99')
