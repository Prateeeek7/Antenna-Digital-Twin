...
# Antenna parameters
L = 0.02710815860782851  # Patch length (m)
W = 0.03156757049075421   # Patch width (m)
h = 0.001975634080378452  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007289904616017321  # Feed x position
feed_y = 0.012627028196301685  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0801_ed0e545a')
