...
# Antenna parameters
L = 0.030399635698043173  # Patch length (m)
W = 0.04062665714554803   # Patch width (m)
h = 0.0008186809536564859  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006416445849309094  # Feed x position
feed_y = 0.01365769901425155  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0455_e105fdf0')
