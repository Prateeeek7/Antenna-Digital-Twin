...
# Antenna parameters
L = 0.02613588423997806  # Patch length (m)
W = 0.0325680947677416   # Patch width (m)
h = 0.0012413964337464516  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009179504568874336  # Feed x position
feed_y = 0.011564896910356165  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0125_b1709aea')
