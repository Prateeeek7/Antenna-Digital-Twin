...
# Antenna parameters
L = 0.03114070757755994  # Patch length (m)
W = 0.039253584877460404   # Patch width (m)
h = 0.0008624137539700082  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007103661096541257  # Feed x position
feed_y = 0.010596637308214937  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0429_4864a880')
