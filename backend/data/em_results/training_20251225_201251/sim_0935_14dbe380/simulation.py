...
# Antenna parameters
L = 0.028328577170214437  # Patch length (m)
W = 0.0437833295254082   # Patch width (m)
h = 0.0029308822753009896  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00729351015703572  # Feed x position
feed_y = 0.01751333181016328  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0935_14dbe380')
