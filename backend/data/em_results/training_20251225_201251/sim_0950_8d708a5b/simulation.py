...
# Antenna parameters
L = 0.02735803327173712  # Patch length (m)
W = 0.04130205299083639   # Patch width (m)
h = 0.0023855261399306194  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003714091887133232  # Feed x position
feed_y = 0.0016329979970222135  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0950_8d708a5b')
