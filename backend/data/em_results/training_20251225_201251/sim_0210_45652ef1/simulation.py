...
# Antenna parameters
L = 0.026703321508411523  # Patch length (m)
W = 0.041023059557948126   # Patch width (m)
h = 0.002083339633938556  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.003727282975126222  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0210_45652ef1')
