...
# Antenna parameters
L = 0.03340421390703188  # Patch length (m)
W = 0.03650788459050075   # Patch width (m)
h = 0.0025736663690049595  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013361685562812753  # Feed x position
feed_y = 0.0146031538362003  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0351_ea7c0cbf')
