...
# Antenna parameters
L = 0.029910504272293467  # Patch length (m)
W = 0.03213805429789871   # Patch width (m)
h = 0.003138487434812065  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009556058249250944  # Feed x position
feed_y = 0.003305740991225519  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0971_53c924cf')
