...
# Antenna parameters
L = 0.026426413272084722  # Patch length (m)
W = 0.0395638699593395   # Patch width (m)
h = 0.0031749643543911507  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007126765652487756  # Feed x position
feed_y = 0.009655032913214923  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0256_cffc1a44')
