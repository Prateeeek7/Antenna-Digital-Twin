...
# Antenna parameters
L = 0.026780629849991237  # Patch length (m)
W = 0.040961140039692076   # Patch width (m)
h = 0.0012092203683846732  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00708114966806859  # Feed x position
feed_y = 0.011713704472550237  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0636_5d15e7f1')
