...
# Antenna parameters
L = 0.033474182727020414  # Patch length (m)
W = 0.03995967414816444   # Patch width (m)
h = 0.0029795628989284736  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01179704851549206  # Feed x position
feed_y = 0.01211564200741608  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0380_ddf4a450')
