...
# Antenna parameters
L = 0.030400006099634856  # Patch length (m)
W = 0.0404698877550584   # Patch width (m)
h = 0.0014284134903612324  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012160002439853943  # Feed x position
feed_y = 0.008679577012289027  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0584_f2046448')
