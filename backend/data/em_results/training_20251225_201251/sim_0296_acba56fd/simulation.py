...
# Antenna parameters
L = 0.033895782339372856  # Patch length (m)
W = 0.03848899761367948   # Patch width (m)
h = 0.001408176904085241  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012571471674913494  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0296_acba56fd')
