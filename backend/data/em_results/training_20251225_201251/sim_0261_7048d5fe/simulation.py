...
# Antenna parameters
L = 0.034490724951403755  # Patch length (m)
W = 0.037206039082063894   # Patch width (m)
h = 0.0022791945256184208  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012070847040980675  # Feed x position
feed_y = 0.014882415632825559  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0261_7048d5fe')
