...
# Antenna parameters
L = 0.029377237926365436  # Patch length (m)
W = 0.04014053221670791   # Patch width (m)
h = 0.0010825649657471694  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004664665355015588  # Feed x position
feed_y = 0.010688771132700272  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0321_6ddb3e1c')
