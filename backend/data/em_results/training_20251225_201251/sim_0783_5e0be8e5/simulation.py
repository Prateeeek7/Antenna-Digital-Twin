...
# Antenna parameters
L = 0.027686950886547153  # Patch length (m)
W = 0.04359721947407558   # Patch width (m)
h = 0.0008586923599191454  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003894716997356807  # Feed x position
feed_y = 0.008230490128751313  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0783_5e0be8e5')
