...
# Antenna parameters
L = 0.029971994163793265  # Patch length (m)
W = 0.04320573316637241   # Patch width (m)
h = 0.0012251260716099376  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0019339602606137957  # Feed x position
feed_y = 0.017282293266548964  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0290_f84008cc')
