...
# Antenna parameters
L = 0.03085144357878298  # Patch length (m)
W = 0.035922185860608524   # Patch width (m)
h = 0.0014321737455336762  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011571171005970202  # Feed x position
feed_y = 0.002974815644868901  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0267_7ef70dd5')
