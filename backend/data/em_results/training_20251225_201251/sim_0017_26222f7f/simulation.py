...
# Antenna parameters
L = 0.028009099521392244  # Patch length (m)
W = 0.042694164609741056   # Patch width (m)
h = 0.002517291494647397  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006915989043129412  # Feed x position
feed_y = 0.003212713583982893  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0017_26222f7f')
