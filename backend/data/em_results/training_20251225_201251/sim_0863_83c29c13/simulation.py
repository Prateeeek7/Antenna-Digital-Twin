...
# Antenna parameters
L = 0.027163803226378645  # Patch length (m)
W = 0.03940597864273431   # Patch width (m)
h = 0.003090109136115119  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01086552129055146  # Feed x position
feed_y = 0.002750597310871371  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0863_83c29c13')
