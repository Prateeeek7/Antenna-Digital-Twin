...
# Antenna parameters
L = 0.026884942376852575  # Patch length (m)
W = 0.04341395140360326   # Patch width (m)
h = 0.0020588966972853117  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010753976950741031  # Feed x position
feed_y = 0.008840269964626928  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0301_20fdb3fc')
