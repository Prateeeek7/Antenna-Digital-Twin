...
# Antenna parameters
L = 0.028751523335320023  # Patch length (m)
W = 0.041111436964919215   # Patch width (m)
h = 0.003060438558573591  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.003981962102307039  # Feed x position
feed_y = 0.01605304487013722  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0476_0078c712')
