...
# Antenna parameters
L = 0.03377392788569506  # Patch length (m)
W = 0.031163625309215008   # Patch width (m)
h = 0.0011231120375171668  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013509571154278026  # Feed x position
feed_y = 0.005031080615105657  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0269_4b7fc0b8')
