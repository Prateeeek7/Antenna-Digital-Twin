...
# Antenna parameters
L = 0.03154343770351895  # Patch length (m)
W = 0.040949487308836074   # Patch width (m)
h = 0.0026101515513213343  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012617375081407582  # Feed x position
feed_y = 0.01637979492353443  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0430_dd33402f')
