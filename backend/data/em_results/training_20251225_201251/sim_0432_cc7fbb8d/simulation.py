...
# Antenna parameters
L = 0.032705517839124294  # Patch length (m)
W = 0.03293602179815831   # Patch width (m)
h = 0.0008758574359709558  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005471222637196277  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0432_cc7fbb8d')
