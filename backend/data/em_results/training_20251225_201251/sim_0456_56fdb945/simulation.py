...
# Antenna parameters
L = 0.026215797775209677  # Patch length (m)
W = 0.03473717843657818   # Patch width (m)
h = 0.0027311863432977926  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010486319110083872  # Feed x position
feed_y = 0.0020980498584193623  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0456_56fdb945')
