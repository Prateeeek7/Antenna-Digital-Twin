...
# Antenna parameters
L = 0.0331919418303865  # Patch length (m)
W = 0.04252657253823339   # Patch width (m)
h = 0.0026238317253630943  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004919463653675284  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0533_b9a0ae3e')
