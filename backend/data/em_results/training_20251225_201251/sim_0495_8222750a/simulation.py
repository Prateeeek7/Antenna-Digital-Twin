...
# Antenna parameters
L = 0.028869496202617115  # Patch length (m)
W = 0.0327878548889801   # Patch width (m)
h = 0.0026523367395451056  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008915284629216575  # Feed x position
feed_y = 0.013115141955592042  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0495_8222750a')
