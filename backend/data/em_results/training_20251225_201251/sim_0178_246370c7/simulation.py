...
# Antenna parameters
L = 0.03261660522245791  # Patch length (m)
W = 0.03187567652412216   # Patch width (m)
h = 0.0020330153678111396  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013046642088983165  # Feed x position
feed_y = 0.006554380130114342  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0178_246370c7')
