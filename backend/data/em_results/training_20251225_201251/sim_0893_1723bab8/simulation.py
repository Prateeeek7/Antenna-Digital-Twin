...
# Antenna parameters
L = 0.02634848692178525  # Patch length (m)
W = 0.032562517027476826   # Patch width (m)
h = 0.0020128195340411584  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002397819082926687  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0893_1723bab8')
