...
# Antenna parameters
L = 0.031348500585220665  # Patch length (m)
W = 0.034051918435469945   # Patch width (m)
h = 0.0018737549134596  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0055622618519561556  # Feed x position
feed_y = 0.013620767374187978  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0475_ba8615d9')
