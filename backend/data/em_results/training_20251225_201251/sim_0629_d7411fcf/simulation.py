...
# Antenna parameters
L = 0.0340036050556451  # Patch length (m)
W = 0.04327897379333607   # Patch width (m)
h = 0.003085491878912188  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013601442022258041  # Feed x position
feed_y = 0.011486590376043364  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0629_d7411fcf')
