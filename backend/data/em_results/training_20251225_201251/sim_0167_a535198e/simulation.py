...
# Antenna parameters
L = 0.026554330622046807  # Patch length (m)
W = 0.035253623666442226   # Patch width (m)
h = 0.0025616397990176174  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002291382850002542  # Feed x position
feed_y = 0.013070023921621914  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0167_a535198e')
