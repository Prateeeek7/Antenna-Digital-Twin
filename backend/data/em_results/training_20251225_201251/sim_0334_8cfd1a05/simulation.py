...
# Antenna parameters
L = 0.025076941997712616  # Patch length (m)
W = 0.037520716254282396   # Patch width (m)
h = 0.0026677760794791183  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007847474243982858  # Feed x position
feed_y = 0.015008286501712959  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0334_8cfd1a05')
