...
# Antenna parameters
L = 0.032492884419584034  # Patch length (m)
W = 0.03299774318982664   # Patch width (m)
h = 0.003178286302351987  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007081203457885911  # Feed x position
feed_y = 0.0098841634110595  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0152_34f75afe')
