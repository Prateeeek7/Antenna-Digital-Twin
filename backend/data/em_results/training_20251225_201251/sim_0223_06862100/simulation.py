...
# Antenna parameters
L = 0.028669303593634086  # Patch length (m)
W = 0.04037793003723978   # Patch width (m)
h = 0.0009853022288626497  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008725923526593753  # Feed x position
feed_y = 0.00880471352642776  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0223_06862100')
