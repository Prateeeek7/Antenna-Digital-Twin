...
# Antenna parameters
L = 0.02787051353532084  # Patch length (m)
W = 0.03425428038692315   # Patch width (m)
h = 0.0025762982276336882  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008138371882926819  # Feed x position
feed_y = 0.008171789319338778  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0538_b66774f0')
