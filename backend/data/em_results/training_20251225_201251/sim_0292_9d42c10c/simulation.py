...
# Antenna parameters
L = 0.03051229226786335  # Patch length (m)
W = 0.04271189284961743   # Patch width (m)
h = 0.002047561258950966  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0027717254297866733  # Feed x position
feed_y = 0.010898939092175588  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0292_9d42c10c')
