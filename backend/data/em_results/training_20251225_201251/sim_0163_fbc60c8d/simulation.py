...
# Antenna parameters
L = 0.03303102697800246  # Patch length (m)
W = 0.035866794295498085   # Patch width (m)
h = 0.0009043131190085328  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006083955262784936  # Feed x position
feed_y = 0.008782465427996168  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0163_fbc60c8d')
