...
# Antenna parameters
L = 0.03129255229072184  # Patch length (m)
W = 0.03804269241084212   # Patch width (m)
h = 0.0029174015531319227  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0038288337987329867  # Feed x position
feed_y = 0.008062809241461202  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0336_a5a8e1f8')
