...
# Antenna parameters
L = 0.0304293793689346  # Patch length (m)
W = 0.04232312606937695   # Patch width (m)
h = 0.002815690327862763  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008274473584724508  # Feed x position
feed_y = 0.006059988498351904  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0200_4b8d55be')
