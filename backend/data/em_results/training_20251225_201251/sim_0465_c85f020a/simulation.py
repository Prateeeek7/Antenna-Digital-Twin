...
# Antenna parameters
L = 0.028490139702569237  # Patch length (m)
W = 0.04033186560588773   # Patch width (m)
h = 0.001457124517420611  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.012875988461013016  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0465_c85f020a')
