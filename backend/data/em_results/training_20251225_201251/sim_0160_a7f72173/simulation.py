...
# Antenna parameters
L = 0.03246261419613543  # Patch length (m)
W = 0.03629524270243305   # Patch width (m)
h = 0.0009466639533029175  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010167390904499194  # Feed x position
feed_y = 0.012301800197794506  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0160_a7f72173')
