...
# Antenna parameters
L = 0.03354959130010229  # Patch length (m)
W = 0.03428527968205066   # Patch width (m)
h = 0.0010018930069361888  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.001  # Feed x position
feed_y = 0.0014038170277177206  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0888_0e949965')
