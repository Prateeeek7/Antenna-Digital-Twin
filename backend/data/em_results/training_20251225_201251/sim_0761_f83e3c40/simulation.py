...
# Antenna parameters
L = 0.033428425523913355  # Patch length (m)
W = 0.042185008506696486   # Patch width (m)
h = 0.003148088995000466  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005015338825922179  # Feed x position
feed_y = 0.016874003402678594  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0761_f83e3c40')
