...
# Antenna parameters
L = 0.029249739825964488  # Patch length (m)
W = 0.03238745700373563   # Patch width (m)
h = 0.001882215822976257  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0014303908391961415  # Feed x position
feed_y = 0.0021213153729954413  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0516_d9673323')
