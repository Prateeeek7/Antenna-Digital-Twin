...
# Antenna parameters
L = 0.028044335793491908  # Patch length (m)
W = 0.04490173636847264   # Patch width (m)
h = 0.001969211487380387  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009104445923063354  # Feed x position
feed_y = 0.003928305238342771  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0240_80237367')
