...
# Antenna parameters
L = 0.028622048851610172  # Patch length (m)
W = 0.038985809594057744   # Patch width (m)
h = 0.002143391879950786  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006202540010247856  # Feed x position
feed_y = 0.005300217319832696  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0069_10d801c6')
