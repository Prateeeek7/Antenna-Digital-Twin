...
# Antenna parameters
L = 0.034486952953962396  # Patch length (m)
W = 0.044573581451794776   # Patch width (m)
h = 0.001804133629887112  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0028342304064440885  # Feed x position
feed_y = 0.007234029042645804  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0095_19e762f3')
