...
# Antenna parameters
L = 0.030376636189119434  # Patch length (m)
W = 0.041712644617539985   # Patch width (m)
h = 0.0024679716581883704  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008987718414199418  # Feed x position
feed_y = 0.014622075163720055  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0591_f2076613')
