...
# Antenna parameters
L = 0.03233064125897989  # Patch length (m)
W = 0.03951243786384318   # Patch width (m)
h = 0.0012437179894825938  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007548237654377624  # Feed x position
feed_y = 0.015804975145537272  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0278_50850671')
