...
# Antenna parameters
L = 0.03470441325703525  # Patch length (m)
W = 0.035965761983980694   # Patch width (m)
h = 0.0027905678567589636  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006083083185151653  # Feed x position
feed_y = 0.014386304793592278  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0563_e4d93c59')
