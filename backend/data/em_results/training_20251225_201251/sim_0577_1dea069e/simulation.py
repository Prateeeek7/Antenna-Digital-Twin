...
# Antenna parameters
L = 0.03175778176697826  # Patch length (m)
W = 0.030044636559688684   # Patch width (m)
h = 0.0031809407194369516  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012703112706791303  # Feed x position
feed_y = 0.007644454291952307  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0577_1dea069e')
