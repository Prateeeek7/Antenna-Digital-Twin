...
# Antenna parameters
L = 0.030579924929672  # Patch length (m)
W = 0.03743495805047206   # Patch width (m)
h = 0.0031836859739943664  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008044979282052379  # Feed x position
feed_y = 0.010179719418259925  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0220_74205051')
