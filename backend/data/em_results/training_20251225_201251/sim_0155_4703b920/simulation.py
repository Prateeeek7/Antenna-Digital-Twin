...
# Antenna parameters
L = 0.02805146630540658  # Patch length (m)
W = 0.044300713213703595   # Patch width (m)
h = 0.0014884094156333483  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01001755819063312  # Feed x position
feed_y = 0.01772028528548144  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0155_4703b920')
