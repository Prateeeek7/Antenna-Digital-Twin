...
# Antenna parameters
L = 0.029194328906345116  # Patch length (m)
W = 0.04121255161774434   # Patch width (m)
h = 0.0030876561524630923  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009828542731831938  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0701_ea81332f')
