...
# Antenna parameters
L = 0.026417846428325207  # Patch length (m)
W = 0.0353259208399384   # Patch width (m)
h = 0.0014200673811288068  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004915045602875864  # Feed x position
feed_y = 0.012962682895976713  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0924_2e480f8d')
