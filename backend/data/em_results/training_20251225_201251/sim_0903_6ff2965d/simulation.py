...
# Antenna parameters
L = 0.030116996803308774  # Patch length (m)
W = 0.03332353177547811   # Patch width (m)
h = 0.001195283498602995  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010830626397730747  # Feed x position
feed_y = 0.0026951195117555803  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0903_6ff2965d')
