...
# Antenna parameters
L = 0.030638674536857254  # Patch length (m)
W = 0.035175688375813946   # Patch width (m)
h = 0.002373716324742935  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00834359731646123  # Feed x position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0647_1f353343')
