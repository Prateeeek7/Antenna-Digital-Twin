...
# Antenna parameters
L = 0.03124202737807728  # Patch length (m)
W = 0.03681045309438374   # Patch width (m)
h = 0.003161358172349309  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012496810951230912  # Feed x position
feed_y = 0.004228469193122876  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0592_4e17c47f')
