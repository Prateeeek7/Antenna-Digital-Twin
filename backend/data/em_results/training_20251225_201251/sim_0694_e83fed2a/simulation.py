...
# Antenna parameters
L = 0.03208560787820766  # Patch length (m)
W = 0.032378293116746344   # Patch width (m)
h = 0.0016050744013994226  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0042447734781595955  # Feed x position
feed_y = 0.012951317246698539  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0694_e83fed2a')
