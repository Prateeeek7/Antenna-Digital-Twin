...
# Antenna parameters
L = 0.025848380584297507  # Patch length (m)
W = 0.034070411244894655   # Patch width (m)
h = 0.002492521027341988  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00573561433353806  # Feed x position
feed_y = 0.01092097398711091  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0332_04d86ed5')
