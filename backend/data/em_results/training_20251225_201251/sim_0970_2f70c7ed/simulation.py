...
# Antenna parameters
L = 0.0320179831198672  # Patch length (m)
W = 0.030274029430393   # Patch width (m)
h = 0.003106866593346331  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007986480445374146  # Feed x position
feed_y = 0.005311779093062915  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0970_2f70c7ed')
