...
# Antenna parameters
L = 0.03259952526502567  # Patch length (m)
W = 0.03994374656951777   # Patch width (m)
h = 0.0009694633372597464  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006108210748771101  # Feed x position
feed_y = 0.010062430103561877  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0619_7f16c6c3')
