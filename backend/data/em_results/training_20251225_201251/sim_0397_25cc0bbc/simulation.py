...
# Antenna parameters
L = 0.03371073329511919  # Patch length (m)
W = 0.031061131589862782   # Patch width (m)
h = 0.002432736976182594  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005225377511185894  # Feed x position
feed_y = 0.00403560823007353  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0397_25cc0bbc')
