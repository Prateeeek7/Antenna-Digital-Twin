...
# Antenna parameters
L = 0.032689781686083545  # Patch length (m)
W = 0.03564727299934731   # Patch width (m)
h = 0.001946372404977443  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01307591267443342  # Feed x position
feed_y = 0.006628605291742321  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0406_2a785738')
