...
# Antenna parameters
L = 0.02992308445852893  # Patch length (m)
W = 0.03529571698911887   # Patch width (m)
h = 0.0020568466720248483  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.009987036531075433  # Feed x position
feed_y = 0.014118286795647549  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0871_e0b59f09')
