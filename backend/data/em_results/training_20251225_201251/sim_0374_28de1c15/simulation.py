...
# Antenna parameters
L = 0.031726967979233654  # Patch length (m)
W = 0.03080340286436279   # Patch width (m)
h = 0.0023504345093563715  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0018879918062515628  # Feed x position
feed_y = 0.012321361145745117  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0374_28de1c15')
