...
# Antenna parameters
L = 0.03297841251419806  # Patch length (m)
W = 0.03542761392367759   # Patch width (m)
h = 0.00280283273978416  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011291087920068107  # Feed x position
feed_y = 0.014171045569471036  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0992_194177fd')
