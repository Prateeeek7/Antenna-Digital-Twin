...
# Antenna parameters
L = 0.029741545421012847  # Patch length (m)
W = 0.030208364185402764   # Patch width (m)
h = 0.002703931907869256  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01189661816840514  # Feed x position
feed_y = 0.012083345674161106  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0977_7f5334bb')
