...
# Antenna parameters
L = 0.02629061194645793  # Patch length (m)
W = 0.032064830386702325   # Patch width (m)
h = 0.0021522631957234845  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030326707305138255  # Feed x position
feed_y = 0.010177861344098645  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0317_6ae14dfa')
