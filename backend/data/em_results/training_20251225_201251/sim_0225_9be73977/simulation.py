...
# Antenna parameters
L = 0.03356447815071441  # Patch length (m)
W = 0.0340274885077638   # Patch width (m)
h = 0.0019503532090025238  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.011602355895321296  # Feed x position
feed_y = 0.0027733757086654694  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0225_9be73977')
