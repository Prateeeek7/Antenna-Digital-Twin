...
# Antenna parameters
L = 0.03357001170362667  # Patch length (m)
W = 0.04449579725272905   # Patch width (m)
h = 0.0015178645292803043  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.013428004681450667  # Feed x position
feed_y = 0.012329975605163883  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0312_a2936d1d')
