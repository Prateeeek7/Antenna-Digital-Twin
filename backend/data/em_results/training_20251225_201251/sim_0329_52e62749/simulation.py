...
# Antenna parameters
L = 0.031655361718895374  # Patch length (m)
W = 0.04453065855438738   # Patch width (m)
h = 0.001484489454925698  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01266214468755815  # Feed x position
feed_y = 0.017812263421754952  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0329_52e62749')
