...
# Antenna parameters
L = 0.0285696356805269  # Patch length (m)
W = 0.03669835233019132   # Patch width (m)
h = 0.001391318891413557  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007101427417168102  # Feed x position
feed_y = 0.012200168980424293  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0949_1be376ff')
