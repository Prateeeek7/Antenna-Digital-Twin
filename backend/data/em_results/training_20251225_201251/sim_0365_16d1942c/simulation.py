...
# Antenna parameters
L = 0.02880928149664514  # Patch length (m)
W = 0.03540726468842217   # Patch width (m)
h = 0.0029276441801859058  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006814523173623833  # Feed x position
feed_y = 0.011728771385152456  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0365_16d1942c')
