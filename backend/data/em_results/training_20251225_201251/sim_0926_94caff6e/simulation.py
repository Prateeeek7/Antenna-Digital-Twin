...
# Antenna parameters
L = 0.0326772706627325  # Patch length (m)
W = 0.03194329201552615   # Patch width (m)
h = 0.00186001768735333  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.007151890026989588  # Feed x position
feed_y = 0.012096149865022601  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0926_94caff6e')
