...
# Antenna parameters
L = 0.03490967407556753  # Patch length (m)
W = 0.032743995329803016   # Patch width (m)
h = 0.0023710321434009672  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.01043659132104921  # Feed x position
feed_y = 0.011308748978107937  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0464_d7c9b356')
