...
# Antenna parameters
L = 0.02935510497993493  # Patch length (m)
W = 0.03598000358758484   # Patch width (m)
h = 0.0009597648151516485  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005360527190709367  # Feed x position
feed_y = 0.00899785764250625  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0149_67d618b8')
