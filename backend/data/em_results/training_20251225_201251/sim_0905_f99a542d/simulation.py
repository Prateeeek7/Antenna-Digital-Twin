...
# Antenna parameters
L = 0.031074421133215006  # Patch length (m)
W = 0.03423413712447376   # Patch width (m)
h = 0.002120764665115271  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.012429768453286003  # Feed x position
feed_y = 0.013684227472070402  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0905_f99a542d')
