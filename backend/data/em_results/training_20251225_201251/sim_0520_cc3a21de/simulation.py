...
# Antenna parameters
L = 0.027145887968229514  # Patch length (m)
W = 0.034984989046678516   # Patch width (m)
h = 0.0028533038105639508  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.005120346148299368  # Feed x position
feed_y = 0.003970243820543825  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0520_cc3a21de')
