...
# Antenna parameters
L = 0.026013112477872403  # Patch length (m)
W = 0.03842200889358993   # Patch width (m)
h = 0.002534269126339802  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0031110083114277063  # Feed x position
feed_y = 0.014490677027676688  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0540_dedd7539')
