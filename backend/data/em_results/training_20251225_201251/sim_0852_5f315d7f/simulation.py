...
# Antenna parameters
L = 0.02675040829460933  # Patch length (m)
W = 0.03082668478235115   # Patch width (m)
h = 0.00288252047581667  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004162136846821885  # Feed x position
feed_y = 0.002162709769586351  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0852_5f315d7f')
