...
# Antenna parameters
L = 0.027113863945649533  # Patch length (m)
W = 0.03763082674272418   # Patch width (m)
h = 0.002762961176857123  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010845545578259813  # Feed x position
feed_y = 0.0033478951246711597  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0596_20e69115')
