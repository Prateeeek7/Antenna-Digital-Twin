...
# Antenna parameters
L = 0.028390743133312635  # Patch length (m)
W = 0.035291979775214206   # Patch width (m)
h = 0.0018009690250026388  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.006614789607109815  # Feed x position
feed_y = 0.014116791910085684  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0389_43f901b7')
