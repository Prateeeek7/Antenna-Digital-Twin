...
# Antenna parameters
L = 0.03135501183041469  # Patch length (m)
W = 0.03276702883438493   # Patch width (m)
h = 0.0011621480486818496  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00747192201227257  # Feed x position
feed_y = 0.0075541544457592355  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0116_93aeaf90')
