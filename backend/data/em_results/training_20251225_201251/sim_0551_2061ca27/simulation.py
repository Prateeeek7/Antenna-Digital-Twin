...
# Antenna parameters
L = 0.02848202482795947  # Patch length (m)
W = 0.03952695473556439   # Patch width (m)
h = 0.0015615237714690108  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0015426697309235352  # Feed x position
feed_y = 0.004159716056368856  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0551_2061ca27')
