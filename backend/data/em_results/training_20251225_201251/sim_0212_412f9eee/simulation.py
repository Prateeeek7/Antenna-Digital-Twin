...
# Antenna parameters
L = 0.027580470775315148  # Patch length (m)
W = 0.03323084909275669   # Patch width (m)
h = 0.0019825877433655346  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0022529731125621607  # Feed x position
feed_y = 0.01072823916024577  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0212_412f9eee')
