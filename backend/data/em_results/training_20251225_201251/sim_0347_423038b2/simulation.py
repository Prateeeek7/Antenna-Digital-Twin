...
# Antenna parameters
L = 0.029082539320210408  # Patch length (m)
W = 0.042046714422437126   # Patch width (m)
h = 0.002069081780502965  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004398279035795599  # Feed x position
feed_y = 0.005155363003572027  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0347_423038b2')
