...
# Antenna parameters
L = 0.026247645479829863  # Patch length (m)
W = 0.042487548933289224   # Patch width (m)
h = 0.001796648434589447  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.0030420663912878593  # Feed x position
feed_y = 0.006028742293623186  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0918_7e136c98')
