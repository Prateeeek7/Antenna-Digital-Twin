...
# Antenna parameters
L = 0.027639115612307256  # Patch length (m)
W = 0.031830382486611866   # Patch width (m)
h = 0.0026403103684482705  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004551843503369854  # Feed x position
feed_y = 0.003080861390921387  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0579_80444586')
