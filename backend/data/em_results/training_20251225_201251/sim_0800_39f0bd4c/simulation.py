...
# Antenna parameters
L = 0.029132839000293415  # Patch length (m)
W = 0.040509643266061546   # Patch width (m)
h = 0.0019355555171462085  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.004978205294643827  # Feed x position
feed_y = 0.011210266120588959  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0800_39f0bd4c')
