...
# Antenna parameters
L = 0.03374201551655172  # Patch length (m)
W = 0.033100963042489155   # Patch width (m)
h = 0.002548829959822239  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010298952527246611  # Feed x position
feed_y = 0.010583027038021308  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0375_5c92d72b')
