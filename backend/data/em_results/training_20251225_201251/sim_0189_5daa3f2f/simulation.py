...
# Antenna parameters
L = 0.02645754741026977  # Patch length (m)
W = 0.03558434632197996   # Patch width (m)
h = 0.0030371567968414345  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.00877233618359628  # Feed x position
feed_y = 0.014233738528791985  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0189_5daa3f2f')
