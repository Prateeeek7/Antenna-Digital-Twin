...
# Antenna parameters
L = 0.025115442237101666  # Patch length (m)
W = 0.04424696454952807   # Patch width (m)
h = 0.0031968657041020385  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.002642405478201046  # Feed x position
feed_y = 0.011810028705193978  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0022_ad8067a5')
