...
# Antenna parameters
L = 0.030958988938340648  # Patch length (m)
W = 0.0326878355564664   # Patch width (m)
h = 0.001533243767476731  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.008288272522101233  # Feed x position
feed_y = 0.011081468085794962  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0268_33aeb272')
