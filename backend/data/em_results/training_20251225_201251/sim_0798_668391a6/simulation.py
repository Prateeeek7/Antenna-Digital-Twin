...
# Antenna parameters
L = 0.02828020378318876  # Patch length (m)
W = 0.030953653704205494   # Patch width (m)
h = 0.0017574063670918049  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.010049037083551485  # Feed x position
feed_y = 0.00918955608592116  # Feed y position
...
# Save results
output_dir = Path('data/em_results/training_20251225_201251/sim_0798_668391a6')
