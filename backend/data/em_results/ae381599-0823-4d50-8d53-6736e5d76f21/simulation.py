...
# Antenna parameters
L = 0.03  # Patch length (m)
W = 0.04   # Patch width (m)
h = 0.0016  # Substrate height (m)
er = 4.4  # Relative permittivity
tand = 0.02  # Loss tangent
feed_x = 0.015  # Feed x position
feed_y = 0.02  # Feed y position
...
# Save results
output_dir = Path('data/em_results/ae381599-0823-4d50-8d53-6736e5d76f21')
